...
export class HubComponent implements OnInit, OnDestroy {
  ...
  challenges: Challenge[] = [
    { id: '1', title: 'Weekly Remix Challenge', description: 'Remix the featured track and win a prize!', prize: '$100' },
    { id: '2', title: 'Production Contest', description: 'Create a track in a specific genre.', prize: 'Featured on our homepage' }
  ];
  communityPosts: CommunityPost[] = [
    { id: '1', author: 'DJ Jazzy Jules', content: 'Just dropped a new track, check it out!', timestamp: new Date() },
    { id: '2', author: 'MC Flow', content: 'Looking for a collaborator for a new project.', timestamp: new Date() }
  ];
  genres = [
    'Shooter',
    'Arcade',
