...
# 3. UserProfileService - Fixed exports and injected dependencies
...
export class UserProfileService {
  ...
  private get db(): any {
    // Break cycle by using injector at runtime
...
# 4. AuthService - Fixed exports and breaking cycles
...
export class AuthService {
  ...
  private get loginConfirmationService(): any {
    const { LoginConfirmationService } = require('./login-confirmation.service');
    return this.injector.get(LoginConfirmationService);
  }
