...
export const SMUVE_TV_CHANNELS: readonly SmuveTvChannel[] = [
  ...
  },
  {
    ...
    number: 106,
    name: 'BATTLE OF THE LAUGHS',
    callSign: 'BA',
    tagline: 'Two comics enter. One laugh leaves.',
    category: 'gaming',
    accent: '#EC4899',
    scene: 'neon-grid',
    icon: 'sentiment_satisfied',
    shows: [
      show('ba-1', 'ROUND ONE', 'Sixteen comedians, no mercy', 45, 'episode'),
      show('ba-2', 'THE RIVAL SET', 'Challengers ranking and callouts', 30, 'news'),
      show('ba-3', 'SUDDEN LAUGH', 'The joke that lands last', 60, 'episode'),
      show('ba-4', 'CROWNING THE CHAMPION', 'The deciding set, uncut', 60, 'episode'),
    ],
  },
  {
    id: 'arcade-after-dark',
    number: 107,
    name: 'AFTER DARK THEATER',
    callSign: 'AD',
    tagline: 'Cult sci-fi and bad movies, after closing.',
    category: 'gaming',
    accent: '#22D3EE',
    scene: 'neon-grid',
    icon: 'movie',
    shows: [
      show('ad-1', 'CABINET ROTATION', 'Cult classics, back to back', 90, 'feature'),
      show('ad-2', 'ONE-TAKE CLEAR', 'Bad sci-fi, no apologies', 60, 'feature'),
      show('ad-3', 'THE MIDNIGHT SLOT', 'Shorts, sketches, and spoofs', 45, 'episode'),
      show('ad-4', 'END CREDITS', 'A history of the worst sequel', 30, 'documentary'),
    ],
  },
  {
    id: 'tha-spot-live',
