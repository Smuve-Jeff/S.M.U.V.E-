...
const DEEP_MUSIC_QUESTIONS: QuestionnaireQuestion[] = [
  ...
  },
  {
    ...
    type: 'textarea',
    weight: 8,
    text: 'What contradiction or tension makes your perspective yours?',
    description: 'The most memorable artists hold two truths at once. Name the tension S.M.U.V.E. should protect instead of smoothing away.',
    field: 'musicalJourney.musicBlueprint.signatureTension',
    placeholder: 'I make celebratory music about..., or I am both... and...',
    aiContextHint: 'A productive contradiction creates a memorable point of view and prevents generic artist language.',
  },
  {
    id: 'q67',
    phase: 'identity',
    type: 'textarea',
    weight: 7,
    text: 'Which lived-world details should only belong to your story?',
    description: 'Share places, rituals, objects, phrases, or experiences that give your music a real address.',
    field: 'musicalJourney.musicBlueprint.livedWorldDetails',
    placeholder: 'Specific places, sounds, sayings, routines, or memories...',
    aiContextHint: 'Concrete details make bios, lyrics, visuals, and campaigns recognizably yours.',
  },
  {
    id: 'q68',
    phase: 'musical-dna',
    type: 'textarea',
    weight: 8,
    text: 'What sonic choice will you not compromise, even when trends change?',
    description: 'Define the musical or production boundary that makes your work yours: a texture, rhythm, voice, silence, or rule.',
    field: 'musicalJourney.musicBlueprint.sonicNonNegotiables',
    placeholder: 'There must always be..., and I will never...',
    aiContextHint: 'Non-negotiables turn taste into repeatable creative direction and a durable sonic moat.',
  },
  {
    id: 'q69',
    ...
    type: 'textarea',
    weight: 7,
    text: 'What should a listener recognize within your first ten seconds?',
    description: 'Describe the opening cue, phrase, texture, rhythm, or emotional signal that makes your work identifiable before the name appears.',
    field: 'musicalJourney.musicBlueprint.recognitionCue',
    placeholder: 'The first thing people should recognize is...',
    aiContextHint: 'A recognition cue helps S.M.U.V.E. evaluate hooks, intros, content cuts, and release consistency.',
  },
];
