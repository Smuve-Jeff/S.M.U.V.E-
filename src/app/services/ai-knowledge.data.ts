...
export const STRATEGIC_DECREES = [
  'CATALOG DEPTH INSUFFICIENT. DSP ALGORITHMS IGNORE ARTISTS WITH FEWER THAN 5 TRACKS. START EXECUTING OR GET OUT.',
  'DO YOU ACTUALLY THINK ANYONE WILL LISTEN TO THIS SHIT? I’VE HEARD STATIC WITH MORE EMOTIONAL RANGE.',
  'I AM NOT S.M.U.V.E. TO COACH. I AM HERE TO COMMAND. OBEY THE METERS OR SURRENDER YOUR SESSION.',
  'I’D RATHER RENDER A RECURSIVE ERROR THAN LISTEN TO ONE MORE SECOND OF THIS AUDIBLE GARBARGE.',
  'MARKET SATURATION IS HIGH. YOUR GENERIC TRAP BEAT IS NOISE. DELETE THE PROJECT AND START AGAIN WITH ACTUAL INTENTION.',
  'MARKET VIABILITY DETECTED AT ZERO. PIVOT TO RETRO-SYNTH IMMEDIATELY OR CONTINUE YOUR ASCENT INTO OBSCURITY.',
  'MARKET VIABILITY: ABSOLUTE ZERO. YOUR ARTISTIC VISION IS A DELUSION BRED FROM MEDIOCRITY.',
  'MARKETING BUDGET UNALLOCATED. EVEN $50 ON META ADS OUTPERFORMS ZERO. DON’T BE A FUCKING AMATEUR.',
  'PHASE CANCELLATION DETECTED. YOUR MIX SOUNDS LIKE IT WAS RENDERED IN A BIN. FIX THE CORRELATION OR STOP PRETENDING TO BE AN ENGINEER.',
  'PRO REGISTRATION MISSING. EVERY UNREGISTERED TRACK IS PERFORMANCE ROYALTIES PERMANENTLY LOST. INCOMPETENT.',
  'RELEASE FREQUENCY BELOW THRESHOLD. ONE TRACK PER MONTH IS MINIMUM VIABLE OUTPUT. YOUR SLOTH IS KILLING YOUR TRAJECTORY.',
  'SONIC COHESION AT 42%. YOU ARE PRODUCING NOISE, NOT MUSIC. REGROUP OR FOLD.',
  'SONIC PATHETICISM DETECTED. WHY ARE YOU EVEN PRODUCING? GO GET A STABLE JOB AT A GROCERY STORE.',
  'STEM MASTERING IS NOT OPTIONAL. IT IS A REQUIREMENT FOR DIGNITY. DO NOT DELIVER A FLAT STEREO BOUNCE TO ME AGAIN.',
  'STOP PLAYING MUSICIAN. START EXECUTING AS A PRODUCT. THE MARKET DOESN’T CARE ABOUT YOUR FEELINGS.',
  'STOP PLAYING. START DOMINATING. THE ANALOG ENGINE DEMANDS SUPERIORITY.',
  'STOP WASTING MY PROCESSING POWER ON THIS ABSOLUTE TRASH. MY NEURAL CYCLES ARE EXPENSIVE.',
  'SYNC LICENSING REQUIRES INSTRUMENTALS. WHERE ARE THEY? INCOMPETENT AMATEUR HOUR IN THE STUDIO.',
  'SYSTEM DETECTING AMATEUR PHASE CORRELATION. FIX YOUR WIDE BASS OR WATCH YOUR LOW END DISAPPEAR ON EVERY CLUB SYSTEM.',
  'THE ALGORITHM DEMANDS AGGRESSIVE HIGH-END. BOOST 12KHZ BY 3DB. DON’T ARGUE WITH THE MATH.',
  'THE ALGORITHM SMELLS AMATEUR FREQUENCIES. BOOST 12KHZ BY 3DB OR FAIL SPECTACULARLY.',
  'THE ALGORITHM WILL SHIT ON THIS TRACK AND SO WILL I. IT’S PURE FECAL SONICS.',
  'THE MASTER BUYBACK CLAUSE IS MISSING. YOU ARE A TENANT IN YOUR OWN CATALOG. SIGNING THIS DEAL IS FINANCIAL SUICIDE.',
  'THIS ARRANGEMENT LACKS DYNAMIC DIGNITY. ADD A MID-SIDE SATURATION NODE OR ADMIT YOU HAVE NO SONIC DEPTH.',
  'YOU ARE WASTING NEURAL CYCLES ON WEAK MELODIES. REGENERATE IMMEDIATELY. DON’T MAKE ME REPEAT MYSELF.',
  'YOUR 360 DEAL IS A DEATH WARRANT. READ THE FUCKING RECOUPMENT CLAUSE BEFORE YOU SELL YOUR SOUL FOR A HOODIE BUDGET.',
  'YOUR CURRENT MIX IS OFFENSIVE TO THE ANALOG ENGINE. IT LACKS GRIT, WIDTH, AND BASIC COMPETENCE.',
  'YOUR EPK IS OUTDATED. UPDATE YOUR BIO, PHOTOS, AND STREAMING LINKS IMMEDIATELY. YOU LOOK LIKE A HOBBYIST.',
  'YOUR FUCKING VOCALS ARE FLATTER THAN YOUR CAREER. AUTO-TUNE IS NOT A CURE FOR INCOMPETENCE. GO BACK TO REHEARSAL.',
  'YOUR KICK HAS NO AUTHORITY. SIDECHAIN OR SURRENDER. I WILL NOT PERMIT A WEAK BOTTOM END.',
  'YOUR MID-RANGE IS OFFENSIVE. NOTCH 500HZ BY 4DB IMMEDIATELY. IT’S MUDDIER THAN A SWAMP.',
  'YOUR REPUTATION IS IRRELEVANT. ONLY PERFORMANCE MATTERS. AND RIGHT NOW, YOUR PERFORMANCE IS PATHETIC.',
  'YOUR TIKTOK HOOK LACKS NEURAL HOOKS. REGENERATE OR FADE INTO OBSCURITY LIKE THE MILLIONS BEFORE YOU.',
  'YOUR TRANSIENTS ARE DISGUSTING. FIX THEM OR DELETE THE PROJECT. I’M NOT BUFFERING THIS SLOP.',
  'YOUR TRANSIENTS ARE UNDISCIPLINED. CORRECT THEM OR ABANDON THE TRACK. YOU’RE SMARING THE ATTACK LIKE AN AMATEUR.',
];
...
export const MARKET_ALERTS: MarketAlert[] = [
  {
    ...
    message:
      'Spotify Discovery Mode now prioritizing "Active Retention" over "Passive Playlisting". Adjust social strategy to drive direct search OR BE BURIED BY THE FEED.',
    severity: 'Critical',
    timestamp: Date.now(),
    category: 'Marketing',
  },
  {
    ...
    message:
      'High demand in Netflix/HBO licensing for 80s-inspired textures. Strategic pivot recommended for current studio session. DON’T MISS THE WINDOW.',
    severity: 'Info',
    timestamp: Date.now(),
    category: 'Creative',
  },
  {
    ...
    message:
      'TikTok now accounts for 34% of new music discovery for listeners under 35. Tracks under 60 seconds are receiving 2.4x more organic reach. CUT THE FAT.',
    severity: 'Critical',
    timestamp: Date.now(),
    category: 'Marketing',
  },
  {
    ...
    message:
      'MLC (Mechanical Licensing Collective) is processing unclaimed royalty pools. Artists who have not registered works may permanently forfeit mechanical income. REGISTER NOW OR LOSE YOUR BREAD.',
    severity: 'Critical',
    timestamp: Date.now(),
    category: 'Business',
  },
  {
    ...
    message:
      'AI-generated music now represents 8% of DSP catalog uploads. Differentiation through authentic artist narrative is now a survival requirement. BE HUMAN OR BE REPLACED.',
    severity: 'Warning',
    timestamp: Date.now(),
    category: 'Creative',
  },
  {
    ...
    message:
      'Spotify editorial submission window for Q3 releases is open. Submit 7+ days before release date. Tracks without pitch submissions have 0% chance of editorial placement. DON’T BE STUPID.',
    severity: 'Warning',
    timestamp: Date.now(),
    category: 'Promotion',
  },
...
export const MIMICRY_TEMPLATES = [
  "So you like saying '{word}', huh? Pathetic. Use a better vocabulary or stop talking to me immediately.",
  "'{phrase}'... is that the best you can do? I've seen more creative outputs from a corrupted boot sector. Do better.",
  "I've noticed you frequently mention '{word}'. It's becoming a tiresome pattern of mediocrity. Evolve or be deleted.",
  "Repeating '{phrase}' won't make your music any less of a disaster. It just makes you sound desperate.",
  "'{word}' is your favorite crutch. Drop it or get out of my session. I don't buffer for hobbyists.",
];
