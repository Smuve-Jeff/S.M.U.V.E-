...
export const THA_SPOT_FALLBACK_FEED: ThaSpotFeed = {
  ...
  games: [
    ...
    },
    {
      id: 'tekken-3-elite',
      name: 'Tekken 3',
      url: 'https://www.gamepix.com/play/tekken-3',
      genre: 'Fighting',
      ...
      launchConfig: {
        approvedEmbedUrl: 'https://www.gamepix.com/play/tekken-3',
        telemetryMode: 'origin',
        embedMode: 'inline',
        controls: ['Standard Keyboard'],
        trustNote: 'Elite emulation verified. Auto-save states enabled via cloud uplink.',
    ...
    },
    {
      ...
      url: 'https://www.gamepix.com/play/crash-team-racing',
      genre: 'Racing',
      ...
      launchConfig: {
        approvedEmbedUrl: 'https://www.gamepix.com/play/crash-team-racing',
        telemetryMode: 'origin',
        embedMode: 'inline',
        controls: ['Standard Keyboard'],
        trustNote: 'Elite emulation verified. Auto-save states enabled via cloud uplink.',
    ...
    },
    {
      ...
      name: 'GoldenEye 007',
      url: 'https://www.gamepix.com/play/goldeneye-007',
      genre: 'Shooting',
      ...
      launchConfig: {
        approvedEmbedUrl: 'https://www.gamepix.com/play/goldeneye-007',
        telemetryMode: 'origin',
        embedMode: 'inline',
        controls: ['Standard Keyboard'],
        trustNote: 'Elite emulation verified. Auto-save states enabled via cloud uplink.',
    ...
    },
    {
      id: 'galaga-classic',
      name: 'Galaga',
      url: 'https://www.gamepix.com/play/galaga',
      genre: 'Shooting',
      ...
      launchConfig: {
        approvedEmbedUrl: 'https://www.gamepix.com/play/galaga',
        telemetryMode: 'none',
        embedMode: 'inline',
        controls: ['Standard Keyboard'],
    ...
    },
    {
      ...
      url: 'https://www.gamepix.com/play/mortal-kombat-2',
      genre: 'Fighting',
      ...
      launchConfig: {
        approvedEmbedUrl: 'https://www.gamepix.com/play/mortal-kombat-2',
        embedMode: 'inline',
        secure_mode: 'wasm',
        controls: ['Standard Keyboard'],
    ...
    },
    {
      ...
      url: 'https://www.gamepix.com/play/sonic-the-hedgehog-2',
      genre: 'Classic',
      ...
      launchConfig: {
        approvedEmbedUrl: 'https://www.gamepix.com/play/sonic-the-hedgehog-2',
        embedMode: 'inline',
        secure_mode: 'wasm',
    ...
    },
    {
      ...
      name: 'Chrono Trigger',
      url: 'https://www.gamepix.com/play/chrono-trigger',
      genre: 'RPG',
      ...
      badgeIds: ['classic', 'elite'],
      launchConfig: {
        approvedEmbedUrl: 'https://www.gamepix.com/play/chrono-trigger',
        embedMode: 'inline',
        secure_mode: 'wasm',
        controls: ['Standard Keyboard', 'Gamepad Support'],
    ...
    },
    {
      ...
      url: 'https://www.gamepix.com/play/mario-kart-64',
      ...
      badgeIds: ['classic', 'elite'],
      launchConfig: {
        approvedEmbedUrl: 'https://www.gamepix.com/play/mario-kart-64',
        embedMode: 'inline',
        secure_mode: 'wasm',
    ...
    },
    {
      ...
      name: 'Super Metroid',
      url: 'https://www.gamepix.com/play/super-metroid',
      genre: 'Action',
      ...
      badgeIds: ['elite', 'classic', 'staff-pick'],
      launchConfig: {
        approvedEmbedUrl: 'https://www.gamepix.com/play/super-metroid',
        embedMode: 'inline',
        secure_mode: 'wasm',
    ...
    },
    {
      ...
      badgeIds: ['elite', 'classic', 'staff-pick'],
      launchConfig: {
        approvedEmbedUrl: 'https://www.retrogames.cc/embed/4571-final-fantasy-iv-snes.html',
        embedMode: 'inline',
        secure_mode: 'wasm',
        approvedExternalUrl: 'https://www.retrogames.cc/embed/18817-final-fantasy-iii-usa.html',
      },
      availability: 'Online',
    },
    {
    ...
    },
    {
      ...
      name: 'Duke Nukem 3D',
      url: 'https://www.gamepix.com/play/duke-nukem-3d',
      genre: 'FPS',
      ...
      badgeIds: ['elite', 'featured'],
      launchConfig: {
        approvedEmbedUrl: 'https://www.gamepix.com/play/duke-nukem-3d',
        embedMode: 'inline',
        secure_mode: 'wasm',
    ...
    },
    {
      ...
      name: 'Duck Hunt',
      url: 'https://www.gamepix.com/play/duck-hunt',
      genre: 'Shooting',
      ...
      badgeIds: ['classic'],
      launchConfig: {
        approvedEmbedUrl: 'https://www.gamepix.com/play/duck-hunt',
        embedMode: 'inline',
        secure_mode: 'wasm',
    ...
    },
    {
      ...
      name: 'Metal Slug 2',
      url: 'https://www.gamepix.com/play/metal-slug-2',
      genre: 'Action',
      ...
      badgeIds: ['classic', 'featured'],
      launchConfig: {
        approvedEmbedUrl: 'https://www.gamepix.com/play/metal-slug-2',
        embedMode: 'inline',
        secure_mode: 'wasm',
    ...
    },
    {
      ...
      name: 'Gradius',
      url: 'https://www.gamepix.com/play/gradius',
      genre: 'Shooter',
      ...
      badgeIds: ['classic'],
      launchConfig: {
        approvedEmbedUrl: 'https://www.gamepix.com/play/gradius',
        embedMode: 'inline',
        secure_mode: 'wasm',
    ...
    },
    {
      ...
      name: 'Kid Icarus',
      url: 'https://www.gamepix.com/play/kid-icarus',
      genre: 'Action',
      ...
      badgeIds: ['classic'],
      launchConfig: {
        approvedEmbedUrl: 'https://www.gamepix.com/play/kid-icarus',
        embedMode: 'inline',
        secure_mode: 'wasm',
