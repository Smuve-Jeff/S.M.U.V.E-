...
export const THA_SPOT_FALLBACK_FEED: ThaSpotFeed = {
  ...
  rooms: [
    ...
    },
    {
      ...
      name: 'NEO_ZONE',
      description:
        'Next-Gen execution. High-fidelity WebGL and browser-native cabinets.',
      icon: 'auto_awesome',
    },
  ],
  liveEvents: [
  ...
  games: [
    {
      ...
      genre: 'RPG',
      description:
        'Absolute high-fidelity RPG action. Experience Final Fantasy IX in a stabilized browser environment.',
      tags: ['RPG', 'Retro', 'Elite', 'Stabilized'],
      badgeIds: ['elite', 'classic'],
      launchConfig: {
        approvedEmbedUrl:
          'https://www.retrogames.cc/embed/40424-final-fantasy-ix-usa-disc-1.html',
        embedMode: 'inline',
        secure_mode: 'wasm',
      },
    },
    {
      ...
      url: 'https://venge.io/',
      description:
        'High-octane WebGL tactical shooter. Absolute precision required.',
      genre: 'FPS',
      rating: 4.7,
      playersOnline: 8900,
      availability: 'Online',
    ...
    },
    {
      ...
      description:
        'Absolute high-fidelity procedural driving. S.M.U.V.E. relaxation protocols enabled.',
      genre: 'Racing',
      rating: 4.8,
      playersOnline: 5400,
      availability: 'Online',
    ...
    },
    {
      ...
      genre: 'Action',
      description:
        'The Absolute original. High-definition top-down urban chaos. S.M.U.V.E. stabilized execution.',
      availability: 'Online',
      playersOnline: 12800,
      rating: 4.9,
      badgeIds: ['featured', 'staff-pick', 'elite'],
    ...
    },
    {
      ...
      genre: 'Action',
      description:
        'Return to Los Santos in the Absolute masterpiece. High-performance, high-definition emulation.',
      availability: 'Online',
      playersOnline: 45000,
      rating: 5,
    ...
    },
    {
      ...
      genre: 'Action',
      description:
        'Neon-soaked 80s in Absolute high-definition. S.M.U.V.E. demands total control.',
    ...
    },
    {
      ...
      genre: 'Action',
      description:
        'Liberty City in Absolute 3D. High-fidelity PS2-era execution. Dominate the streets.',
    ...
    },
    {
      ...
      description:
        'The original Minecraft creative mode, playable in your browser. Build anything you can imagine.',
      genre: 'Sandbox',
      rating: 4.8,
      playersOnline: 5000,
      availability: 'Online',
    ...
    },
    {
      ...
      description:
        'The legendary cinematic platformer perfectly recreated in JavaScript. 60 minutes to save the princess.',
      genre: 'Platformer',
      rating: 4.7,
      playersOnline: 300,
      availability: 'Online',
    ...
    },
    {
      ...
      description:
        'The original Diablo (1996) shareware version running in your browser. Experience the depths of Tristram.',
      genre: 'Action RPG',
      rating: 4.9,
      playersOnline: 800,
      availability: 'Online',
      tags: ['RPG', 'Classic', 'Dungeon Crawler'],
      badgeIds: ['classic', 'elite'],
    ...
    },
    {
      ...
      description:
        'Legendary fast-paced arena shooter. Frag your friends in this web-based port of Quake.',
      genre: 'FPS',
      rating: 4.8,
      playersOnline: 1200,
      availability: 'Online',
    ...
    },
    {
      ...
      url: 'https://www.retrogames.cc/embed/23550-super-street-fighter-ii-the-new-challengers-usa.html',
      description:
        'The definitive fighting game experience. Master the Hadouken and climb the world tournament.',
      genre: 'Fighting',
      rating: 4.9,
      playersOnline: 2500,
      availability: 'Online',
    ...
    },
    {
      ...
      description:
        'Break ankles. Absolute streetball dominance. S.M.U.V.E. approved high-fidelity run.',
      genre: 'Sports',
      rating: 5.0,
      playersOnline: 18000,
      availability: 'Online',
    ...
    },
    {
      ...
      description:
        'Top-tier MOBA experience. 5v5 tactical dominance. S.M.U.V.E. strategic grade.',
      genre: 'MOBA',
      rating: 4.8,
      playersOnline: 120000,
      availability: 'Online',
      tags: ['MOBA', 'Strategy', 'Multiplayer', 'Elite'],
      badgeIds: ['trending', 'elite'],
      launchConfig: {
    ...
    },
    {
      ...
      description:
        'High-quality community-led MOBA project. S.M.U.V.E. approved tactical sim.',
      genre: 'MOBA',
      rating: 4.7,
      playersOnline: 5000,
      availability: 'Online',
    ...
    },
    {
      ...
      description:
        'High-fidelity modern WebGL football simulation. Smooth 3D gameplay.',
      genre: 'Sports',
      rating: 4.8,
      playersOnline: 25000,
      availability: 'Online',
      tags: ['Sports', 'Football', '3D', 'Modern'],
      badgeIds: ['featured'],
      launchConfig: {
        approvedEmbedUrl:
          'https://www.gamepix.com/play/soccer-skills-world-cup',
        embedMode: 'inline',
      },
    },
    {
      ...
      description:
        "The Absolute god of war experience. High-fidelity PS2 emulation for Kratos' journey. S.M.U.V.E. demands rage.",
      ...
      launchConfig: {
        approvedEmbedUrl:
          'https://www.retrogames.cc/embed/41220-god-of-war-usa.html',
        embedMode: 'inline',
        secure_mode: 'wasm',
      },
    },
    {
      ...
      description:
        'The Absolute fighting game. Master the iron fist. High-performance PS2 core.',
      genre: 'Fighting',
      rating: 4.9,
      playersOnline: 14000,
      availability: 'Online',
      ...
      launchConfig: {
        approvedEmbedUrl:
          'https://www.retrogames.cc/embed/41258-tekken-5-usa.html',
        embedMode: 'inline',
        secure_mode: 'wasm',
      },
    },
    {
      ...
      description:
        'High-intensity anime combat. S.M.U.V.E. power levels are Absolute.',
      genre: 'Fighting',
      rating: 4.9,
      playersOnline: 11000,
      availability: 'Online',
      ...
      launchConfig: {
        approvedEmbedUrl:
          'https://www.retrogames.cc/embed/41261-dragon-ball-z-budokai-3-usa.html',
        embedMode: 'inline',
        secure_mode: 'wasm',
      },
    },
    {
      ...
      url: '/assets/games/halo-ce-web/halo-ce-web.html',
      description:
        'The Absolute shooter. Master the Chief. S.M.U.V.E. demands tactical superiority.',
      genre: 'FPS',
      rating: 5.0,
      playersOnline: 30000,
      availability: 'Online',
      tags: ['FPS', 'Multiplayer', 'Xbox', 'Elite'],
      badgeIds: ['classic', 'elite', 'featured'],
      launchConfig: {
        approvedEmbedUrl: '/assets/games/halo-ce-web/halo-ce-web.html',
        embedMode: 'inline',
    ...
    },
    {
      ...
      description:
        'Absolute survival horror. S.M.U.V.E. demands high-stakes precision.',
      genre: 'Survival Horror',
      rating: 5.0,
      playersOnline: 12000,
      availability: 'Online',
      tags: ['Horror', 'Adventure', 'PS2', 'Elite'],
      badgeIds: ['classic', 'elite'],
      launchConfig: {
        approvedEmbedUrl:
          'https://www.retrogames.cc/embed/41252-resident-evil-4-usa.html',
        embedMode: 'inline',
        secure_mode: 'wasm',
      },
    },
    ...
    },
    {
      ...
      genre: 'Action',
      description:
        'Respect is everything. The Absolute top-down sequel with multi-gang loyalty systems and high-fidelity chaos.',
      rating: 4.8,
      playersOnline: 8500,
      availability: 'Online',
    ...
    },
    {
      ...
      genre: 'Action',
      description:
        "You're nicked! The Absolute expansion taking the chaos to the streets of London. High-fidelity mod implementation.",
      rating: 4.7,
      playersOnline: 4200,
      availability: 'Online',
      tags: ['Action', 'Retro', 'PC', 'Elite'],
    ...
    },
    {
      ...
      genre: 'Sports',
      description:
        'Elite WebGL Tribute. High-fidelity browser-native execution for EA SPORTS FC 24.',
      rating: 4.8,
      playersOnline: 180000,
      availability: 'Online',
      tags: ['Sports', 'Soccer', 'WebGL', 'Elite', 'Internal'],
    ...
    },
    {
      ...
      genre: 'Sports',
      description:
        'Elite WebGL Tribute. High-fidelity browser-native execution for Madden NFL 24.',
      rating: 4.7,
      playersOnline: 85000,
      availability: 'Online',
      tags: ['Sports', 'NFL', 'WebGL', 'Elite', 'Internal'],
      badgeIds: ['next-gen', 'elite'],
      art: {
        eyebrow: 'EA Sports Elite',
        accentStart: '#dc2626',
    ...
    },
    {
      ...
      genre: 'Sports',
      description:
        'Elite WebGL Tribute. High-fidelity browser-native execution for NBA 2K24.',
      rating: 4.6,
      playersOnline: 95000,
      availability: 'Online',
      tags: ['Sports', 'NBA', 'WebGL', 'Elite', 'Internal'],
      badgeIds: ['next-gen', 'elite'],
      art: {
        eyebrow: '2K Elite',
        accentStart: '#ea580c',
    ...
    },
    {
      ...
      genre: 'Action',
      description:
        'Absolute high-fidelity Action action. Experience Resident Evil 3 in a stabilized browser environment.',
      tags: ['Action', 'Retro', 'Elite', 'Stabilized'],
      badgeIds: ['elite', 'classic'],
      launchConfig: {
        approvedEmbedUrl:
          'https://www.retrogames.cc/embed/40579-resident-evil-3-nemesis.html',
        embedMode: 'inline',
        secure_mode: 'wasm',
      },
    },
    {
      ...
      genre: 'MOBA',
      description:
        'Absolute MOBA competition. High-fidelity tactical team battles.',
      rating: 4.7,
      playersOnline: 1000000,
      availability: 'Online',
      tags: ['MOBA', 'Competitive', 'Elite'],
      badgeIds: ['elite'],
      art: {
    ...
    },
    {
      ...
      genre: 'Fighting',
      description:
        'Absolute high-fidelity Fighting action. Experience Marvel vs Capcom 2 in a stabilized browser environment.',
      tags: ['Fighting', 'Retro', 'Elite', 'Stabilized'],
      badgeIds: ['elite', 'classic'],
      launchConfig: {
        approvedEmbedUrl:
          'https://www.retrogames.cc/embed/10055-marvel-vs-capcom-2-new-age-of-heroes.html',
        embedMode: 'inline',
        secure_mode: 'wasm',
      },
    },
    {
      ...
      genre: 'Racing',
      description:
        'Elite WebGL Tribute. High-fidelity browser-native execution for Forza Horizon 5.',
      rating: 5.0,
      playersOnline: 150000,
      availability: 'Online',
      tags: ['Racing', 'Open World', 'WebGL', 'Elite', 'Internal'],
      badgeIds: ['next-gen', 'elite'],
      art: {
    ...
    },
    {
      ...
      genre: 'Fighting',
      description:
        'Absolute high-fidelity Fighting action. Experience Tekken Tag Tournament in a stabilized browser environment.',
      tags: ['Fighting', 'Retro', 'Elite', 'Stabilized'],
      badgeIds: ['elite', 'classic'],
      launchConfig: {
        approvedEmbedUrl:
          'https://www.retrogames.cc/embed/10043-tekken-tag-tournament.html',
        embedMode: 'inline',
        secure_mode: 'wasm',
      },
    },
    {
      ...
      genre: 'MOBA',
      description:
        'Elite WebGL Tribute. High-fidelity browser-native execution for League of Legends.',
      rating: 4.9,
      playersOnline: 2000000,
      availability: 'Online',
      tags: ['MOBA', 'Competitive', 'WebGL', 'Elite', 'Internal'],
      badgeIds: ['next-gen', 'elite'],
      art: {
        eyebrow: 'Riot Elite',
        accentStart: '#3b82f6',
    ...
    },
    {
      ...
      genre: 'Fighting',
      description:
        'Absolute high-fidelity Fighting action. Experience Capcom vs SNK 2 in a stabilized browser environment.',
      tags: ['Fighting', 'Retro', 'Elite', 'Stabilized'],
      badgeIds: ['elite', 'classic'],
      launchConfig: {
        approvedEmbedUrl:
          'https://www.retrogames.cc/embed/10061-capcom-vs-snk-2-millionaire-fighting-2001.html',
        embedMode: 'inline',
        secure_mode: 'wasm',
      },
    },
    {
      ...
      genre: 'Fighting',
      description:
        'Absolute high-fidelity Fighting action. Experience SoulCalibur II in a stabilized browser environment.',
      tags: ['Fighting', 'Retro', 'Elite', 'Stabilized'],
      badgeIds: ['elite', 'classic'],
      launchConfig: {
        approvedEmbedUrl:
          'https://www.retrogames.cc/embed/10071-soulcalibur-ii.html',
        embedMode: 'inline',
        secure_mode: 'wasm',
      },
    },
    {
      ...
      genre: 'Racing',
      description:
        'Elite WebGL Tribute. High-fidelity browser-native execution for Forza Motorsport.',
      rating: 4.6,
      playersOnline: 20000,
      availability: 'Online',
      tags: ['Racing', 'Simulation', 'WebGL', 'Elite', 'Internal'],
      badgeIds: ['next-gen', 'elite'],
      art: {
    ...
    },
    {
      ...
      genre: 'Action',
      description:
        'Absolute high-fidelity Action action. Experience Metal Gear Solid 2 in a stabilized browser environment.',
      tags: ['Action', 'Retro', 'Elite', 'Stabilized'],
      badgeIds: ['elite', 'classic'],
      launchConfig: {
        approvedEmbedUrl:
          'https://www.retrogames.cc/embed/42774-metal-gear-solid-2-sons-of-liberty.html',
        embedMode: 'inline',
        secure_mode: 'wasm',
      },
    },
    {
      ...
      genre: 'Action',
      description:
        'Absolute high-fidelity Action action. Experience Silent Hill 2 in a stabilized browser environment.',
      tags: ['Action', 'Retro', 'Elite', 'Stabilized'],
      badgeIds: ['elite', 'classic'],
      launchConfig: {
        approvedEmbedUrl:
          'https://www.retrogames.cc/embed/42775-silent-hill-2.html',
        embedMode: 'inline',
        secure_mode: 'wasm',
      },
    },
    {
      ...
      genre: 'RPG',
      description:
        'Absolute high-fidelity RPG action. Experience Final Fantasy X in a stabilized browser environment.',
      tags: ['RPG', 'Retro', 'Elite', 'Stabilized'],
      badgeIds: ['elite', 'classic'],
      launchConfig: {
        approvedEmbedUrl:
    ...
    },
    {
      ...
      genre: 'RPG',
      description:
        'Absolute high-fidelity RPG action. Experience Kingdom Hearts in a stabilized browser environment.',
      tags: ['RPG', 'Retro', 'Elite', 'Stabilized'],
      badgeIds: ['elite', 'classic'],
      launchConfig: {
        approvedEmbedUrl:
          'https://www.retrogames.cc/embed/42779-kingdom-hearts.html',
        embedMode: 'inline',
        secure_mode: 'wasm',
      },
    },
    {
      ...
      genre: 'Racing',
      description:
        'Elite WebGL Tribute. High-fidelity browser-native execution for Rocket League.',
      rating: 4.9,
      playersOnline: 400000,
      availability: 'Online',
      tags: ['Sports', 'Racing', 'WebGL', 'Elite', 'Internal'],
      badgeIds: ['next-gen', 'elite'],
      art: {
    ...
    },
    {
      ...
      genre: 'Fighting',
      description:
        'Elite WebGL Tribute. High-fidelity browser-native execution for Tekken 8.',
      rating: 4.9,
      playersOnline: 45000,
      availability: 'Online',
    ...
    },
    {
      ...
      genre: 'Action',
      description:
        'Absolute high-fidelity Action action. Experience GTA Vice City Elite in a stabilized browser environment.',
      tags: ['Action', 'Retro', 'Elite', 'Stabilized'],
      badgeIds: ['elite', 'classic'],
      launchConfig: {
        approvedEmbedUrl:
    ...
    },
    {
      ...
      genre: 'Action',
      description:
        'Absolute high-fidelity Action action. Experience GTA III Elite in a stabilized browser environment.',
      tags: ['Action', 'Retro', 'Elite', 'Stabilized'],
      badgeIds: ['elite', 'classic'],
      launchConfig: {
        approvedEmbedUrl:
    ...
    },
    {
      ...
      genre: 'Sports',
      description:
        'Absolute high-fidelity Sports action. Experience Tony Hawk 3 in a stabilized browser environment.',
      tags: ['Sports', 'Retro', 'Elite', 'Stabilized'],
      badgeIds: ['elite', 'classic'],
      launchConfig: {
        approvedEmbedUrl:
          'https://www.retrogames.cc/embed/41030-tony-hawk-s-pro-skater-3.html',
        embedMode: 'inline',
        secure_mode: 'wasm',
      },
    },
    {
      ...
      genre: 'Sports',
      description:
        'Absolute high-fidelity Sports action. Experience SSX Tricky in a stabilized browser environment.',
      tags: ['Sports', 'Retro', 'Elite', 'Stabilized'],
      badgeIds: ['elite', 'classic'],
      launchConfig: {
        approvedEmbedUrl:
          'https://www.retrogames.cc/embed/42780-ssx-tricky.html',
        embedMode: 'inline',
        secure_mode: 'wasm',
      },
    },
    {
      ...
      genre: 'Racing',
      description:
        'Absolute high-fidelity Racing action. Experience Burnout 3 in a stabilized browser environment.',
      tags: ['Racing', 'Retro', 'Elite', 'Stabilized'],
      badgeIds: ['elite', 'classic'],
      launchConfig: {
        approvedEmbedUrl:
          'https://www.retrogames.cc/embed/42781-burnout-3-takedown.html',
        embedMode: 'inline',
        secure_mode: 'wasm',
      },
    },
    {
      ...
      genre: 'Racing',
      description:
        'Absolute high-fidelity Racing action. Experience Need for Speed Underground 2 in a stabilized browser environment.',
      tags: ['Racing', 'Retro', 'Elite', 'Stabilized'],
      badgeIds: ['elite', 'classic'],
      launchConfig: {
        approvedEmbedUrl:
          'https://www.retrogames.cc/embed/42782-need-for-speed-underground-2.html',
        embedMode: 'inline',
        secure_mode: 'wasm',
      },
    },
    {
      ...
      genre: 'Racing',
      description:
        'Elite WebGL Tribute. High-fidelity browser-native execution for Forza Horizon 4.',
      rating: 4.9,
      playersOnline: 30000,
      availability: 'Online',
      tags: ['Racing', 'Open World', 'WebGL', 'Elite', 'Internal'],
    ...
    },
    {
      ...
      genre: 'Action',
      description:
        'Absolute high-fidelity Action action. Experience Ratchet and Clank in a stabilized browser environment.',
      tags: ['Action', 'Retro', 'Elite', 'Stabilized'],
      badgeIds: ['elite', 'classic'],
      launchConfig: {
        approvedEmbedUrl:
          'https://www.retrogames.cc/embed/42783-ratchet-clank.html',
        embedMode: 'inline',
        secure_mode: 'wasm',
      },
    },
    {
      ...
      genre: 'Action',
      description:
        'Absolute high-fidelity Action action. Experience Jak and Daxter in a stabilized browser environment.',
      tags: ['Action', 'Retro', 'Elite', 'Stabilized'],
      badgeIds: ['elite', 'classic'],
      launchConfig: {
        approvedEmbedUrl:
          'https://www.retrogames.cc/embed/42784-jak-and-daxter-the-precursor-legacy.html',
        embedMode: 'inline',
        secure_mode: 'wasm',
      },
    },
    {
      ...
      genre: 'Action',
      description:
        'Absolute high-fidelity Action action. Experience Sly Cooper in a stabilized browser environment.',
      tags: ['Action', 'Retro', 'Elite', 'Stabilized'],
      badgeIds: ['elite', 'classic'],
      launchConfig: {
        approvedEmbedUrl:
          'https://www.retrogames.cc/embed/42785-sly-cooper-and-the-thievius-raccoonus.html',
        embedMode: 'inline',
        secure_mode: 'wasm',
      },
    },
    {
      ...
      genre: 'Action',
      description:
        'Absolute high-fidelity Action action. Experience God of War Elite in a stabilized browser environment.',
      tags: ['Action', 'Retro', 'Elite', 'Stabilized'],
      badgeIds: ['elite', 'classic'],
      launchConfig: {
        approvedEmbedUrl:
          'https://www.retrogames.cc/embed/42786-god-of-war.html',
        embedMode: 'inline',
        secure_mode: 'wasm',
      },
    },
    {
      ...
      genre: 'Action',
      description:
        'Absolute high-fidelity Action action. Experience Devil May Cry 3 in a stabilized browser environment.',
      tags: ['Action', 'Retro', 'Elite', 'Stabilized'],
      badgeIds: ['elite', 'classic'],
      launchConfig: {
        approvedEmbedUrl:
          'https://www.retrogames.cc/embed/42787-devil-may-cry-3-dante-s-awakening.html',
        embedMode: 'inline',
        secure_mode: 'wasm',
      },
    },
    {
      ...
      genre: 'Fighting',
      description:
        'Elite WebGL Tribute. High-fidelity browser-native execution for Mortal Kombat 1.',
      rating: 4.8,
      playersOnline: 35000,
      availability: 'Online',
      tags: ['Fighting', 'Competitive', 'WebGL', 'Elite', 'Internal'],
    ...
    },
    {
      ...
      genre: 'Adventure',
      description:
        'Absolute high-fidelity Adventure action. Experience Okami in a stabilized browser environment.',
    ...
    },
    {
      ...
      genre: 'Adventure',
      description:
        'Absolute high-fidelity Adventure action. Experience Shadow of the Colossus in a stabilized browser environment.',
      tags: ['Adventure', 'Retro', 'Elite', 'Stabilized'],
      badgeIds: ['elite', 'classic'],
      launchConfig: {
        approvedEmbedUrl:
          'https://www.retrogames.cc/embed/42789-shadow-of-the-colossus.html',
        embedMode: 'inline',
        secure_mode: 'wasm',
      },
    },
    {
      ...
      genre: 'Action',
      description:
        'Absolute high-fidelity Action action. Experience Prince of Persia in a stabilized browser environment.',
      tags: ['Action', 'Retro', 'Elite', 'Stabilized'],
      badgeIds: ['elite', 'classic'],
      launchConfig: {
        approvedEmbedUrl:
          'https://www.retrogames.cc/embed/42790-prince-of-persia-the-sands-of-time.html',
        embedMode: 'inline',
        secure_mode: 'wasm',
      },
    },
    {
      ...
      genre: 'Action',
      description:
        'Absolute high-fidelity Action action. Experience Splinter Cell in a stabilized browser environment.',
      tags: ['Action', 'Retro', 'Elite', 'Stabilized'],
      badgeIds: ['elite', 'classic'],
      launchConfig: {
        approvedEmbedUrl:
          'https://www.retrogames.cc/embed/42791-tom-clancy-s-splinter-cell.html',
        embedMode: 'inline',
        secure_mode: 'wasm',
      },
    },
    {
      ...
      genre: 'RPG',
      description:
        'Absolute high-fidelity RPG action. Experience Star Wars: KOTOR in a stabilized browser environment.',
      tags: ['RPG', 'Retro', 'Elite', 'Stabilized'],
      badgeIds: ['elite', 'classic'],
      launchConfig: {
        approvedEmbedUrl:
          'https://www.retrogames.cc/embed/42792-star-wars-knights-of-the-old-republic.html',
        embedMode: 'inline',
        secure_mode: 'wasm',
      },
    },
    {
      ...
      genre: 'FPS',
      description:
        'Absolute high-fidelity FPS action. Experience Halo 2 Elite in a stabilized browser environment.',
    ...
    },
    {
      ...
      description:
        'The Absolute origin of stealth action. Optimized MSX2 emulation.',
      genre: 'Stealth',
      rating: 4.8,
      playersOnline: 1200,
      availability: 'Online',
      ...
      launchConfig: {
        approvedEmbedUrl:
          'https://www.retrogames.cc/embed/19318-metal-gear-japan.html',
        embedMode: 'inline',
      },
    },
    {
      ...
      description:
        "Castlevania's Absolute MSX2 execution. Explore the castle with precision.",
      genre: 'Action',
      rating: 4.7,
      playersOnline: 800,
      availability: 'Online',
      ...
      launchConfig: {
        approvedEmbedUrl:
          'https://www.retrogames.cc/embed/19321-vampire-killer-japan-europe.html',
        embedMode: 'inline',
      },
    },
    {
      ...
      genre: 'Sports',
      description:
        'The ultimate 8-bit football classic. Simple, addictive, and legendary. Featuring iconic arcade-style gridiron action.',
      availability: 'Online',
      playersOnline: 12400,
      rating: 4.9,
      badgeIds: ['classic', 'elite'],
      ...
      launchConfig: {
        approvedEmbedUrl:
          'https://www.retrogames.cc/embed/18844-tecmo-bowl-usa.html',
        embedMode: 'inline',
        secure_mode: 'wasm',
      },
      art: {
      ...
      image:
        'https://www.retrogames.cc/assets/images/screenshots/nes/tecmo-bowl-usa.png',
    },
    {
      id: 'nba-jam-elite',
      name: 'NBA Jam',
      ...
      genre: 'Sports',
      description:
        "HE'S ON FIRE! The definitive arcade basketball experience. High-flying dunks and intense 2-on-2 action.",
      availability: 'Online',
      playersOnline: 15600,
      rating: 5.0,
      badgeIds: ['classic', 'elite'],
      ...
      image:
        'https://www.retrogames.cc/assets/images/screenshots/arcade/nba-jam-usa.png',
    },
    {
      ...
      genre: 'Sports',
      description:
        'A turning point in basketball simulation. Featuring Michael Jordan and the deepest gameplay of its era.',
      availability: 'Online',
      playersOnline: 8900,
      rating: 4.7,
      badgeIds: ['classic', 'elite'],
      ...
      launchConfig: {
        approvedEmbedUrl:
          'https://www.retrogames.cc/embed/41887-nba-live-2000-usa.html',
        embedMode: 'inline',
        secure_mode: 'wasm',
      },
      art: {
      ...
      image:
        'https://www.retrogames.cc/assets/images/screenshots/psx/nba-live-2000-usa.png',
    },
    {
      ...
      description:
        'The definitive street-brawling classic. Save Marian and dominate the Black Warriors.',
      genre: "Beat 'em up",
      rating: 4.9,
      playersOnline: 1200,
      availability: 'Online',
      ...
      launchConfig: {
        ...
        embedMode: 'inline',
        approvedExternalUrl:
          'https://www.retrogames.cc/embed/8499-double-dragon-japan.html',
        approvedEmbedUrl:
          'https://www.retrogames.cc/embed/8499-double-dragon-japan.html',
        secure_mode: 'wasm',
      },
    ...
    },
    {
      ...
      description:
        'Experience the final chapter of the Z-Saga in this high-fidelity GBA masterpiece.',
      genre: 'RPG',
      rating: 4.8,
      playersOnline: 3400,
      availability: 'Online',
      ...
      launchConfig: {
        ...
        embedMode: 'inline',
        approvedExternalUrl:
          'https://www.retrogames.cc/embed/22409-dragon-ball-z-buu-s-fury-usa.html',
        approvedEmbedUrl:
          'https://www.retrogames.cc/embed/22409-dragon-ball-z-buu-s-fury-usa.html',
        secure_mode: 'wasm',
      },
    ...
    },
    {
      ...
      description:
        'The foundational gridiron experience. Pure football strategy and execution.',
      genre: 'Sports',
      rating: 4.6,
      playersOnline: 450,
      availability: 'Online',
      ...
      launchConfig: {
        ...
        embedMode: 'inline',
        approvedExternalUrl:
          'https://www.retrogames.cc/embed/16599-10-yard-fight-usa-europe.html',
        approvedEmbedUrl:
          'https://www.retrogames.cc/embed/16599-10-yard-fight-usa-europe.html',
        secure_mode: 'wasm',
      },
    ...
    },
    {
      ...
      description:
        'Where the Blue Bomber began. Precise platforming and legendary boss battles.',
      genre: 'Platformer',
      rating: 4.9,
      playersOnline: 1800,
      availability: 'Online',
      ...
      launchConfig: {
        ...
        embedMode: 'inline',
        approvedExternalUrl:
          'https://www.retrogames.cc/embed/17300-mega-man-usa.html',
        approvedEmbedUrl:
          'https://www.retrogames.cc/embed/17300-mega-man-usa.html',
        secure_mode: 'wasm',
      },
    ...
    },
    {
      ...
      description:
        'The Absolute boxing challenge. Rise through the ranks to face the Iron Mike.',
      genre: 'Sports',
      rating: 4.9,
      playersOnline: 950,
      availability: 'Online',
      ...
      launchConfig: {
        ...
        embedMode: 'inline',
        approvedExternalUrl:
          'https://www.retrogames.cc/embed/17355-mike-tyson-s-punch-out-usa.html',
        approvedEmbedUrl:
          'https://www.retrogames.cc/embed/17355-mike-tyson-s-punch-out-usa.html',
        secure_mode: 'wasm',
      },
    ...
    },
    {
      ...
      description:
        'The beginning of the legend. Explore Hyrule, conquer dungeons, and save Princess Zelda.',
      genre: 'Adventure',
      rating: 4.9,
      playersOnline: 2100,
      availability: 'Online',
      ...
      launchConfig: {
        ...
        embedMode: 'inline',
        approvedExternalUrl:
          'https://www.retrogames.cc/embed/17203-the-legend-of-zelda-usa.html',
        approvedEmbedUrl:
          'https://www.retrogames.cc/embed/17203-the-legend-of-zelda-usa.html',
        secure_mode: 'wasm',
      },
    ...
    },
    {
      ...
      launchConfig: {
        ...
        embedMode: 'inline',
        approvedExternalUrl:
          'https://www.retrogames.cc/embed/41728-grand-theft-auto-2.html',
        approvedEmbedUrl:
          'https://www.retrogames.cc/embed/41728-grand-theft-auto-2.html',
        secure_mode: 'wasm',
      },
    ...
    },
    {
      ...
      url: 'https://www.retrogames.cc/embed/41223-grand-theft-auto-vice-city-usa.html',
      description:
        'The Absolute high-quality classic version of GTA: Vice City.',
      genre: 'Action',
      rating: 4.9,
      playersOnline: 500,
      availability: 'Online',
    ...
    },
    {
      ...
      description:
        'The Absolute high-quality classic version of GTA: San Andreas.',
      genre: 'Action',
      rating: 4.9,
      playersOnline: 500,
      availability: 'Online',
    ...
    },
    {
      ...
      url: 'https://www.retrogames.cc/embed/18816-final-fantasy-usa.html',
      description:
        'The Absolute high-quality classic version of Final Fantasy.',
      genre: 'RPG',
      rating: 4.9,
      playersOnline: 500,
      availability: 'Online',
    ...
    },
    {
      ...
      url: 'https://www.retrogames.cc/embed/40425-final-fantasy-vii-usa-disc-1.html',
      description:
        'The Absolute high-quality classic version of Final Fantasy VII.',
      genre: 'RPG',
      rating: 4.9,
      playersOnline: 500,
      availability: 'Online',
    ...
    },
    {
      ...
      url: 'https://www.retrogames.cc/embed/42778-final-fantasy-x.html',
      description:
        'The Absolute high-quality classic version of Final Fantasy X.',
      genre: 'RPG',
      rating: 4.9,
      playersOnline: 500,
      availability: 'Online',
    ...
    },
    {
      ...
      url: 'https://www.retrogames.cc/embed/19018-street-fighter-ii-the-world-warrior-usa.html',
      description:
        'The Absolute high-quality classic version of Street Fighter II.',
      genre: 'Fighting',
      rating: 4.9,
      playersOnline: 500,
      availability: 'Online',
    ...
    },
    {
      ...
      url: 'https://www.retrogames.cc/embed/10001-street-fighter-iii-3rd-strike-fight-for-the-future-990512.html',
      description:
        'The Absolute high-quality classic version of Street Fighter III.',
      genre: 'Fighting',
      rating: 4.9,
      playersOnline: 500,
      availability: 'Online',
    ...
    },
    {
      ...
      url: 'https://www.retrogames.cc/embed/19139-double-dragon-usa.html',
      description:
        'The Absolute high-quality classic version of Double Dragon.',
      genre: "Beat 'em up",
      rating: 4.9,
      playersOnline: 500,
      availability: 'Online',
    ...
    },
    {
      ...
      description:
        'The Absolute high-quality classic version of Double Dragon II.',
      genre: "Beat 'em up",
      rating: 4.9,
      playersOnline: 500,
      availability: 'Online',
      ...
      launchConfig: {
        ...
        embedMode: 'inline',
        approvedExternalUrl:
          'https://www.retrogames.cc/embed/16729-double-dragon-ii-the-revenge-usa.html',
        approvedEmbedUrl:
          'https://www.retrogames.cc/embed/16729-double-dragon-ii-the-revenge-usa.html',
        secure_mode: 'wasm',
      },
    ...
    },
    {
      ...
      url: 'https://www.retrogames.cc/embed/22409-dragon-ball-z-buu-s-fury-usa.html',
      description:
        "The Absolute high-quality classic version of DBZ: Buu's Fury.",
      genre: 'RPG',
      rating: 4.9,
      playersOnline: 500,
      availability: 'Online',
    ...
    },
    {
      ...
      description:
        'The Absolute high-quality classic version of DBZ: Supersonic Warriors.',
      genre: 'Fighting',
      rating: 4.9,
      playersOnline: 500,
      availability: 'Online',
      ...
      launchConfig: {
        ...
        embedMode: 'inline',
        approvedExternalUrl:
          'https://www.retrogames.cc/embed/22415-dragon-ball-z-supersonic-warriors-usa.html',
        approvedEmbedUrl:
          'https://www.retrogames.cc/embed/22415-dragon-ball-z-supersonic-warriors-usa.html',
        secure_mode: 'wasm',
      },
    ...
    },
    {
      ...
      launchConfig: {
        ...
        embedMode: 'inline',
        approvedExternalUrl:
          'https://www.retrogames.cc/embed/17302-mega-man-x-usa.html',
        approvedEmbedUrl:
          'https://www.retrogames.cc/embed/17302-mega-man-x-usa.html',
        secure_mode: 'wasm',
      },
    ...
    },
    {
      ...
      url: 'https://www.retrogames.cc/embed/17203-the-legend-of-zelda-usa.html',
      description:
        'The Absolute high-quality classic version of The Legend of Zelda.',
      genre: 'Adventure',
      rating: 4.9,
      playersOnline: 500,
      availability: 'Online',
    ...
    },
    {
      ...
      url: 'https://www.retrogames.cc/embed/32331-legend-of-zelda-the-ocarina-of-time-usa.html',
      description:
        'The Absolute high-quality classic version of Zelda: Ocarina of Time.',
      genre: 'Adventure',
      rating: 4.9,
      playersOnline: 500,
      availability: 'Online',
    ...
    },
    {
      ...
      url: 'https://www.retrogames.cc/embed/18847-sonic-the-hedgehog-usa-europe.html',
      description:
        'The Absolute high-quality classic version of Sonic the Hedgehog.',
      genre: 'Classic',
      rating: 4.9,
      playersOnline: 500,
      availability: 'Online',
    ...
    },
    {
      ...
      url: 'https://www.retrogames.cc/embed/24220-sonic-the-hedgehog-2-world.html',
      description:
        'The Absolute high-quality classic version of Sonic the Hedgehog 2.',
      genre: 'Classic',
      rating: 4.9,
      playersOnline: 500,
      availability: 'Online',
    ...
    },
    {
      ...
      description:
        'The Absolute high-quality classic version of Madden NFL 2004.',
      genre: 'Sports',
      rating: 4.9,
      playersOnline: 500,
      availability: 'Online',
    ...
    },
    {
      ...
      url: 'https://www.retrogames.cc/embed/16599-10-yard-fight-usa-europe.html',
      description:
        'The Absolute high-quality classic version of 10-Yard Fight.',
      genre: 'Sports',
      rating: 4.9,
      playersOnline: 500,
      availability: 'Online',
    ...
    },
    {
      ...
      url: 'https://www.retrogames.cc/embed/17355-mike-tyson-s-punch-out-usa.html',
      description:
        "The Absolute high-quality classic version of Mike Tyson's Punch-Out!!.",
      genre: 'Sports',
      rating: 4.9,
      playersOnline: 500,
      availability: 'Online',
    ...
    },
    {
      ...
      genre: 'RPG',
      description:
        'The Absolute pinnacle of RPG design. Time-traveling excellence with multiple endings and high-fidelity combat.',
      tags: ['RPG', 'Retro', 'SNES', 'Elite', 'Time-Travel'],
      badgeIds: ['elite', 'classic', 'staff-pick'],
      launchConfig: {
        approvedEmbedUrl:
          'https://www.retrogames.cc/embed/18804-chrono-trigger-usa.html',
        embedMode: 'inline',
        secure_mode: 'wasm',
      },
    },
    {
      ...
      genre: 'RPG',
      description:
        'The definitive Hoenn journey. High-fidelity GBA emulation with stabilized Battle Frontier protocols.',
      tags: ['RPG', 'Retro', 'GBA', 'Elite', 'Pokemon'],
      badgeIds: ['elite', 'trending', 'staff-pick'],
      launchConfig: {
        approvedEmbedUrl:
          'https://www.retrogames.cc/embed/22421-pokemon-emerald-version-usa.html',
        embedMode: 'inline',
        secure_mode: 'wasm',
      },
    },
    {
      ...
      genre: 'FPS',
      description:
        'Hell on Earth. The Absolute foundation of the FPS genre, now in high-fidelity browser execution.',
    ...
    },
    {
      ...
      genre: 'Action',
      description:
        'The Absolute king of run-and-gun. High-fidelity pixel art and intense arcade combat.',
      tags: ['Action', 'Retro', 'Arcade', 'Elite', 'Shooter'],
      badgeIds: ['elite', 'featured'],
      launchConfig: {
        approvedEmbedUrl:
          'https://www.retrogames.cc/embed/9084-metal-slug-3.html',
        embedMode: 'inline',
        secure_mode: 'wasm',
      },
    },
    {
      ...
      genre: 'Fighting',
      description:
        'The Absolute fighting classic. Fatalities, combos, and high-fidelity arcade execution.',
    ...
    },
    {
      ...
      genre: 'Adventure',
      description:
        'The Absolute 16-bit masterpiece. High-fidelity adventure through the Light and Dark worlds.',
      tags: ['Adventure', 'Retro', 'SNES', 'Elite', 'RPG'],
      badgeIds: ['elite', 'classic', 'staff-pick'],
      launchConfig: {
        approvedEmbedUrl:
          'https://www.retrogames.cc/embed/18826-legend-of-zelda-the-a-link-to-the-past-usa.html',
        embedMode: 'inline',
        secure_mode: 'wasm',
      },
    },
    {
      ...
      genre: 'Sports',
      description:
        'Absolute high-flying arcade basketball. Create your player and dominate the court in high-fidelity.',
      tags: ['Sports', 'Retro', 'Arcade', 'Elite', 'Basketball'],
      badgeIds: ['elite', 'featured'],
      launchConfig: {
        approvedEmbedUrl:
          'https://www.retrogames.cc/embed/17391-nba-hangtime-usa-rev-l1-1.html',
        embedMode: 'inline',
        secure_mode: 'wasm',
      },
    },
    {
      ...
      genre: 'Fighting',
      description:
        'Absolute precision fighting. High-fidelity parry mechanics and competitive arcade flow.',
      tags: ['Fighting', 'Retro', 'Arcade', 'Elite', 'Combat'],
      badgeIds: ['elite', 'tournament-live'],
      launchConfig: {
        approvedEmbedUrl:
    ...
    },
    {
      ...
      genre: 'Action',
      description:
        'The Absolute foundation of the Metroidvania genre. High-fidelity exploration and atmospheric execution.',
    ...
    },
    {
      ...
      genre: 'FPS',
      description:
        'Absolute 3D revolution. High-fidelity Lovecraftian horror and fast-paced tactical shooting.',
      tags: ['FPS', 'Retro', 'PC', 'Elite', '3D'],
      badgeIds: ['elite', 'featured'],
      launchConfig: {
    ...
    },
    {
      ...
      genre: 'RPG',
      description:
        'The Absolute return to Kanto. High-fidelity GBA journey with stabilized training protocols.',
      tags: ['RPG', 'Retro', 'GBA', 'Elite', 'Pokemon'],
      badgeIds: ['elite', 'trending'],
      launchConfig: {
        approvedEmbedUrl:
          'https://www.retrogames.cc/embed/22422-pokemon-fire-red-version-usa.html',
        embedMode: 'inline',
        secure_mode: 'wasm',
      },
    },
    {
      ...
      genre: 'RPG',
      description:
        'Absolute cinematic RPG storytelling. High-fidelity 16-bit journey through a world of magic and machines.',
      tags: ['RPG', 'Retro', 'SNES', 'Elite', 'Fantasy'],
      badgeIds: ['elite', 'classic', 'staff-pick'],
      launchConfig: {
        approvedEmbedUrl:
          'https://www.retrogames.cc/embed/18817-final-fantasy-iii-usa.html',
        embedMode: 'inline',
        secure_mode: 'wasm',
      },
    },
    {
      ...
      genre: 'Action',
      description:
        'Absolute robot-hunting action. High-fidelity dash-and-jump combat with boss ability assimilation.',
    ...
    },
    {
      ...
      genre: 'Classic',
      description:
        'Absolute time-traveling speed. High-fidelity CD-quality soundtrack and innovative level design.',
      tags: ['Classic', 'Retro', 'Sega CD', 'Elite', 'Sonic'],
      badgeIds: ['elite', 'trending'],
      launchConfig: {
        approvedEmbedUrl:
          'https://www.retrogames.cc/embed/18991-sonic-the-hedgehog-cd-usa.html',
        embedMode: 'inline',
        secure_mode: 'wasm',
      },
    },
    {
      ...
      genre: 'FPS',
      description:
        'Absolute interactive FPS attitude. High-fidelity alien-blasting action and urban exploration.',
    ...
    },
    {
      ...
      genre: 'Action',
      description:
        'Absolute refined run-and-gun. High-fidelity boss encounters and frantic weapon variety.',
      tags: ['Action', 'Retro', 'Arcade', 'Elite', 'Shooter'],
      badgeIds: ['elite', 'featured'],
      launchConfig: {
        approvedEmbedUrl:
          'https://www.retrogames.cc/embed/9089-metal-slug-x-super-vehicle-001.html',
        embedMode: 'inline',
        secure_mode: 'wasm',
      },
    },
    {
      ...
      genre: 'Action',
      description:
        'Absolute fantasy brawler. High-fidelity hack-and-slash combat with powerful magic summons.',
      tags: ['Action', 'Retro', 'Arcade', 'Elite', 'Fantasy'],
      badgeIds: ['elite', 'classic'],
      launchConfig: {
        approvedEmbedUrl:
          'https://www.retrogames.cc/embed/8682-golden-axe.html',
        embedMode: 'inline',
        secure_mode: 'wasm',
      },
    },
    {
      ...
      genre: "Beat 'em up",
      description:
        'Absolute urban brawling perfection. High-fidelity soundtrack and bone-crunching combat execution.',
      tags: ["Beat 'em up", 'Retro', 'Genesis', 'Elite', 'Action'],
      badgeIds: ['elite', 'featured', 'staff-pick'],
      launchConfig: {
        approvedEmbedUrl:
          'https://www.retrogames.cc/embed/19020-streets-of-rage-2-usa.html',
        embedMode: 'inline',
        secure_mode: 'wasm',
      },
    },
    {
      ...
      genre: 'Sports',
      description:
        'Absolute high-impact football. High-fidelity arcade physics and no-holds-barred gridiron action.',
      tags: ['Sports', 'Retro', 'Arcade', 'Elite', 'Football'],
      badgeIds: ['elite', 'trending'],
      launchConfig: {
        approvedEmbedUrl:
          'https://www.retrogames.cc/embed/17395-nfl-blitz-usa.html',
        embedMode: 'inline',
        secure_mode: 'wasm',
      },
    },
    {
      ...
      genre: 'Action',
      description:
        "Absolute soul-collecting adventure. High-fidelity GBA exploration through Dracula's castle.",
      tags: ['Action', 'Retro', 'GBA', 'Elite', 'RPG'],
      badgeIds: ['elite', 'staff-pick'],
      launchConfig: {
        approvedEmbedUrl:
          'https://www.retrogames.cc/embed/22402-castlevania-aria-of-sorrow-usa.html',
        embedMode: 'inline',
        secure_mode: 'wasm',
      },
    },
    {
      ...
      genre: 'FPS',
      description:
        'Absolute browser-native tactical FPS. High-fidelity multiplayer combat with optimized WebGL execution.',
    ...
    },
    {
      ...
      genre: 'FPS',
      description:
        'Absolute high-speed movement shooter. High-fidelity competitive environment and deep weapon mastery.',
      tags: ['FPS', 'Multiplayer', 'WebGL', 'Elite', 'Modern'],
      badgeIds: ['elite', 'tournament-live'],
      launchConfig: {
    ...
    },
    {
      ...
      genre: 'FPS',
      description:
        'Absolute futuristic tactical shooting. High-fidelity abilities and squad-based WebGL combat.',
      tags: ['FPS', 'Multiplayer', 'WebGL', 'Elite', 'Modern'],
      badgeIds: ['elite', 'new-drop'],
      launchConfig: {
    ...
    },
    {
      ...
      genre: 'FPS',
      description:
        'Absolute egg-based tactical shooter. High-fidelity precision and high-count multiplayer runs.',
      tags: ['FPS', 'Multiplayer', 'WebGL', 'Elite', 'Modern'],
      badgeIds: ['elite', 'featured'],
      launchConfig: {
    ...
    },
    {
      ...
      genre: 'Sports',
      description:
        'Absolute tournament football. High-fidelity 3D WebGL physics and global ladder support.',
      tags: ['Sports', 'Soccer', 'WebGL', 'Elite', 'Modern'],
      badgeIds: ['elite', 'tournament-live'],
      launchConfig: {
        approvedEmbedUrl:
          'https://www.gamepix.com/play/soccer-skills-world-cup',
    ...
    },
    {
      ...
      genre: 'Action',
      description:
        'Absolute high-fidelity Action action. Experience Contra III in a stabilized browser environment.',
      tags: ['Action', 'Retro', 'Elite', 'Stabilized'],
      badgeIds: ['elite', 'classic'],
      launchConfig: {
        approvedEmbedUrl:
    ...
    },
    {
      ...
      genre: 'Action',
      description:
        'Absolute high-fidelity Action action. Experience Castlevania IV in a stabilized browser environment.',
      tags: ['Action', 'Retro', 'Elite', 'Stabilized'],
      badgeIds: ['elite', 'classic'],
      launchConfig: {
        approvedEmbedUrl:
          'https://www.retrogames.cc/embed/18824-super-castlevania-iv-usa.html',
        embedMode: 'inline',
        secure_mode: 'wasm',
      },
    },
    {
      ...
      genre: 'Action',
      description:
        'Absolute high-fidelity Action action. Experience Mega Man X3 in a stabilized browser environment.',
      tags: ['Action', 'Retro', 'Elite', 'Stabilized'],
      badgeIds: ['elite', 'classic'],
      launchConfig: {
        approvedEmbedUrl:
          'https://www.retrogames.cc/embed/18833-mega-man-x3-usa.html',
        embedMode: 'inline',
        secure_mode: 'wasm',
      },
    },
    {
      ...
      genre: 'Action',
      description:
        'Absolute high-fidelity Action action. Experience Kirby Super Star in a stabilized browser environment.',
      tags: ['Action', 'Retro', 'Elite', 'Stabilized'],
      badgeIds: ['elite', 'classic'],
      launchConfig: {
        approvedEmbedUrl:
          'https://www.retrogames.cc/embed/18825-kirby-super-star-usa.html',
        embedMode: 'inline',
        secure_mode: 'wasm',
      },
    },
    {
      ...
      genre: 'Classic',
      description:
        'Absolute high-fidelity Classic action. Experience Super Mario World in a stabilized browser environment.',
      tags: ['Classic', 'Retro', 'Elite', 'Stabilized'],
      badgeIds: ['elite', 'classic'],
      launchConfig: {
        approvedEmbedUrl:
          'https://www.retrogames.cc/embed/18842-super-mario-world-usa.html',
        embedMode: 'inline',
        secure_mode: 'wasm',
      },
    },
    {
      ...
      genre: 'Classic',
      description:
        'Absolute high-fidelity Classic action. Experience Donkey Kong Country in a stabilized browser environment.',
      tags: ['Classic', 'Retro', 'Elite', 'Stabilized'],
      badgeIds: ['elite', 'classic'],
      launchConfig: {
        approvedEmbedUrl:
          'https://www.retrogames.cc/embed/18808-donkey-kong-country-usa.html',
        embedMode: 'inline',
        secure_mode: 'wasm',
      },
    },
    {
      ...
      genre: 'Classic',
      description:
        'Absolute high-fidelity Classic action. Experience Sonic the Hedgehog 3 in a stabilized browser environment.',
      tags: ['Classic', 'Retro', 'Elite', 'Stabilized'],
      badgeIds: ['elite', 'classic'],
      launchConfig: {
        approvedEmbedUrl:
          'https://www.retrogames.cc/embed/18848-sonic-the-hedgehog-3-usa.html',
        embedMode: 'inline',
        secure_mode: 'wasm',
      },
    },
    {
      ...
      genre: 'Action',
      description:
        'Absolute high-fidelity Action action. Experience Aladdin in a stabilized browser environment.',
      tags: ['Action', 'Retro', 'Elite', 'Stabilized'],
      badgeIds: ['elite', 'classic'],
      launchConfig: {
        approvedEmbedUrl:
          'https://www.retrogames.cc/embed/18821-disney-s-aladdin-usa.html',
        embedMode: 'inline',
        secure_mode: 'wasm',
      },
    },
    {
      ...
      genre: 'Action',
      description:
        'Absolute high-fidelity Action action. Experience The Lion King in a stabilized browser environment.',
      tags: ['Action', 'Retro', 'Elite', 'Stabilized'],
      badgeIds: ['elite', 'classic'],
      launchConfig: {
        approvedEmbedUrl:
          'https://www.retrogames.cc/embed/18822-disney-s-the-lion-king-usa.html',
        embedMode: 'inline',
        secure_mode: 'wasm',
      },
    },
    {
      ...
      genre: 'Action',
      description:
        'Absolute high-fidelity Action action. Experience Earthworm Jim in a stabilized browser environment.',
      tags: ['Action', 'Retro', 'Elite', 'Stabilized'],
      badgeIds: ['elite', 'classic'],
      launchConfig: {
        approvedEmbedUrl:
          'https://www.retrogames.cc/embed/18810-earthworm-jim-usa.html',
        embedMode: 'inline',
        secure_mode: 'wasm',
      },
    },
    {
      ...
      genre: 'Shooting',
      description:
        'Absolute high-fidelity Shooting action. Experience Star Fox in a stabilized browser environment.',
      tags: ['Shooting', 'Retro', 'Elite', 'Stabilized'],
      badgeIds: ['elite', 'classic'],
      launchConfig: {
        approvedEmbedUrl:
          'https://www.retrogames.cc/embed/18836-star-fox-usa.html',
        embedMode: 'inline',
        secure_mode: 'wasm',
      },
    },
    {
      ...
      genre: 'Racing',
      description:
        'Absolute high-fidelity Racing action. Experience F-Zero in a stabilized browser environment.',
      tags: ['Racing', 'Retro', 'Elite', 'Stabilized'],
      badgeIds: ['elite', 'classic'],
      launchConfig: {
        approvedEmbedUrl:
          'https://www.retrogames.cc/embed/18815-f-zero-usa.html',
        embedMode: 'inline',
        secure_mode: 'wasm',
      },
    },
    {
      ...
      genre: 'Racing',
      description:
        'Absolute high-fidelity Racing action. Experience Mario Kart 64 in a stabilized browser environment.',
      tags: ['Racing', 'Retro', 'Elite', 'Stabilized'],
      badgeIds: ['elite', 'classic'],
      launchConfig: {
        approvedEmbedUrl:
          'https://www.retrogames.cc/embed/32269-mario-kart-64-usa.html',
        embedMode: 'inline',
        secure_mode: 'wasm',
      },
    },
    {
      ...
      genre: 'Shooting',
      description:
        'Absolute high-fidelity Shooting action. Experience Star Fox 64 in a stabilized browser environment.',
      tags: ['Shooting', 'Retro', 'Elite', 'Stabilized'],
      badgeIds: ['elite', 'classic'],
      launchConfig: {
        approvedEmbedUrl:
          'https://www.retrogames.cc/embed/32356-star-fox-64-usa.html',
        embedMode: 'inline',
        secure_mode: 'wasm',
      },
    },
    {
      ...
      genre: 'RPG',
      description:
        'Absolute high-fidelity RPG action. Experience Zelda: Majora Mask in a stabilized browser environment.',
      tags: ['RPG', 'Retro', 'Elite', 'Stabilized'],
      badgeIds: ['elite', 'classic'],
      launchConfig: {
        approvedEmbedUrl:
          'https://www.retrogames.cc/embed/32332-legend-of-zelda-the-majora-s-mask-usa.html',
        embedMode: 'inline',
        secure_mode: 'wasm',
      },
    },
    {
      ...
      genre: 'Adventure',
      description:
        'Absolute high-fidelity Adventure action. Experience Banjo-Kazooie in a stabilized browser environment.',
      tags: ['Adventure', 'Retro', 'Elite', 'Stabilized'],
      badgeIds: ['elite', 'classic'],
      launchConfig: {
        approvedEmbedUrl:
          'https://www.retrogames.cc/embed/32111-banjo-kazooie-usa.html',
        embedMode: 'inline',
        secure_mode: 'wasm',
      },
    },
    {
      ...
      genre: 'Action',
      description:
        'Absolute high-fidelity Action action. Experience Crash Bandicoot in a stabilized browser environment.',
      tags: ['Action', 'Retro', 'Elite', 'Stabilized'],
      badgeIds: ['elite', 'classic'],
      launchConfig: {
        approvedEmbedUrl:
          'https://www.retrogames.cc/embed/41684-crash-bandicoot.html',
        embedMode: 'inline',
        secure_mode: 'wasm',
      },
    },
    {
      ...
      genre: 'Adventure',
      description:
        'Absolute high-fidelity Adventure action. Experience Spyro the Dragon in a stabilized browser environment.',
      tags: ['Adventure', 'Retro', 'Elite', 'Stabilized'],
      badgeIds: ['elite', 'classic'],
      launchConfig: {
        approvedEmbedUrl:
          'https://www.retrogames.cc/embed/40645-spyro-the-dragon.html',
        embedMode: 'inline',
        secure_mode: 'wasm',
      },
    },
    {
      ...
      genre: 'Action',
      description:
        'Absolute high-fidelity Action action. Experience Resident Evil 2 in a stabilized browser environment.',
      tags: ['Action', 'Retro', 'Elite', 'Stabilized'],
      badgeIds: ['elite', 'classic'],
      launchConfig: {
        approvedEmbedUrl:
          'https://www.retrogames.cc/embed/40578-resident-evil-2-dual-shock-edition.html',
        embedMode: 'inline',
        secure_mode: 'wasm',
      },
    },
    {
      ...
      genre: 'Action',
      description:
        'Absolute high-fidelity Action action. Experience Silent Hill in a stabilized browser environment.',
      tags: ['Action', 'Retro', 'Elite', 'Stabilized'],
      badgeIds: ['elite', 'classic'],
      launchConfig: {
        approvedEmbedUrl:
          'https://www.retrogames.cc/embed/40590-silent-hill.html',
        embedMode: 'inline',
        secure_mode: 'wasm',
      },
    },
    {
      ...
      genre: 'Action',
      description:
        'Absolute high-fidelity Action action. Experience Metal Gear Solid in a stabilized browser environment.',
      tags: ['Action', 'Retro', 'Elite', 'Stabilized'],
      badgeIds: ['elite', 'classic'],
      launchConfig: {
        approvedEmbedUrl:
          'https://www.retrogames.cc/embed/40552-metal-gear-solid.html',
        embedMode: 'inline',
        secure_mode: 'wasm',
      },
    },
    {
      ...
      genre: 'Racing',
      description:
        'Absolute high-fidelity Racing action. Experience Gran Turismo 2 in a stabilized browser environment.',
      tags: ['Racing', 'Retro', 'Elite', 'Stabilized'],
      badgeIds: ['elite', 'classic'],
      launchConfig: {
        approvedEmbedUrl:
          'https://www.retrogames.cc/embed/41460-gran-turismo-2.html',
        embedMode: 'inline',
        secure_mode: 'wasm',
      },
    },
    {
      ...
      genre: 'Action',
      description:
        'Absolute high-fidelity Action action. Experience Dino Crisis in a stabilized browser environment.',
      tags: ['Action', 'Retro', 'Elite', 'Stabilized'],
      badgeIds: ['elite', 'classic'],
      launchConfig: {
        approvedEmbedUrl:
          'https://www.retrogames.cc/embed/40191-dino-crisis.html',
        embedMode: 'inline',
        secure_mode: 'wasm',
      },
    },
    {
      ...
      genre: 'Action',
      description:
        'Absolute high-fidelity Action action. Experience MediEvil in a stabilized browser environment.',
      tags: ['Action', 'Retro', 'Elite', 'Stabilized'],
      badgeIds: ['elite', 'classic'],
      launchConfig: {
    ...
    },
    {
      ...
      genre: 'Action',
      description:
        'Absolute high-fidelity Action action. Experience Twisted Metal 2 in a stabilized browser environment.',
      tags: ['Action', 'Retro', 'Elite', 'Stabilized'],
      badgeIds: ['elite', 'classic'],
      launchConfig: {
        approvedEmbedUrl:
          'https://www.retrogames.cc/embed/40623-twisted-metal-2.html',
        embedMode: 'inline',
        secure_mode: 'wasm',
      },
    },
    {
      ...
      genre: 'Action',
      description:
        'Absolute high-fidelity Action action. Experience Duke Nukem: Time to Kill in a stabilized browser environment.',
      tags: ['Action', 'Retro', 'Elite', 'Stabilized'],
      badgeIds: ['elite', 'classic'],
      launchConfig: {
        approvedEmbedUrl:
          'https://www.retrogames.cc/embed/40454-duke-nukem-time-to-kill.html',
        embedMode: 'inline',
        secure_mode: 'wasm',
      },
    },
    {
      ...
      genre: 'FPS',
      description:
        'Absolute high-fidelity FPS action. Experience Doom 64 in a stabilized browser environment.',
      tags: ['FPS', 'Retro', 'Elite', 'Stabilized'],
      badgeIds: ['elite', 'classic'],
      launchConfig: {
        approvedEmbedUrl:
          'https://www.retrogames.cc/embed/32168-doom-64-usa.html',
        embedMode: 'inline',
        secure_mode: 'wasm',
      },
    },
    {
      ...
      genre: 'FPS',
      description:
        'Absolute high-fidelity FPS action. Experience GoldenEye 007 Elite in a stabilized browser environment.',
      tags: ['FPS', 'Retro', 'Elite', 'Stabilized'],
      badgeIds: ['elite', 'classic'],
      launchConfig: {
        approvedEmbedUrl:
    ...
    },
    {
      ...
      genre: 'FPS',
      description:
        'Absolute high-fidelity FPS action. Experience Perfect Dark in a stabilized browser environment.',
      tags: ['FPS', 'Retro', 'Elite', 'Stabilized'],
      badgeIds: ['elite', 'classic'],
      launchConfig: {
        approvedEmbedUrl:
          'https://www.retrogames.cc/embed/32351-perfect-dark-usa.html',
        embedMode: 'inline',
        secure_mode: 'wasm',
      },
    },
    {
      ...
      genre: 'FPS',
      description:
        'Absolute high-fidelity FPS action. Experience Quake II in a stabilized browser environment.',
      tags: ['FPS', 'Retro', 'Elite', 'Stabilized'],
      badgeIds: ['elite', 'classic'],
      launchConfig: {
        approvedEmbedUrl:
          'https://www.retrogames.cc/embed/32354-quake-ii-usa.html',
        embedMode: 'inline',
        secure_mode: 'wasm',
      },
    },
    {
      ...
      genre: 'FPS',
      description:
        'Absolute high-fidelity FPS action. Experience Turok 2 in a stabilized browser environment.',
      tags: ['FPS', 'Retro', 'Elite', 'Stabilized'],
      badgeIds: ['elite', 'classic'],
      launchConfig: {
        approvedEmbedUrl:
          'https://www.retrogames.cc/embed/32419-turok-2-seeds-of-evil-usa.html',
        embedMode: 'inline',
        secure_mode: 'wasm',
      },
    },
    {
      ...
      genre: 'Sports',
      description:
        'Absolute high-fidelity Sports action. Experience Wave Race 64 in a stabilized browser environment.',
      tags: ['Sports', 'Retro', 'Elite', 'Stabilized'],
      badgeIds: ['elite', 'classic'],
      launchConfig: {
        approvedEmbedUrl:
          'https://www.retrogames.cc/embed/32431-wave-race-64-usa.html',
        embedMode: 'inline',
        secure_mode: 'wasm',
      },
    },
    {
      ...
      genre: 'Sports',
      description:
        'Absolute high-fidelity Sports action. Experience 1080 Snowboarding in a stabilized browser environment.',
      tags: ['Sports', 'Retro', 'Elite', 'Stabilized'],
      badgeIds: ['elite', 'classic'],
      launchConfig: {
        approvedEmbedUrl:
          'https://www.retrogames.cc/embed/32098-1080-snowboarding-usa.html',
        embedMode: 'inline',
        secure_mode: 'wasm',
      },
    },
    {
      ...
      genre: 'Sports',
      description:
        'Absolute high-fidelity Sports action. Experience Mario Golf in a stabilized browser environment.',
      tags: ['Sports', 'Retro', 'Elite', 'Stabilized'],
      badgeIds: ['elite', 'classic'],
      launchConfig: {
        approvedEmbedUrl:
          'https://www.retrogames.cc/embed/32267-mario-golf-usa.html',
        embedMode: 'inline',
        secure_mode: 'wasm',
      },
    },
    {
      ...
      genre: 'Sports',
      description:
        'Absolute high-fidelity Sports action. Experience Mario Tennis in a stabilized browser environment.',
      tags: ['Sports', 'Retro', 'Elite', 'Stabilized'],
      badgeIds: ['elite', 'classic'],
      launchConfig: {
        approvedEmbedUrl:
          'https://www.retrogames.cc/embed/32268-mario-tennis-usa.html',
        embedMode: 'inline',
        secure_mode: 'wasm',
      },
    },
    {
      ...
      genre: 'Strategy',
      description:
        'Absolute high-fidelity Strategy action. Experience Pokemon Stadium 2 in a stabilized browser environment.',
      tags: ['Strategy', 'Retro', 'Elite', 'Stabilized'],
      badgeIds: ['elite', 'classic'],
      launchConfig: {
        approvedEmbedUrl:
          'https://www.retrogames.cc/embed/32336-pokemon-stadium-2-usa.html',
        embedMode: 'inline',
        secure_mode: 'wasm',
      },
    },
    {
      ...
      genre: 'Sports',
      description:
        'Absolute high-fidelity Sports action. Experience Tony Hawk 2 Master in a stabilized browser environment.',
      tags: ['Sports', 'Retro', 'Elite', 'Stabilized'],
      badgeIds: ['elite', 'classic'],
      launchConfig: {
        approvedEmbedUrl:
    ...
    },
    {
      ...
      genre: 'Action',
      description:
        'Absolute high-fidelity Action action. Experience Spider-Man PS1 in a stabilized browser environment.',
      tags: ['Action', 'Retro', 'Elite', 'Stabilized'],
      badgeIds: ['elite', 'classic'],
      launchConfig: {
        approvedEmbedUrl:
          'https://www.retrogames.cc/embed/40595-spider-man.html',
        embedMode: 'inline',
        secure_mode: 'wasm',
      },
    },
    {
      ...
      genre: 'Fighting',
      description:
        'Absolute high-fidelity Fighting action. Experience X-Men vs Street Fighter in a stabilized browser environment.',
      tags: ['Fighting', 'Retro', 'Elite', 'Stabilized'],
      badgeIds: ['elite', 'classic'],
      launchConfig: {
        approvedEmbedUrl:
          'https://www.retrogames.cc/embed/8407-x-men-vs-street-fighter-961004.html',
        embedMode: 'inline',
        secure_mode: 'wasm',
      },
    },
    {
      ...
      genre: 'Fighting',
      description:
        'Absolute high-fidelity Fighting action. Experience Marvel Super Heroes in a stabilized browser environment.',
      tags: ['Fighting', 'Retro', 'Elite', 'Stabilized'],
      badgeIds: ['elite', 'classic'],
      launchConfig: {
        approvedEmbedUrl:
          'https://www.retrogames.cc/embed/8403-marvel-super-heroes-951024.html',
        embedMode: 'inline',
        secure_mode: 'wasm',
      },
    },
    {
      ...
      genre: 'Fighting',
      description:
        'Absolute high-fidelity Fighting action. Experience Street Fighter Alpha 3 in a stabilized browser environment.',
      tags: ['Fighting', 'Retro', 'Elite', 'Stabilized'],
      badgeIds: ['elite', 'classic'],
      launchConfig: {
        approvedEmbedUrl:
          'https://www.retrogames.cc/embed/10006-street-fighter-alpha-3-980904.html',
        embedMode: 'inline',
        secure_mode: 'wasm',
      },
    },
    {
      ...
      genre: 'Fighting',
      description:
        'Absolute high-fidelity Fighting action. Experience Darkstalkers in a stabilized browser environment.',
      tags: ['Fighting', 'Retro', 'Elite', 'Stabilized'],
      badgeIds: ['elite', 'classic'],
      launchConfig: {
        approvedEmbedUrl:
          'https://www.retrogames.cc/embed/8401-darkstalkers-the-night-warriors-940705.html',
        embedMode: 'inline',
        secure_mode: 'wasm',
      },
    },
    {
      ...
      genre: "Beat 'em up",
      description:
        "Absolute high-fidelity Beat 'em up action. Experience Cadillacs and Dinosaurs in a stabilized browser environment.",
      tags: ["Beat 'em up", 'Retro', 'Elite', 'Stabilized'],
      badgeIds: ['elite', 'classic'],
      launchConfig: {
        approvedEmbedUrl:
          'https://www.retrogames.cc/embed/8489-cadillacs-and-dinosaurs-930201.html',
        embedMode: 'inline',
        secure_mode: 'wasm',
      },
    },
    {
      ...
      genre: "Beat 'em up",
      description:
        "Absolute high-fidelity Beat 'em up action. Experience Captain Commando in a stabilized browser environment.",
      tags: ["Beat 'em up", 'Retro', 'Elite', 'Stabilized'],
      badgeIds: ['elite', 'classic'],
      launchConfig: {
        approvedEmbedUrl:
          'https://www.retrogames.cc/embed/8491-captain-commando-911101.html',
        embedMode: 'inline',
        secure_mode: 'wasm',
      },
    },
    {
      ...
      genre: "Beat 'em up",
      description:
        "Absolute high-fidelity Beat 'em up action. Experience The Punisher in a stabilized browser environment.",
      tags: ["Beat 'em up", 'Retro', 'Elite', 'Stabilized'],
      badgeIds: ['elite', 'classic'],
      launchConfig: {
        approvedEmbedUrl:
          'https://www.retrogames.cc/embed/8515-the-punisher-930422.html',
        embedMode: 'inline',
        secure_mode: 'wasm',
      },
    },
    ...
    // ── Multiplayer & Co-op Arcade (New Additions) ──
    {
      ...
      playersOnline: 18500,
      availability: 'Online',
      tags: ['Racing', 'Multiplayer', 'Arcade', 'Combat'],
      multiplayerType: 'Server',
      badgeIds: ['trending'],
      queueEstimateMinutes: 1,
      sessionObjectives: ['Win one arena match', 'Land 3 powerup eliminations'],
      controlHints: ['Collect powerups early', 'Use shields on straightaways'],
      launchConfig: {
        inlinePolicy: 'trusted',
        embedMode: 'inline',
        approvedEmbedUrl: 'https://poki.com/en/g/smash-karts',
        approvedExternalUrl: 'https://poki.com/en/g/smash-karts',
        telemetryMode: 'origin',
    ...
    {
      id: 'basketball-stars-multiplayer',
      name: 'Basketball Stars',
      ...
      badgeIds: ['featured', 'trending'],
      queueEstimateMinutes: 1,
      sessionObjectives: ['Win a ranked match', 'Score 3 consecutive baskets'],
      controlHints: ['Fake before shooting', 'Defend the three-point line'],
      launchConfig: {
        inlinePolicy: 'trusted',
        embedMode: 'inline',
        approvedEmbedUrl: 'https://poki.com/en/g/basketball-stars',
        approvedExternalUrl: 'https://poki.com/en/g/basketball-stars',
        telemetryMode: 'origin',
        telemetryOrigins: ['https://poki.com'],
      },
      art: {
    ...
    {
      id: 'football-legends-multiplayer',
      ...
      playersOnline: 31000,
      availability: 'Online',
      tags: ['Sports', 'Soccer', 'Multiplayer', 'PvP', 'Tournament'],
      multiplayerType: 'Server',
      badgeIds: ['tournament-live', 'trending'],
      queueEstimateMinutes: 2,
      sessionObjectives: ['Score a hat trick', 'Keep a clean sheet'],
      controlHints: ['Master the through ball', 'Defend with your midfield'],
      launchConfig: {
        inlinePolicy: 'trusted',
        embedMode: 'inline',
        approvedEmbedUrl: 'https://poki.com/en/g/football-legends',
        approvedExternalUrl: 'https://poki.com/en/g/football-legends',
        telemetryMode: 'origin',
        telemetryOrigins: ['https://poki.com'],
      },
      art: {
    ...
    },
    {
      ...
      playersOnline: 15600,
      availability: 'Online',
      tags: ['Sports', 'Basketball', 'Multiplayer', 'PvP', 'Arcade'],
      multiplayerType: 'Server',
      badgeIds: ['featured'],
      queueEstimateMinutes: 1,
      ...
      launchConfig: {
        inlinePolicy: 'trusted',
        embedMode: 'inline',
        approvedEmbedUrl: 'https://www.crazygames.com/game/basketbros',
        approvedExternalUrl: 'https://www.crazygames.com/game/basketbros',
        telemetryMode: 'origin',
        telemetryOrigins: ['https://www.crazygames.com'],
      },
      art: {
        eyebrow: 'Online PvP',
        accentStart: '#f97316',
    ...
    },
    {
      ...
      playersOnline: 8900,
      availability: 'Online',
      tags: ['Sports', 'Volleyball', 'Multiplayer', 'PvP', 'Party'],
      multiplayerType: 'Server',
      badgeIds: ['featured'],
      queueEstimateMinutes: 1,
      ...
      launchConfig: {
        inlinePolicy: 'trusted',
        embedMode: 'inline',
        approvedEmbedUrl: 'https://www.crazygames.com/game/volley-random',
        approvedExternalUrl: 'https://www.crazygames.com/game/volley-random',
        telemetryMode: 'origin',
        telemetryOrigins: ['https://www.crazygames.com'],
      },
      art: {
    ...
    },
    {
      ...
      playersOnline: 7200,
      availability: 'Online',
      tags: ['Sports', 'Golf', 'Multiplayer', 'PvP', 'Arcade'],
      multiplayerType: 'Server',
      badgeIds: ['staff-pick'],
      queueEstimateMinutes: 1,
      sessionObjectives: ['Win a round', 'Score under par'],
      controlHints: ['Power controls distance', 'Wind affects ball trajectory'],
      launchConfig: {
        inlinePolicy: 'trusted',
        embedMode: 'inline',
        approvedEmbedUrl: 'https://poki.com/en/g/battle-golf',
        approvedExternalUrl: 'https://poki.com/en/g/battle-golf',
        telemetryMode: 'origin',
        telemetryOrigins: ['https://poki.com'],
      },
      art: {
    ...
    },
    {
      ...
      playersOnline: 14000,
      availability: 'Online',
      tags: ['Fighting', 'Shooting', 'Multiplayer', 'PvP', 'Arcade'],
      multiplayerType: 'Server',
      badgeIds: ['featured'],
      queueEstimateMinutes: 1,
      sessionObjectives: ['Win 3 rounds', 'Land a long-range shot'],
      controlHints: ['Account for bullet drop', 'Jump to dodge incoming fire'],
      launchConfig: {
        inlinePolicy: 'trusted',
        embedMode: 'inline',
        approvedEmbedUrl: 'https://poki.com/en/g/rooftop-snipers',
        approvedExternalUrl: 'https://poki.com/en/g/rooftop-snipers',
        telemetryMode: 'origin',
        telemetryOrigins: ['https://poki.com'],
      },
      art: {
    ...
    },
    {
      ...
      playersOnline: 11200,
      availability: 'Online',
      tags: ['Fighting', 'Physics', 'Multiplayer', 'PvP', 'Arcade'],
      multiplayerType: 'Server',
      badgeIds: ['trending'],
      queueEstimateMinutes: 1,
      ...
      launchConfig: {
        inlinePolicy: 'trusted',
        embedMode: 'inline',
        approvedEmbedUrl: 'https://poki.com/en/g/ragdoll-hit',
        approvedExternalUrl: 'https://poki.com/en/g/ragdoll-hit',
        telemetryMode: 'origin',
        telemetryOrigins: ['https://poki.com'],
      },
      art: {
    ...
    },
    {
      ...
      playersOnline: 6800,
      availability: 'Online',
      tags: ['Shooting', 'Multiplayer', 'Co-op', 'PvP', 'Arcade'],
      multiplayerType: 'Server',
      badgeIds: ['staff-pick'],
      queueEstimateMinutes: 2,
      sessionObjectives: ['Survive a co-op wave', 'Win a free-for-all match'],
      controlHints: ['Aim for headshots', 'Use cover between reloads'],
      launchConfig: {
        inlinePolicy: 'trusted',
        embedMode: 'inline',
        approvedEmbedUrl: 'https://poki.com/en/g/temple-of-boom',
        approvedExternalUrl: 'https://poki.com/en/g/temple-of-boom',
        telemetryMode: 'origin',
        telemetryOrigins: ['https://poki.com'],
      },
      art: {
    ...
    },
    {
      ...
      playersOnline: 23000,
      availability: 'Online',
      tags: ['Arcade', 'Multiplayer', 'Party', 'PvP', 'Action'],
      multiplayerType: 'Server',
      badgeIds: ['featured', 'trending'],
      queueEstimateMinutes: 1,
      sessionObjectives: ['Reach the getaway first', 'Eliminate 3 opponents'],
      controlHints: ['Grab weapons immediately', 'Use obstacles for cover'],
      launchConfig: {
        inlinePolicy: 'trusted',
        embedMode: 'inline',
        approvedEmbedUrl: 'https://poki.com/en/g/getaway-shootout',
        approvedExternalUrl: 'https://poki.com/en/g/getaway-shootout',
        telemetryMode: 'origin',
        telemetryOrigins: ['https://poki.com'],
      },
      art: {
        eyebrow: 'Party Battle',
        accentStart: '#e11d48',
        accentEnd: '#881337',
      },
      image: '/assets/games/multiplayer-default.png',
    },
    {
      ...
      playersOnline: 19000,
      availability: 'Online',
      tags: ['Arcade', 'Multiplayer', 'Party', 'PvP', 'Platformer'],
      multiplayerType: 'Server',
      badgeIds: ['trending'],
      queueEstimateMinutes: 1,
      ...
      launchConfig: {
        inlinePolicy: 'trusted',
        embedMode: 'inline',
        approvedEmbedUrl: 'https://poki.com/en/g/house-of-hazards',
        approvedExternalUrl: 'https://poki.com/en/g/house-of-hazards',
        telemetryMode: 'origin',
        telemetryOrigins: ['https://poki.com'],
      },
      art: {
    ...
    },
    {
      ...
      badgeIds: ['staff-pick'],
      queueEstimateMinutes: 1,
      sessionObjectives: ['Outlast all opponents', 'Clear 10 tube sections'],
      controlHints: ['Jump late to clear gaps', 'Use momentum for distance'],
      launchConfig: {
        inlinePolicy: 'trusted',
        embedMode: 'inline',
        approvedEmbedUrl: 'https://poki.com/en/g/tube-jumpers',
        approvedExternalUrl: 'https://poki.com/en/g/tube-jumpers',
        telemetryMode: 'origin',
        telemetryOrigins: ['https://poki.com'],
      },
      art: {
    ...
    },
    {
      ...
      playersOnline: 12500,
      availability: 'Online',
      tags: ['Sports', 'Racing', 'Multiplayer', 'PvP', 'Arcade'],
      multiplayerType: 'Server',
      badgeIds: ['featured'],
      queueEstimateMinutes: 2,
      sessionObjectives: ['Score a goal', 'Win a match'],
      controlHints: ['Use boost to aerial hit', 'Rotate back on defense'],
      launchConfig: {
        inlinePolicy: 'trusted',
        embedMode: 'inline',
        approvedEmbedUrl: 'https://www.crazygames.com/game/rocketgoal-io',
        approvedExternalUrl: 'https://www.crazygames.com/game/rocketgoal-io',
        telemetryMode: 'origin',
        telemetryOrigins: ['https://www.crazygames.com'],
      },
      art: {
    ...
    },
    {
      ...
      playersOnline: 7800,
      availability: 'Online',
      tags: ['Racing', 'Multiplayer', 'PvP', 'Arcade', 'Driving'],
      multiplayerType: 'Server',
      badgeIds: ['staff-pick'],
      queueEstimateMinutes: 1,
      ...
      launchConfig: {
        inlinePolicy: 'trusted',
        embedMode: 'inline',
        approvedEmbedUrl: 'https://poki.com/en/g/2-player-city-racing-2',
        approvedExternalUrl: 'https://poki.com/en/g/2-player-city-racing-2',
        telemetryMode: 'origin',
        telemetryOrigins: ['https://poki.com'],
      },
      art: {
        eyebrow: 'Split-Screen Racing',
        accentStart: '#f59e0b',
        accentEnd: '#78350f',
      },
      image: '/assets/games/multiplayer-default.png',
    },
    {
      ...
      playersOnline: 28000,
      availability: 'Online',
      tags: ['Puzzle', 'Multiplayer', 'Co-op', 'Platformer', 'Classic'],
      multiplayerType: 'Server',
    ...
    },
    {
      ...
      playersOnline: 6200,
      availability: 'Online',
      tags: ['Puzzle', 'Multiplayer', 'Co-op', 'Platformer', 'Survival'],
      multiplayerType: 'Server',
      badgeIds: ['staff-pick'],
      queueEstimateMinutes: 1,
      ...
      launchConfig: {
        inlinePolicy: 'trusted',
        embedMode: 'inline',
        approvedEmbedUrl: 'https://poki.com/en/g/duo-survival',
        approvedExternalUrl: 'https://poki.com/en/g/duo-survival',
        telemetryMode: 'origin',
        telemetryOrigins: ['https://poki.com'],
      },
      art: {
        eyebrow: 'Co-op Challenge',
        accentStart: '#8b5cf6',
        accentEnd: '#4c1d95',
      },
      image: '/assets/games/multiplayer-default.png',
    },
    {
      ...
      playersOnline: 9500,
      availability: 'Online',
      tags: ['Platformer', 'Multiplayer', 'PvP', 'Arcade', 'Racing'],
      multiplayerType: 'Server',
      badgeIds: ['trending'],
      queueEstimateMinutes: 1,
      ...
      launchConfig: {
        inlinePolicy: 'trusted',
        embedMode: 'inline',
        approvedEmbedUrl: 'https://poki.com/en/g/blumgi-slime',
        approvedExternalUrl: 'https://poki.com/en/g/blumgi-slime',
        telemetryMode: 'origin',
        telemetryOrigins: ['https://poki.com'],
      },
      art: {
        eyebrow: 'Multiplayer Race',
        accentStart: '#10b981',
        accentEnd: '#064e3b',
      },
      image: '/assets/games/multiplayer-default.png',
    },
    {
      ...
      playersOnline: 13500,
      availability: 'Online',
      tags: ['Platformer', 'Multiplayer', 'PvP', 'Physics', 'Arcade'],
      multiplayerType: 'Server',
      badgeIds: ['featured'],
      queueEstimateMinutes: 1,
      ...
      launchConfig: {
        inlinePolicy: 'trusted',
        embedMode: 'inline',
        approvedEmbedUrl: 'https://poki.com/en/g/stickman-climb-2',
        approvedExternalUrl: 'https://poki.com/en/g/stickman-climb-2',
        telemetryMode: 'origin',
        telemetryOrigins: ['https://poki.com'],
      },
      art: {
    ...
    },
    {
      ...
      playersOnline: 10500,
      availability: 'Online',
      tags: ['Sports', 'Multiplayer', 'PvP', 'Arcade', 'Tennis'],
      multiplayerType: 'Server',
      badgeIds: ['staff-pick'],
      queueEstimateMinutes: 1,
      ...
      launchConfig: {
        inlinePolicy: 'trusted',
        embedMode: 'inline',
        approvedEmbedUrl: 'https://poki.com/en/g/ping-pong-go',
        approvedExternalUrl: 'https://poki.com/en/g/ping-pong-go',
        telemetryMode: 'origin',
        telemetryOrigins: ['https://poki.com'],
      },
      art: {
    ...
    },
    {
      ...
      playersOnline: 5800,
      availability: 'Online',
      tags: ['Strategy', 'Multiplayer', 'PvP', 'Classic', 'Board'],
      multiplayerType: 'Server',
      badgeIds: ['classic'],
      queueEstimateMinutes: 1,
      ...
      launchConfig: {
        inlinePolicy: 'trusted',
        embedMode: 'inline',
        approvedEmbedUrl: 'https://poki.com/en/g/battleship-war',
        approvedExternalUrl: 'https://poki.com/en/g/battleship-war',
        telemetryMode: 'origin',
        telemetryOrigins: ['https://poki.com'],
      },
      art: {
        eyebrow: 'Online Strategy',
        accentStart: '#2563eb',
        accentEnd: '#1e3a5f',
      },
      image: '/assets/games/multiplayer-default.png',
    ...
    {
      id: 'master-checkers-multiplayer',
      ...
      badgeIds: ['classic'],
      queueEstimateMinutes: 1,
      sessionObjectives: ['Win a match', 'King 3 pieces'],
      controlHints: ['Control the center', 'Plan jumps in advance'],
      launchConfig: {
        inlinePolicy: 'trusted',
        embedMode: 'inline',
    ...
    },
    {
      ...
      playersOnline: 12000,
      availability: 'Online',
      tags: ['Strategy', 'Multiplayer', 'PvP', 'Cards', 'Party'],
      multiplayerType: 'Server',
      badgeIds: ['trending'],
      queueEstimateMinutes: 1,
    ...
    },
    {
      ...
      playersOnline: 52000,
      availability: 'Online',
      tags: ['Sports', 'Multiplayer', 'PvP', 'Pool', 'Tournament'],
      multiplayerType: 'Server',
      ...
      launchConfig: {
        inlinePolicy: 'trusted',
        embedMode: 'inline',
        approvedEmbedUrl: 'https://www.miniclip.com/games/8-ball-pool',
        approvedExternalUrl: 'https://www.miniclip.com/games/8-ball-pool',
        telemetryMode: 'origin',
        telemetryOrigins: ['https://www.miniclip.com'],
      },
      art: {
        eyebrow: 'Online Multiplayer',
        accentStart: '#06b6d4',
    ...
    },
    {
      ...
      playersOnline: 8900,
      availability: 'Online',
      tags: ['Sports', 'Multiplayer', 'PvP', 'Bowling', 'Arcade'],
      multiplayerType: 'Server',
      badgeIds: ['featured'],
      queueEstimateMinutes: 1,
    ...
    },
    {
      ...
      badgeIds: ['classic'],
      queueEstimateMinutes: 0,
      sessionObjectives: ['Win a match', 'Win 3 matches in a row'],
      controlHints: ['Take the center first', 'Block opponent forks'],
      launchConfig: {
        inlinePolicy: 'trusted',
        embedMode: 'inline',
        approvedEmbedUrl: 'https://www.crazygames.com/t/tic-tac-toe',
        approvedExternalUrl: 'https://www.crazygames.com/t/tic-tac-toe',
        telemetryMode: 'origin',
        telemetryOrigins: ['https://www.crazygames.com'],
      },
      art: {
    ...
    },
    {
      ...
      playersOnline: 45000,
      availability: 'Online',
      tags: ['FPS', 'Multiplayer', 'PvP', 'Shooting', 'Competitive'],
      multiplayerType: 'Server',
      badgeIds: ['trending', 'tournament-live'],
      queueEstimateMinutes: 1,
      ...
      launchConfig: {
        ...
        telemetryMode: 'origin',
        telemetryOrigins: ['https://krunker.io'],
      },
      art: {
        eyebrow: 'Online FPS',
        accentStart: '#e11d48',
    ...
    },
    {
      ...
      playersOnline: 38000,
      availability: 'Online',
      tags: ['FPS', 'Multiplayer', 'PvP', 'Building', 'Battle Royale'],
      multiplayerType: 'Server',
      badgeIds: ['featured', 'trending'],
      queueEstimateMinutes: 2,
      ...
      launchConfig: {
        ...
        telemetryMode: 'origin',
        telemetryOrigins: ['https://1v1.lol'],
      },
      art: {
        eyebrow: 'Online Battle Royale',
        accentStart: '#f59e0b',
        accentEnd: '#78350f',
      },
      image: '/assets/games/multiplayer-default.png',
    },
    {
      ...
      playersOnline: 55000,
      availability: 'Online',
      tags: ['Arcade', 'Multiplayer', 'PvP', 'io', 'Competitive'],
      multiplayerType: 'Server',
      badgeIds: ['trending'],
      queueEstimateMinutes: 0,
      ...
      launchConfig: {
        ...
        telemetryMode: 'origin',
        telemetryOrigins: ['https://slither.io'],
      },
      art: {
        eyebrow: 'Online Arena',
        accentStart: '#10b981',
    ...
    },
    {
      ...
      launchConfig: {
        ...
        telemetryMode: 'origin',
        telemetryOrigins: ['https://agar.io'],
      },
      art: {
        eyebrow: 'Online Arena',
        accentStart: '#3b82f6',
    ...
    },
    {
      ...
      queueEstimateMinutes: 1,
      sessionObjectives: ['Win a TDM match', 'Get a 5-kill streak'],
      controlHints: ['Customize your loadout', 'Use slide for mobility'],
      launchConfig: {
        inlinePolicy: 'trusted',
        embedMode: 'inline',
        approvedEmbedUrl: 'https://venge.io/',
        approvedExternalUrl: 'https://venge.io/',
        telemetryMode: 'origin',
        telemetryOrigins: ['https://venge.io'],
      },
      art: {
        eyebrow: 'Online FPS',
        accentStart: '#dc2626',
    ...
    },
    {
      ...
      playersOnline: 5500,
      availability: 'Online',
      tags: ['Adventure', 'Multiplayer', 'Co-op', 'Survival', 'Puzzle'],
      multiplayerType: 'Server',
      badgeIds: ['staff-pick'],
      queueEstimateMinutes: 1,
      ...
      launchConfig: {
        inlinePolicy: 'trusted',
        embedMode: 'inline',
        approvedEmbedUrl: 'https://poki.com/en/g/robinson-crusoe',
        approvedExternalUrl: 'https://poki.com/en/g/robinson-crusoe',
        telemetryMode: 'origin',
        telemetryOrigins: ['https://poki.com'],
      },
      art: {
        eyebrow: 'Co-op Adventure',
        accentStart: '#22c55e',
        accentEnd: '#14532d',
      },
      image: '/assets/games/multiplayer-default.png',
    },
    {
      ...
      playersOnline: 7800,
      availability: 'Online',
      tags: ['Shooting', 'Multiplayer', 'Co-op', 'Tactical', 'Squad'],
      multiplayerType: 'Server',
      badgeIds: ['featured'],
      queueEstimateMinutes: 2,
    ...
    },
    {
      ...
      playersOnline: 9200,
      availability: 'Online',
      tags: ['Shooting', 'Multiplayer', 'Co-op', 'Defense', 'Survival'],
      multiplayerType: 'Server',
      badgeIds: ['trending'],
      queueEstimateMinutes: 1,
      sessionObjectives: ['Survive 10 waves', 'Upgrade all defenses'],
      controlHints: ['Cover different angles', 'Save resources for boss waves'],
      launchConfig: {
        inlinePolicy: 'trusted',
        embedMode: 'inline',
        approvedEmbedUrl: 'https://www.gamepix.com/play/zombie-idle-defense',
    ...
    },
    {
      ...
      playersOnline: 6800,
      availability: 'Online',
      tags: ['Strategy', 'Multiplayer', 'Co-op', 'Defense', 'Tactical'],
      multiplayerType: 'Server',
      badgeIds: ['staff-pick'],
      queueEstimateMinutes: 1,
    ...
    },
    {
      ...
      playersOnline: 5400,
      availability: 'Online',
      tags: ['RPG', 'Multiplayer', 'Co-op', 'Adventure', 'Fantasy'],
      multiplayerType: 'Server',
      badgeIds: ['staff-pick'],
      queueEstimateMinutes: 2,
      sessionObjectives: ['Defeat the boss', 'Clear 3 dungeon floors'],
      controlHints: ['Tank draws aggro', 'DPS focuses priority targets'],
      launchConfig: {
        inlinePolicy: 'trusted',
        embedMode: 'inline',
    ...
    },
    {
      ...
      playersOnline: 8200,
      availability: 'Online',
      tags: ['Fighting', 'Multiplayer', 'PvP', 'Physics', 'Arcade'],
      multiplayerType: 'Server',
      badgeIds: ['trending'],
      queueEstimateMinutes: 1,
      sessionObjectives: ['Win a duel', 'Land a long-range shot'],
      controlHints: ['Pull back for more power', 'Lead moving targets'],
      launchConfig: {
        inlinePolicy: 'trusted',
        embedMode: 'inline',
        approvedEmbedUrl: 'https://poki.com/en/g/ragdoll-archers',
        approvedExternalUrl: 'https://poki.com/en/g/ragdoll-archers',
        telemetryMode: 'origin',
        telemetryOrigins: ['https://poki.com'],
      },
      art: {
    ...
    },
    {
      ...
      playersOnline: 11200,
      availability: 'Online',
      tags: ['Racing', 'Multiplayer', 'Stunts', 'Arcade', 'Physics'],
      multiplayerType: 'Server',
      badgeIds: ['featured', 'trending'],
      queueEstimateMinutes: 1,
      ...
      launchConfig: {
        inlinePolicy: 'trusted',
        embedMode: 'inline',
        approvedEmbedUrl: 'https://poki.com/en/g/moto-x3m-3',
        approvedExternalUrl: 'https://poki.com/en/g/moto-x3m-3',
        telemetryMode: 'origin',
        telemetryOrigins: ['https://poki.com'],
      },
      art: {
        eyebrow: 'Online Racing',
        accentStart: '#f97316',
        accentEnd: '#7c2d12',
      },
      image: '/assets/games/multiplayer-default.png',
    },
    {
      ...
      playersOnline: 4800,
      availability: 'Online',
      tags: ['Shooting', 'Multiplayer', 'Co-op', 'Idle', 'Arcade'],
      multiplayerType: 'Server',
      badgeIds: ['staff-pick'],
      queueEstimateMinutes: 1,
      ...
      launchConfig: {
        inlinePolicy: 'trusted',
        embedMode: 'inline',
        approvedEmbedUrl: 'https://www.gamepix.com/play/idle-gun',
        approvedExternalUrl: 'https://www.gamepix.com/play/idle-gun',
        telemetryMode: 'origin',
        telemetryOrigins: ['https://www.gamepix.com'],
      },
      art: {
        eyebrow: 'Co-op Shooter',
        accentStart: '#f43f5e',
        accentEnd: '#9f1239',
      },
      image: '/assets/games/multiplayer-default.png',
    ...
    // BEATSABER BATTLE
    {
      ...
      playersOnline: 14000,
      availability: 'Online',
      tags: ['Rhythm', 'Multiplayer', 'PvP', 'Music', 'Arcade'],
      multiplayerType: 'Server',
      ...
      launchConfig: {
        inlinePolicy: 'trusted',
        embedMode: 'inline',
        approvedEmbedUrl: 'https://poki.com/en/g/fnf-vs-whitty',
        approvedExternalUrl: 'https://poki.com/en/g/fnf-vs-whitty',
        telemetryMode: 'origin',
        telemetryOrigins: ['https://poki.com'],
      },
      art: {
  ...
  recommendationRails: [
    {
      ...
      subtitle:
        'Absolute high-fidelity browser-native execution. Replaced Cloud-Link with Elite Master protocols.',
      roomIds: ['neo-zone'],
      gameIds: [
    ...
    },
    {
      ...
      subtitle:
        'The Absolute defining titles of the Golden Era. Stabilized for browser-native play.',
      roomIds: ['action-zone', 'shooting-range'],
      gameIds: [
    ...
    },
    {
      ...
      subtitle:
        'Absolute low-latency browser dominance. High-fidelity IO execution.',
