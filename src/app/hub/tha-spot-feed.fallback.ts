  ...
  games: [
    {
      ...
      tags: ['RPG', 'Retro', 'Elite', 'Stabilized'],
    ...
    },
    {
      ...
      launchConfig: {
        ...
        approvedExternalUrl: 'https://www.retrogames.cc/embed/10002-pac-man-midway.html',
      },
      art: {
        eyebrow: 'Namco Elite',
        accentStart: '#facc15',
    ...
    },
    {
      ...
      url: 'https://www.retrogames.cc/embed/22458-super-street-fighter-ii-snes.html',
      ...
      playersOnline: 4500,
      availability: 'Online',
      tags: ['Combat', 'Arcade', 'Classic', 'Fighting', 'station-cabinet', 'Multiplayer', 'PvP'],
      badgeIds: ['tournament-live'],
      queueEstimateMinutes: 2,
      sessionObjectives: ['Defeat 4 opponents in arcade mode', 'Land a Super Combo finisher'],
      controlHints: ['Master the quarter-circle forward motion', 'Use heavy attacks to break high guards'],
      launchConfig: {
        difficulty: 'Bracket',
        controls: ['Keyboard'],
        objectives: ['Survive the first bracket round', 'Convert one punish cleanly'],
        modes: ['Solo', 'Versus'],
        inlinePolicy: 'trusted',
        ...
        approvedEmbedUrl: 'https://www.retrogames.cc/embed/22458-super-street-fighter-ii-snes.html',
        telemetryMode: 'origin',
    ...
    },
    {
      ...
      url: 'https://www.retrogames.cc/embed/3664-space-invaders-nes.html',
      ...
      launchConfig: {
        ...
        inlinePolicy: 'trusted',
        embedMode: 'inline',
        approvedEmbedUrl: 'https://www.retrogames.cc/embed/3664-space-invaders-nes.html',
    ...
    },
    {
      id: 'doom',
      name: 'DOOM',
      url: 'https://www.retrogames.cc/embed/5540-doom-dos.html',
      genre: 'Shooting',
      ...
      launchConfig: {
        approvedEmbedUrl: 'https://www.retrogames.cc/embed/5540-doom-dos.html',
        telemetryMode: 'origin',
        embedMode: 'inline',
        controls: ['Standard Keyboard'],
        trustNote: 'Elite emulation verified. Auto-save states enabled via cloud uplink.',
    ...
    },
    {
      ...
      tags: ['Classic', 'Platformer', 'Retro', 'station-cabinet', 'WASM', 'High-Perf'],
      launchConfig: {
        approvedEmbedUrl: 'https://www.retrogames.cc/embed/3654-super-mario-bros-nes.html',
        telemetryMode: 'none',
        embedMode: 'inline',
        controls: ['Standard Keyboard'],
        trustNote: 'Elite emulation verified. Auto-save states enabled via cloud uplink.',
        secure_mode: 'wasm',
        approvedExternalUrl: 'https://www.retrogames.cc/embed/16847-super-mario-bros-japan-usa.html',
      },
      art: {
    ...
    },
    {
      ...
      url: 'https://www.retrogames.cc/embed/18893-legend-of-zelda-ocarina-of-time-n64.html',
      genre: 'RPG',
      ...
      launchConfig: {
        approvedEmbedUrl: 'https://www.retrogames.cc/embed/18893-legend-of-zelda-ocarina-of-time-n64.html',
        telemetryMode: 'origin',
        embedMode: 'inline',
        controls: ['Standard Keyboard'],
        trustNote: 'Elite emulation verified. Auto-save states enabled via cloud uplink.',
    ...
    },
    {
      ...
      url: 'https://www.retrogames.cc/embed/21888-street-fighter-ii-world-warrior-snes.html',
      genre: 'Fighting',
      ...
      launchConfig: {
        approvedEmbedUrl: 'https://www.retrogames.cc/embed/21888-street-fighter-ii-world-warrior-snes.html',
        embedMode: 'inline',
        secure_mode: 'wasm',
        controls: ['Standard Keyboard'],
    ...
    },
    {
      ...
      launchConfig: {
        ...
        trustNote: 'Elite emulation verified. Auto-save states enabled via cloud uplink.',
        secure_mode: 'wasm',
        approvedExternalUrl: 'https://www.retrogames.cc/embed/32197-007-goldeneye-usa.html',
      },
      art: {
        eyebrow: 'MI6 Command',
        accentStart: '#fbbf24',
    ...
    },
    {
      ...
      launchConfig: {
        ...
        trustNote: 'Elite emulation verified. Auto-save states enabled via cloud uplink.',
        secure_mode: 'wasm',
        approvedExternalUrl: 'https://www.retrogames.cc/embed/40662-parappa-the-rapper.html',
      },
      art: {
    ...
    },
    {
      ...
      url: 'https://www.retrogames.cc/embed/4004-sonic-the-hedgehog-genesis.html',
      genre: 'Classic',
      ...
      launchConfig: {
        approvedEmbedUrl: 'https://www.retrogames.cc/embed/4004-sonic-the-hedgehog-genesis.html',
        telemetryMode: 'origin',
        embedMode: 'inline',
        controls: ['Standard Keyboard'],
        trustNote: 'Elite emulation verified. Auto-save states enabled via cloud uplink.',
    ...
    },
    {
      ...
      name: 'Tetris',
      url: 'https://www.retrogames.cc/embed/3652-tetris-nes.html',
      genre: 'Puzzle',
      ...
      launchConfig: {
        approvedEmbedUrl: 'https://www.retrogames.cc/embed/3652-tetris-nes.html',
        telemetryMode: 'origin',
        embedMode: 'inline',
        controls: ['Standard Keyboard'],
        trustNote: 'Elite emulation verified. Auto-save states enabled via cloud uplink.',
    ...
    },
    {
      ...
      url: 'https://www.retrogames.cc/embed/26461-castlevania-symphony-of-the-night-ps1.html',
      genre: 'Action RPG',
      ...
      launchConfig: {
        approvedEmbedUrl: 'https://www.retrogames.cc/embed/26461-castlevania-symphony-of-the-night-ps1.html',
        telemetryMode: 'origin',
        embedMode: 'inline',
        controls: ['Standard Keyboard'],
        trustNote: 'Elite emulation verified. Atmospheric audio link established.',
        secure_mode: 'wasm',
        approvedExternalUrl: 'https://www.retrogames.cc/embed/40194-castlevania-symphony-of-the-night.html',
      },
      art: {
    ...
    },
    {
      ...
      launchConfig: {
        ...
        secure_mode: 'wasm',
        approvedExternalUrl: 'https://www.retrogames.cc/embed/40597-wipeout-xl.html',
      },
      art: {
    ...
    },
    {
      ...
      url: 'https://www.retrogames.cc/embed/3577-street-fighter-ii-genesis.html',
      genre: 'Fighting',
      ...
      launchConfig: {
        approvedEmbedUrl: 'https://www.retrogames.cc/embed/3577-street-fighter-ii-genesis.html',
        telemetryMode: 'origin',
        embedMode: 'inline',
        controls: ['Standard Keyboard'],
        trustNote: 'Elite emulation verified. Tournament-grade responsiveness.',
        secure_mode: 'wasm',
        approvedExternalUrl: 'https://www.retrogames.cc/embed/19001-street-fighter-ii-special-champion-edition-usa.html',
      },
      art: {
        eyebrow: 'Capcom Elite',
        accentStart: '#fbbf24',
    ...
    },
    {
      ...
      name: 'Wolfenstein 3D',
      url: 'https://www.retrogames.cc/embed/36786-wolfenstein-3d-dos.html',
      genre: 'FPS',
      ...
      launchConfig: {
        approvedEmbedUrl: 'https://www.retrogames.cc/embed/36786-wolfenstein-3d-dos.html',
        telemetryMode: 'origin',
        embedMode: 'inline',
        controls: ['Standard Keyboard'],
    ...
    },
    {
      ...
      name: 'Double Dragon',
      url: 'https://www.retrogames.cc/embed/3633-double-dragon-nes.html',
      genre: 'Beat \'em up',
      ...
      launchConfig: {
        approvedEmbedUrl: 'https://www.retrogames.cc/embed/3633-double-dragon-nes.html',
        telemetryMode: 'none',
        embedMode: 'inline',
        controls: ['Standard Keyboard'],
    ...
    },
    {
      ...
      launchConfig: {
        ...
        secure_mode: 'wasm',
        approvedExternalUrl: 'https://www.retrogames.cc/embed/21262-pokemon-yellow-version-special-pikachu-edition-usa-europe.html',
      },
      art: {
        eyebrow: 'Nintendo Elite',
        accentStart: '#f87171',
    ...
    },
    {
      ...
      name: 'Final Fantasy',
      url: 'https://www.retrogames.cc/embed/4547-final-fantasy-nes.html',
      genre: 'RPG',
      ...
      launchConfig: {
        approvedEmbedUrl: 'https://www.retrogames.cc/embed/4547-final-fantasy-nes.html',
        telemetryMode: 'none',
        embedMode: 'inline',
        controls: ['Standard Keyboard'],
    ...
    },
    {
      ...
      url: 'https://www.retrogames.cc/embed/27830-final-fantasy-vii-ps1.html',
      genre: 'RPG',
      ...
      launchConfig: {
        approvedEmbedUrl: 'https://www.retrogames.cc/embed/27830-final-fantasy-vii-ps1.html',
        embedMode: 'inline',
        secure_mode: 'wasm',
        controls: ['Standard Keyboard'],
    ...
    },
    {
      ...
      name: 'Grand Theft Auto: San Andreas (Elite HD)',
      ...
      launchConfig: {
        approvedEmbedUrl: 'https://www.retrogames.cc/embed/27071-grand-theft-auto-san-andreas-ps2.html',
        embedMode: 'inline',
        secure_mode: 'wasm',
        controls: ['Standard Keyboard'],
        approvedExternalUrl: '',
    ...
    },
    {
      ...
      launchConfig: {
        ...
        secure_mode: 'wasm',
        controls: ['Standard Keyboard'],
        approvedExternalUrl: 'https://www.retrogames.cc/embed/41885-madden-nfl-2000-usa.html',
      },
      art: {
    ...
    },
    {
      id: 'nba-2k1-elite',
      name: 'NBA 2K1',
      url: 'https://www.retrogames.cc/embed/22608-nba-2k1-dreamcast.html',
      genre: 'Sports',
      ...
      launchConfig: {
        approvedEmbedUrl: 'https://www.retrogames.cc/embed/22608-nba-2k1-dreamcast.html',
        embedMode: 'inline',
        secure_mode: 'wasm',
        controls: ['Standard Keyboard'],
        approvedExternalUrl: '',
    ...
    },
    {
      ...
      launchConfig: {
        ...
        secure_mode: 'wasm',
        controls: ['Standard Keyboard'],
        approvedExternalUrl: 'https://www.retrogames.cc/embed/32467-wwf-no-mercy-usa.html',
      },
      art: {
        eyebrow: 'THQ Elite',
        accentStart: '#a78bfa',
    ...
    },
    {
      ...
      launchConfig: {
        ...
        secure_mode: 'wasm',
        controls: ['Standard Keyboard'],
        approvedExternalUrl: 'https://www.retrogames.cc/embed/8404-marvel-vs-capcom-clash-of-super-heroes-980123.html',
      },
      art: {
        eyebrow: 'Capcom Elite',
        accentStart: '#fbbf24',
    ...
    },
    {
      ...
      launchConfig: {
        ...
        secure_mode: 'wasm',
        controls: ['Standard Keyboard'],
        approvedExternalUrl: 'https://www.retrogames.cc/embed/9394-teenage-mutant-ninja-turtles-turtles-in-time-4-players-ver-uaa.html',
      },
      art: {
        eyebrow: 'Konami Elite',
        accentStart: '#10b981',
    ...
    },
    {
      ...
      launchConfig: {
        ...
        approvedExternalUrl: 'https://www.retrogames.cc/embed/41551-tekken-5.html',
      },
      availability: 'Online',
      playersOnline: 12000,
      rating: 4.9,
    ...
    },
    {
      ...
      launchConfig: {
        ...
        secure_mode: 'wasm',
        controls: ['Standard Keyboard', 'Gamepad Support'],
        approvedExternalUrl: 'https://www.retrogames.cc/embed/43336-metal-gear-solid-2-sons-of-liberty.html',
      },
      availability: 'Online',
      playersOnline: 12000,
      rating: 4.9,
    ...
    },
    {
      ...
      launchConfig: {
        ...
        secure_mode: 'wasm',
        controls: ['Standard Keyboard', 'Gamepad Support'],
        approvedExternalUrl: 'https://www.retrogames.cc/embed/41228-sonic-adventure-2-usa.html',
      },
      availability: 'Online',
      playersOnline: 12000,
      rating: 4.9,
    ...
    },
    {
      ...
      launchConfig: {
        ...
        secure_mode: 'wasm',
        controls: ['Standard Keyboard', 'Gamepad Support'],
        approvedExternalUrl: 'https://www.retrogames.cc/embed/43331-shadow-of-the-colossus.html',
      },
      availability: 'Online',
      playersOnline: 12000,
      rating: 4.9,
    ...
    },
    {
      ...
      launchConfig: {
        ...
        secure_mode: 'wasm',
        controls: ['Standard Keyboard', 'Gamepad Support'],
        approvedExternalUrl: 'https://www.retrogames.cc/embed/41221-soulcalibur-ii-usa.html',
      },
      availability: 'Online',
      playersOnline: 12000,
      rating: 4.9,
    ...
    },
    {
      ...
      url: 'https://www.retrogames.cc/embed/37896-street-fighter-iii-3rd-strike-dreamcast.html',
      genre: 'Fighting',
      ...
      badgeIds: ['classic', 'elite'],
      launchConfig: {
        approvedEmbedUrl: 'https://www.retrogames.cc/embed/37896-street-fighter-iii-3rd-strike-dreamcast.html',
        embedMode: 'inline',
        secure_mode: 'wasm',
        controls: ['Standard Keyboard', 'Gamepad Support'],
    ...
    },
    {
      ...
      launchConfig: {
        ...
        secure_mode: 'wasm',
        controls: ['Standard Keyboard', 'Gamepad Support'],
        approvedExternalUrl: 'https://www.retrogames.cc/embed/41224-marvel-vs-capcom-2-usa.html',
      },
      availability: 'Online',
      playersOnline: 12000,
      rating: 4.9,
    ...
    },
    {
      ...
      launchConfig: {
        ...
        secure_mode: 'wasm',
        controls: ['Standard Keyboard', 'Gamepad Support'],
        approvedExternalUrl: 'https://www.retrogames.cc/embed/41253-metal-gear-solid-usa.html',
      },
      availability: 'Online',
      playersOnline: 8500,
      rating: 5,
    ...
    },
    {
      ...
      launchConfig: {
        ...
        secure_mode: 'wasm',
        controls: ['Standard Keyboard', 'Gamepad Support'],
        approvedExternalUrl: 'https://www.retrogames.cc/embed/41249-gran-turismo-2-usa.html',
      },
      availability: 'Online',
      playersOnline: 10500,
      rating: 4.9,
    ...
    },
    {
      ...
      name: 'Grand Theft Auto: Vice City (Elite HD)',
      url: 'https://www.retrogames.cc/embed/27010-grand-theft-auto-vice-city-ps2.html',
      genre: 'Action',
      ...
      badgeIds: ['classic', 'elite'],
      launchConfig: {
        approvedEmbedUrl: 'https://www.retrogames.cc/embed/27010-grand-theft-auto-vice-city-ps2.html',
        embedMode: 'inline',
        secure_mode: 'wasm',
        controls: ['Standard Keyboard', 'Gamepad Support'],
        approvedExternalUrl: '',
    ...
    },
    {
      ...
      url: 'https://www.retrogames.cc/embed/27092-final-fantasy-x-ps2.html',
      genre: 'RPG',
      ...
      badgeIds: ['classic', 'elite'],
      launchConfig: {
        approvedEmbedUrl: 'https://www.retrogames.cc/embed/27092-final-fantasy-x-ps2.html',
        embedMode: 'inline',
        secure_mode: 'wasm',
        controls: ['Standard Keyboard', 'Gamepad Support'],
    ...
    },
    {
      ...
      launchConfig: {
        ...
        secure_mode: 'wasm',
        controls: ['Standard Keyboard', 'Gamepad Support'],
        approvedExternalUrl: 'https://www.retrogames.cc/embed/41225-resident-evil-4-usa.html',
      },
      availability: 'Online',
      playersOnline: 16000,
      rating: 5,
    ...
    },
    {
      ...
      launchConfig: {
        ...
        secure_mode: 'wasm',
        controls: ['Standard Keyboard', 'Gamepad Support'],
        approvedExternalUrl: 'https://www.retrogames.cc/embed/41226-burnout-3-takedown-usa.html',
      },
      availability: 'Online',
      playersOnline: 12000,
      rating: 4.9,
    ...
    },
    {
      ...
      url: 'https://www.retrogames.cc/embed/26980-grand-theft-auto-iii-ps2.html',
      genre: 'Action',
      ...
      badgeIds: ['classic', 'elite'],
      launchConfig: {
        approvedEmbedUrl: 'https://www.retrogames.cc/embed/26980-grand-theft-auto-iii-ps2.html',
        embedMode: 'inline',
        secure_mode: 'wasm',
        controls: ['Standard Keyboard', 'Gamepad Support'],
        approvedExternalUrl: '',
    ...
    },
    {
      ...
      url: 'https://www.retrogames.cc/embed/27316-spider-man-2-ps2.html',
      genre: 'Action',
      description: 'Swing through Manhattan with Absolute precision. The web is yours to control. S.M.U.V.E. demands Elite agility.',
      tags: ['Action', 'Open World', 'PS2', 'Elite'],
      badgeIds: ['classic', 'elite'],
      launchConfig: {
        approvedEmbedUrl: 'https://www.retrogames.cc/embed/27316-spider-man-2-ps2.html',
        embedMode: 'inline',
        secure_mode: 'wasm',
        controls: ['Standard Keyboard', 'Gamepad Support'],
        approvedExternalUrl: '',
    ...
    },
    {
      ...
      launchConfig: {
        ...
        secure_mode: 'wasm',
        controls: ['Standard Keyboard', 'Gamepad Support'],
        approvedExternalUrl: 'https://www.retrogames.cc/embed/41238-jak-and-daxter-the-precursor-legacy-usa.html',
      },
      availability: 'Online',
      playersOnline: 8600,
      rating: 5,
    ...
    },
    {
      ...
      launchConfig: {
        ...
        secure_mode: 'wasm',
        controls: ['Standard Keyboard', 'Gamepad Support'],
        approvedExternalUrl: 'https://www.retrogames.cc/embed/41243-driver-parallel-lines-usa.html',
      },
      availability: 'Online',
      playersOnline: 7200,
      rating: 5,
    ...
    },
    {
      ...
      launchConfig: {
        ...
        secure_mode: 'wasm',
        controls: ['Standard Keyboard', 'Gamepad Support'],
        approvedExternalUrl: 'https://www.retrogames.cc/embed/41245-true-crime-streets-of-la-usa.html',
      },
      availability: 'Online',
      playersOnline: 7500,
      rating: 5,
    ...
    },
    {
      ...
      url: 'https://www.retrogames.cc/embed/18892-legend-of-zelda-majoras-mask-n64.html',
      genre: 'Adventure',
      ...
      badgeIds: ['classic', 'elite'],
      launchConfig: {
        approvedEmbedUrl: 'https://www.retrogames.cc/embed/18892-legend-of-zelda-majoras-mask-n64.html',
        embedMode: 'inline',
        secure_mode: 'wasm',
        controls: ['Standard Keyboard', 'Gamepad Support'],
        approvedExternalUrl: 'https://www.retrogames.cc/embed/41240-the-legend-of-zelda-majora-s-mask-usa.html',
      },
      availability: 'Online',
      playersOnline: 8400,
      rating: 5,
    ...
    },
    {
      ...
      url: 'https://www.retrogames.cc/embed/27096-prince-of-persia-sands-of-time-ps2.html',
      genre: 'Adventure',
      ...
      badgeIds: ['classic', 'elite'],
      launchConfig: {
        approvedEmbedUrl: 'https://www.retrogames.cc/embed/27096-prince-of-persia-sands-of-time-ps2.html',
        embedMode: 'inline',
        secure_mode: 'wasm',
        controls: ['Standard Keyboard', 'Gamepad Support'],
        approvedExternalUrl: 'https://www.retrogames.cc/embed/41242-prince-of-persia-the-sands-of-time-usa.html',
      },
      availability: 'Online',
      playersOnline: 8500,
      rating: 5,
    ...
    },
    {
      ...
      launchConfig: {
        ...
        secure_mode: 'wasm',
        controls: ['Standard Keyboard', 'Gamepad Support'],
        approvedExternalUrl: 'https://www.retrogames.cc/embed/41248-beyond-good-evil-usa.html',
      },
      availability: 'Online',
      playersOnline: 6800,
      rating: 5,
    ...
    },
    {
      ...
      launchConfig: {
        ...
        secure_mode: 'wasm',
        controls: ['Standard Keyboard', 'Gamepad Support'],
        approvedExternalUrl: 'https://www.retrogames.cc/embed/41251-ico-usa.html',
      },
      availability: 'Online',
      playersOnline: 5300,
      rating: 5,
    ...
    },
    {
      ...
      url: 'https://www.retrogames.cc/embed/3625-donkey-kong-nes.html',
      genre: 'Arcade',
      ...
      badgeIds: ['classic', 'elite'],
      launchConfig: {
        approvedEmbedUrl: 'https://www.retrogames.cc/embed/3625-donkey-kong-nes.html',
        embedMode: 'inline',
        secure_mode: 'wasm',
        controls: ['Standard Keyboard', 'Gamepad Support'],
    ...
    },
    {
      ...
      url: 'https://www.retrogames.cc/embed/26941-madden-nfl-2004-ps2.html',
      genre: 'Sports',
      ...
      badgeIds: ['classic', 'elite'],
      launchConfig: {
        approvedEmbedUrl: 'https://www.retrogames.cc/embed/26941-madden-nfl-2004-ps2.html',
        embedMode: 'inline',
        secure_mode: 'wasm',
        controls: ['Standard Keyboard', 'Gamepad Support'],
        approvedExternalUrl: '',
    ...
    },
    {
      id: 'fifa-2005-elite',
      name: 'FIFA 2005',
      url: 'https://www.retrogames.cc/embed/24614-fifa-2005-ps2.html',
      genre: 'Sports',
      ...
      badgeIds: ['classic', 'elite'],
      launchConfig: {
        approvedEmbedUrl: 'https://www.retrogames.cc/embed/24614-fifa-2005-ps2.html',
        embedMode: 'inline',
        secure_mode: 'wasm',
        controls: ['Standard Keyboard', 'Gamepad Support'],
        approvedExternalUrl: '',
    ...
    },
    {
      ...
      launchConfig: {
        ...
        secure_mode: 'wasm',
        controls: ['Standard Keyboard', 'Gamepad Support'],
        approvedExternalUrl: 'https://www.retrogames.cc/embed/41247-shin-megami-tensei-nocturne-usa.html',
      },
      availability: 'Online',
      playersOnline: 8200,
      rating: 5,
    ...
    },
    {
      ...
      url: 'https://www.retrogames.cc/embed/27105-need-for-speed-most-wanted-ps2.html',
      genre: 'Racing',
      description: 'The blacklist is waiting. Dominate the pursuits with Absolute speed. S.M.U.V.E. demands the top spot.',
      tags: ['Racing', 'Action', 'PS2', 'Elite'],
      badgeIds: ['classic', 'elite'],
      launchConfig: {
        approvedEmbedUrl: 'https://www.retrogames.cc/embed/27105-need-for-speed-most-wanted-ps2.html',
        embedMode: 'inline',
        secure_mode: 'wasm',
        controls: ['Standard Keyboard', 'Gamepad Support'],
        approvedExternalUrl: '',
    ...
    },
    {
      ...
      launchConfig: {
        ...
        secure_mode: 'wasm',
        controls: ['Standard Keyboard', 'Gamepad Support'],
        approvedExternalUrl: 'https://www.retrogames.cc/embed/41229-metal-gear-solid-3-snake-eater-usa.html',
      },
      availability: 'Online',
      playersOnline: 8100,
      rating: 5,
    ...
    },
    {
      ...
      launchConfig: {
        ...
        secure_mode: 'wasm',
        controls: ['Standard Keyboard', 'Gamepad Support'],
        approvedExternalUrl: 'https://www.retrogames.cc/embed/41232-gran-turismo-4-usa.html',
      },
      availability: 'Online',
      playersOnline: 6400,
      rating: 5,
    ...
    },
    {
      ...
      launchConfig: {
        ...
        secure_mode: 'wasm',
        controls: ['Standard Keyboard', 'Gamepad Support'],
        approvedExternalUrl: 'https://www.retrogames.cc/embed/41236-kingdom-hearts-ii-usa.html',
      },
      availability: 'Online',
      playersOnline: 6700,
      rating: 5,
    ...
    },
    {
      ...
      launchConfig: {
        ...
        secure_mode: 'wasm',
        controls: ['Standard Keyboard', 'Gamepad Support'],
        approvedExternalUrl: 'https://www.retrogames.cc/embed/41239-devil-may-cry-3-dante-s-awakening-usa.html',
      },
      availability: 'Online',
      playersOnline: 6500,
      rating: 5,
    ...
    },
    {
      ...
      launchConfig: {
        ...
        secure_mode: 'wasm',
        controls: ['Standard Keyboard', 'Gamepad Support'],
        approvedExternalUrl: 'https://www.retrogames.cc/embed/41235-half-life-usa.html',
      },
      availability: 'Online',
      playersOnline: 5900,
      rating: 5,
    ...
    },
    {
      ...
      launchConfig: {
        ...
        secure_mode: 'wasm',
        controls: ['Standard Keyboard', 'Gamepad Support'],
        approvedExternalUrl: 'https://www.retrogames.cc/embed/41246-unreal-tournament-usa.html',
      },
      availability: 'Online',
      playersOnline: 6700,
      rating: 5,
    ...
    },
    {
      ...
      launchConfig: {
        ...
        secure_mode: 'wasm',
        controls: ['Standard Keyboard', 'Gamepad Support'],
        approvedExternalUrl: 'https://www.retrogames.cc/embed/41252-medal-of-honor-frontline-usa.html',
      },
      availability: 'Online',
      playersOnline: 7500,
      rating: 5,
    ...
    },
    {
      ...
      name: 'Halo 2',
      url: 'https://www.retrogames.cc/embed/23128-halo-2-xbox.html',
      genre: 'FPS',
      ...
      badgeIds: ['classic', 'elite'],
      launchConfig: {
        approvedEmbedUrl: 'https://www.retrogames.cc/embed/23128-halo-2-xbox.html',
        embedMode: 'inline',
        secure_mode: 'wasm',
        controls: ['Standard Keyboard', 'Gamepad Support'],
        approvedExternalUrl: '',
    ...
    },
    {
      ...
      launchConfig: {
        ...
        secure_mode: 'wasm',
        controls: ['Standard Keyboard', 'Gamepad Support'],
        approvedExternalUrl: 'https://www.retrogames.cc/embed/41222-star-wars-knights-of-the-old-republic-usa.html',
      },
      availability: 'Online',
      playersOnline: 12000,
      rating: 4.9,
    ...
    },
    {
      ...
      launchConfig: {
        ...
        secure_mode: 'wasm',
        controls: ['Standard Keyboard', 'Gamepad Support'],
        approvedExternalUrl: 'https://www.retrogames.cc/embed/41223-ninja-gaiden-black-usa.html',
      },
      availability: 'Online',
      playersOnline: 12000,
      rating: 4.9,
    ...
    },
    {
      ...
      launchConfig: {
        ...
        secure_mode: 'wasm',
        controls: ['Standard Keyboard', 'Gamepad Support'],
        approvedExternalUrl: 'https://www.retrogames.cc/embed/42780-ratchet-clank-up-your-arsenal.html',
      },
      availability: 'Online',
      playersOnline: 12000,
      rating: 4.9,
    ...
    },
    {
      ...
      launchConfig: {
        ...
        secure_mode: 'wasm',
        controls: ['Standard Keyboard', 'Gamepad Support'],
        approvedExternalUrl: 'https://www.retrogames.cc/embed/42781-sly-2-band-of-thieves.html',
      },
      availability: 'Online',
      playersOnline: 12000,
      rating: 4.9,
    ...
    },
    {
      ...
      launchConfig: {
        ...
        secure_mode: 'wasm',
        controls: ['Standard Keyboard', 'Gamepad Support'],
        approvedExternalUrl: 'https://www.retrogames.cc/embed/42782-katamari-damacy.html',
      },
      availability: 'Online',
      playersOnline: 12000,
      rating: 4.9,
    ...
    },
    {
      ...
      launchConfig: {
        ...
        secure_mode: 'wasm',
        controls: ['Standard Keyboard', 'Gamepad Support'],
        approvedExternalUrl: 'https://www.retrogames.cc/embed/42783-persona-4.html',
      },
      availability: 'Online',
      playersOnline: 12000,
      rating: 4.9,
    ...
    },
    {
      ...
      launchConfig: {
        ...
        secure_mode: 'wasm',
        controls: ['Standard Keyboard', 'Gamepad Support'],
        approvedExternalUrl: 'https://www.retrogames.cc/embed/42785-silent-hill-2.html',
      },
      availability: 'Online',
      playersOnline: 8000,
      rating: 5,
    ...
    },
    {
      ...
      launchConfig: {
        ...
        secure_mode: 'wasm',
        controls: ['Standard Keyboard', 'Gamepad Support'],
        approvedExternalUrl: 'https://www.retrogames.cc/embed/42786-def-jam-fight-for-ny.html',
      },
      availability: 'Online',
      playersOnline: 15000,
      rating: 4.9,
    ...
    },
    {
      ...
      url: 'https://www.retrogames.cc/embed/27264-need-for-speed-underground-2-ps2.html',
      genre: 'Racing',
      ...
      badgeIds: ['elite', 'featured'],
      launchConfig: {
        approvedEmbedUrl: 'https://www.retrogames.cc/embed/27264-need-for-speed-underground-2-ps2.html',
        embedMode: 'inline',
        secure_mode: 'wasm',
        controls: ['Standard Keyboard', 'Gamepad Support'],
        approvedExternalUrl: '',
    ...
    },
    {
      ...
      url: 'https://www.retrogames.cc/embed/21891-street-fighter-ii-champion-edition-snes.html',
      ...
      launchConfig: {
        ...
        embedMode: 'inline',
        approvedExternalUrl: 'https://www.retrogames.cc/embed/21891-street-fighter-ii-champion-edition-snes.html',
      },
    },
    {
    ...
    },
    {
      ...
      playersOnline: 22000,
      availability: 'Online',
      tags: ['Action', 'Adventure', 'PS2', 'Elite'],
      badgeIds: ['classic', 'elite', 'featured'],
      launchConfig: {
    ...
    },
    {
      ...
      playersOnline: 14000,
      availability: 'Online',
      tags: ['Fighting', 'Versus', 'PS2', 'Elite'],
      badgeIds: ['classic', 'elite', 'tournament-live'],
      launchConfig: {
    ...
    },
    {
      ...
      playersOnline: 15000,
      availability: 'Online',
      tags: ['Racing', 'Multiplayer', 'N64', 'Elite'],
      badgeIds: ['classic', 'elite'],
      launchConfig: {
    ...
    },
    {
      ...
      name: 'Grand Theft Auto: London 1969 (Elite)',
      url: 'https://www.retrogames.cc/embed/28674-grand-theft-auto-london-1969-ps1.html',
      genre: 'Action',
    ...
    },
    {
      ...
      name: 'Tekken 8',
      url: 'https://www.retrogames.cc/embed/47369-tekken-8-pc.html',
      genre: 'Fighting',
      description: 'Elite WebGL Tribute. High-fidelity browser-native execution for Tekken 8.',
      rating: 4.9,
      playersOnline: 45000,
      availability: 'Online',
      tags: ['Fighting', 'Competitive', 'WebGL', 'Elite', 'Internal'],
      badgeIds: ['next-gen', 'elite'],
      art: {
      ...
      launchConfig: {
        approvedExternalUrl: '',
        embedMode: 'inline',
        approvedEmbedUrl: 'https://www.retrogames.cc/embed/47369-tekken-8-pc.html',
      },
    },
    {
      ...
      tags: ['Sports', 'Retro', 'Elite', 'Stabilized'],
      badgeIds: ['elite', 'classic'],
      launchConfig: {
    ...
    },
    {
      ...
      url: 'https://www.retrogames.cc/embed/47368-mortal-kombat-1-pc.html',
      genre: 'Fighting',
      ...
      launchConfig: {
        approvedExternalUrl: '',
        embedMode: 'inline',
        approvedEmbedUrl: 'https://www.retrogames.cc/embed/47368-mortal-kombat-1-pc.html',
      },
    },
    {
    ...
    },
    {
      ...
      tags: ['FPS', 'Retro', 'Elite', 'Stabilized'],
      badgeIds: ['elite', 'classic'],
      launchConfig: {
    ...
    },
    {
      ...
      launchConfig: {
        ...
        embedMode: 'external-only',
        secure_mode: 'wasm',
        approvedExternalUrl: 'https://www.retrogames.cc/embed/41887-nba-live-2000-usa.html',
      },
      art: {
    ...
    },
    {
      ...
      playersOnline: 1200,
      availability: 'Online',
      tags: ['Classic', 'Retro', 'Arcade', 'Beat \'em up', 'Elite'],
      badgeIds: ['elite', 'staff-pick'],
      launchConfig: {
        difficulty: 'Elite',
    ...
    },
    {
      ...
      name: 'Dragon Ball Z: Buu\'s Fury (Classic)',
      ...
      playersOnline: 3400,
      availability: 'Online',
      tags: ['Classic', 'Retro', 'GBA', 'RPG', 'Elite', 'DBZ'],
    ...
    },
    {
      ...
      url: 'https://www.retrogames.cc/embed/4735-mega-man-2-nes.html',
      ...
      launchConfig: {
        ...
        approvedEmbedUrl: 'https://www.retrogames.cc/embed/4735-mega-man-2-nes.html',
        secure_mode: 'wasm',
      },
      art: {
        eyebrow: 'Classic Elite',
    ...
    },
    {
      ...
      url: 'https://www.retrogames.cc/embed/3643-legend-of-zelda-nes.html',
      description: 'The beginning of the legend. Explore Hyrule, conquer dungeons, and save Princess Zelda.',
      genre: 'Adventure',
      rating: 4.9,
      playersOnline: 2100,
      availability: 'Online',
      tags: ['Classic', 'Retro', 'NES', 'Adventure', 'Elite'],
      badgeIds: ['elite', 'staff-pick'],
      launchConfig: {
        difficulty: 'Elite',
        controls: ['Gamepad', 'Keyboard'],
        ...
        approvedEmbedUrl: 'https://www.retrogames.cc/embed/3643-legend-of-zelda-nes.html',
        secure_mode: 'wasm',
      },
      art: {
        eyebrow: 'Classic Elite',
    ...
    },
    {
      ...
      playersOnline: 500,
      availability: 'Online',
      tags: ['Classic', 'Retro', 'Elite', 'Action'],
      badgeIds: ['elite'],
      launchConfig: {
        difficulty: 'Elite',
        controls: ['Gamepad', 'Keyboard'],
    ...
    {
      id: 'gta-2-classic',
      name: 'Grand Theft Auto 2 (Classic)',
    ...
    {
      id: 'gta-sa-classic',
      name: 'Grand Theft Auto: San Andreas (Classic)',
    ...
    },
    {
      ...
      url: 'https://www.retrogames.cc/embed/3634-double-dragon-ii-the-revenge-nes.html',
      ...
      launchConfig: {
        ...
        approvedEmbedUrl: 'https://www.retrogames.cc/embed/3634-double-dragon-ii-the-revenge-nes.html',
        secure_mode: 'wasm',
      },
      art: {
        eyebrow: 'Classic Elite',
    ...
    {
      id: 'dbz-sw-classic',
      name: 'Dragon Ball Z: Supersonic Warriors (Classic)',
    ...
    },
    {
      ...
      url: 'https://www.retrogames.cc/embed/21113-mega-man-x-snes.html',
      ...
      launchConfig: {
        ...
        approvedEmbedUrl: 'https://www.retrogames.cc/embed/21113-mega-man-x-snes.html',
        secure_mode: 'wasm',
      },
      art: {
        eyebrow: 'Classic Elite',
    ...
    },
    {
      ...
      name: 'The Legend of Zelda: Ocarina of Time (Classic)',
      url: 'https://www.retrogames.cc/embed/18893-legend-of-zelda-ocarina-of-time-n64.html',
      ...
      playersOnline: 500,
      availability: 'Online',
      tags: ['Classic', 'Retro', 'Elite', 'Adventure'],
      badgeIds: ['elite'],
      launchConfig: {
        difficulty: 'Elite',
        controls: ['Gamepad', 'Keyboard'],
    ...
    },
    {
      ...
      playersOnline: 500,
      availability: 'Online',
      tags: ['Classic', 'Retro', 'Elite', 'Classic'],
      badgeIds: ['elite'],
      launchConfig: {
        difficulty: 'Elite',
        controls: ['Gamepad', 'Keyboard'],
    ...
    },
    {
      ...
      url: 'https://www.retrogames.cc/embed/4008-sonic-the-hedgehog-2-genesis.html',
      ...
      launchConfig: {
        ...
        embedMode: 'inline',
        approvedExternalUrl: 'https://www.retrogames.cc/embed/24220-sonic-the-hedgehog-2-world.html',
        approvedEmbedUrl: 'https://www.retrogames.cc/embed/4008-sonic-the-hedgehog-2-genesis.html',
        secure_mode: 'wasm',
      },
      art: {
        eyebrow: 'Classic Elite',
    ...
    },
    {
      ...
      playersOnline: 500,
      availability: 'Online',
      tags: ['Classic', 'Retro', 'Elite', 'Sports'],
      badgeIds: ['elite'],
      launchConfig: {
        difficulty: 'Elite',
        controls: ['Gamepad', 'Keyboard'],
    ...
    },
    {
      ...
      tags: ['RPG', 'Retro', 'GBA', 'Elite', 'Pokemon'],
      badgeIds: ['elite', 'trending', 'staff-pick'],
      launchConfig: {
    ...
    },
    {
      ...
      name: 'DOOM II',
      url: 'https://www.retrogames.cc/embed/5543-doom-ii-dos.html',
      genre: 'FPS',
      ...
      badgeIds: ['elite', 'classic'],
      launchConfig: {
        approvedEmbedUrl: 'https://www.retrogames.cc/embed/5543-doom-ii-dos.html',
        embedMode: 'inline',
        secure_mode: 'wasm',
    ...
    },
    {
      ...
      name: 'Metal Slug 3',
      url: 'https://www.retrogames.cc/embed/20773-metal-slug-3-neo-geo.html',
      genre: 'Action',
      ...
      badgeIds: ['elite', 'featured'],
      launchConfig: {
        approvedEmbedUrl: 'https://www.retrogames.cc/embed/20773-metal-slug-3-neo-geo.html',
        embedMode: 'inline',
        secure_mode: 'wasm',
    ...
    },
    {
      ...
      url: 'https://www.retrogames.cc/embed/4642-legend-of-zelda-a-link-to-the-past-snes.html',
      genre: 'Adventure',
      description: 'The Absolute 16-bit masterpiece. High-fidelity adventure through the Light and Dark worlds.',
      tags: ['Adventure', 'Retro', 'SNES', 'Elite', 'RPG'],
      badgeIds: ['elite', 'classic', 'staff-pick'],
      launchConfig: {
        approvedEmbedUrl: 'https://www.retrogames.cc/embed/4642-legend-of-zelda-a-link-to-the-past-snes.html',
        embedMode: 'inline',
        secure_mode: 'wasm',
    ...
    },
    {
      ...
      tags: ['Sports', 'Retro', 'Arcade', 'Elite', 'Basketball'],
      badgeIds: ['elite', 'featured'],
      launchConfig: {
    ...
    },
    {
      ...
      tags: ['RPG', 'Retro', 'SNES', 'Elite', 'Fantasy'],
      badgeIds: ['elite', 'classic', 'staff-pick'],
      launchConfig: {
    ...
    },
    {
      ...
      tags: ['Action', 'Retro', 'SNES', 'Elite', 'Platformer'],
      badgeIds: ['elite', 'featured'],
      launchConfig: {
        approvedEmbedUrl: 'https://www.retrogames.cc/embed/21113-mega-man-x-snes.html',
        embedMode: 'inline',
    ...
    },
    {
      ...
      tags: ['Classic', 'Retro', 'Sega CD', 'Elite', 'Sonic'],
      badgeIds: ['elite', 'trending'],
      launchConfig: {
    ...
    },
    {
      ...
      tags: ['FPS', 'Retro', 'PC', 'Elite', 'Action'],
      badgeIds: ['elite', 'featured'],
      launchConfig: {
    ...
    },
    {
      ...
      name: 'Metal Slug X',
      url: 'https://www.retrogames.cc/embed/20757-metal-slug-x-neo-geo.html',
      genre: 'Action',
      description: 'Absolute refined run-and-gun. High-fidelity boss encounters and frantic weapon variety.',
      tags: ['Action', 'Retro', 'Arcade', 'Elite', 'Shooter'],
      badgeIds: ['elite', 'featured'],
      launchConfig: {
        approvedEmbedUrl: 'https://www.retrogames.cc/embed/20757-metal-slug-x-neo-geo.html',
        embedMode: 'inline',
        secure_mode: 'wasm',
    ...
    },
    {
      ...
      tags: ['Beat \'em up', 'Retro', 'Genesis', 'Elite', 'Action'],
      badgeIds: ['elite', 'featured', 'staff-pick'],
      launchConfig: {
    ...
    },
    {
      ...
      tags: ['Action', 'Retro', 'GBA', 'Elite', 'RPG'],
      badgeIds: ['elite', 'staff-pick'],
      launchConfig: {
    ...
    },
    {
      ...
      url: 'https://www.retrogames.cc/embed/4647-super-castlevania-iv-snes.html',
      genre: 'Action',
      description: 'Absolute high-fidelity Action action. Experience Castlevania IV in a stabilized browser environment.',
      tags: ['Action', 'Retro', 'Elite', 'Stabilized'],
      badgeIds: ['elite', 'classic'],
      launchConfig: {
        approvedEmbedUrl: 'https://www.retrogames.cc/embed/4647-super-castlevania-iv-snes.html',
        embedMode: 'inline',
        secure_mode: 'wasm',
    ...
    },
    {
      ...
      name: 'Mega Man X3',
      url: 'https://www.retrogames.cc/embed/4764-mega-man-x3-snes.html',
      genre: 'Action',
      description: 'Absolute high-fidelity Action action. Experience Mega Man X3 in a stabilized browser environment.',
      tags: ['Action', 'Retro', 'Elite', 'Stabilized'],
      badgeIds: ['elite', 'classic'],
      launchConfig: {
        approvedEmbedUrl: 'https://www.retrogames.cc/embed/4764-mega-man-x3-snes.html',
        embedMode: 'inline',
        secure_mode: 'wasm',
    ...
    },
    {
      ...
      url: 'https://www.retrogames.cc/embed/4707-kirby-super-star-snes.html',
      genre: 'Action',
      description: 'Absolute high-fidelity Action action. Experience Kirby Super Star in a stabilized browser environment.',
      tags: ['Action', 'Retro', 'Elite', 'Stabilized'],
      badgeIds: ['elite', 'classic'],
      launchConfig: {
        approvedEmbedUrl: 'https://www.retrogames.cc/embed/4707-kirby-super-star-snes.html',
        embedMode: 'inline',
        secure_mode: 'wasm',
    ...
    },
    {
      ...
      url: 'https://www.retrogames.cc/embed/4767-super-mario-world-snes.html',
      genre: 'Classic',
      ...
      badgeIds: ['elite', 'classic'],
      launchConfig: {
        approvedEmbedUrl: 'https://www.retrogames.cc/embed/4767-super-mario-world-snes.html',
        embedMode: 'inline',
        secure_mode: 'wasm',
    ...
    },
    {
      ...
      url: 'https://www.retrogames.cc/embed/4657-donkey-kong-country-snes.html',
      genre: 'Classic',
      description: 'Absolute high-fidelity Classic action. Experience Donkey Kong Country in a stabilized browser environment.',
      tags: ['Classic', 'Retro', 'Elite', 'Stabilized'],
      badgeIds: ['elite', 'classic'],
      launchConfig: {
        approvedEmbedUrl: 'https://www.retrogames.cc/embed/4657-donkey-kong-country-snes.html',
        embedMode: 'inline',
        secure_mode: 'wasm',
    ...
    },
    {
      ...
      url: 'https://www.retrogames.cc/embed/4010-sonic-3-and-knuckles-genesis.html',
      genre: 'Classic',
      description: 'Absolute high-fidelity Classic action. Experience Sonic the Hedgehog 3 in a stabilized browser environment.',
      tags: ['Classic', 'Retro', 'Elite', 'Stabilized'],
      badgeIds: ['elite', 'classic'],
      launchConfig: {
        approvedEmbedUrl: 'https://www.retrogames.cc/embed/4010-sonic-3-and-knuckles-genesis.html',
        embedMode: 'inline',
        secure_mode: 'wasm',
    ...
    },
    {
      ...
      name: 'Star Fox',
      url: 'https://www.retrogames.cc/embed/4778-star-fox-snes.html',
      genre: 'Shooting',
      ...
      badgeIds: ['elite', 'classic'],
      launchConfig: {
        approvedEmbedUrl: 'https://www.retrogames.cc/embed/4778-star-fox-snes.html',
        embedMode: 'inline',
        secure_mode: 'wasm',
    ...
    },
    {
      ...
      name: 'F-Zero',
      url: 'https://www.retrogames.cc/embed/20958-f-zero-snes.html',
      genre: 'Racing',
      ...
      badgeIds: ['elite', 'classic'],
      launchConfig: {
        approvedEmbedUrl: 'https://www.retrogames.cc/embed/20958-f-zero-snes.html',
        embedMode: 'inline',
        secure_mode: 'wasm',
    ...
    },
    {
      ...
      name: 'Star Fox 64',
      url: 'https://www.retrogames.cc/embed/18944-star-fox-64-n64.html',
      genre: 'Shooting',
      description: 'Absolute high-fidelity Shooting action. Experience Star Fox 64 in a stabilized browser environment.',
      tags: ['Shooting', 'Retro', 'Elite', 'Stabilized'],
      badgeIds: ['elite', 'classic'],
      launchConfig: {
        approvedEmbedUrl: 'https://www.retrogames.cc/embed/18944-star-fox-64-n64.html',
        embedMode: 'inline',
        secure_mode: 'wasm',
    ...
    },
    {
      ...
      name: 'DOOM 64',
      url: 'https://www.retrogames.cc/embed/21559-doom-64-n64.html',
      genre: 'FPS',
      description: 'Absolute high-fidelity FPS action. Experience Doom 64 in a stabilized browser environment.',
      tags: ['FPS', 'Retro', 'Elite', 'Stabilized'],
      badgeIds: ['elite', 'classic'],
      launchConfig: {
        approvedEmbedUrl: 'https://www.retrogames.cc/embed/21559-doom-64-n64.html',
        embedMode: 'inline',
        secure_mode: 'wasm',
    ...
    },
    {
      ...
      tags: ['Strategy', 'Retro', 'Elite', 'Stabilized'],
      badgeIds: ['elite', 'classic'],
      launchConfig: {
    ...
    },
    {
      ...
      name: 'Duck Hunt',
      url: 'https://www.retrogames.cc/embed/17905-duck-hunt-nes.html',
      genre: 'Shooting',
      description: 'The iconic NES light-gun classic. Shoot ducks and endure the laughing dog\'s taunts in this quintessential Nintendo launch title.',
      rating: 4.6,
      playersOnline: 15000,
      availability: 'Online',
      ...
      badgeIds: ['classic'],
      launchConfig: {
        approvedEmbedUrl: 'https://www.retrogames.cc/embed/17905-duck-hunt-nes.html',
        embedMode: 'external-only',
        secure_mode: 'wasm',
    ...
    },
    {
      ...
      url: 'https://www.retrogames.cc/embed/4766-super-mario-kart-snes.html',
      genre: 'Racing',
      description: 'The game that invented kart racing. Race through Mushroom Kingdom circuits.',
      rating: 4.7,
      playersOnline: 8200,
      availability: 'Online',
      tags: ['Racing', 'SNES', 'Classic', 'Multiplayer', 'Mario'],
      badgeIds: ['classic', 'elite'],
      launchConfig: {
        approvedEmbedUrl: 'https://www.retrogames.cc/embed/4766-super-mario-kart-snes.html',
        embedMode: 'inline',
        secure_mode: 'wasm',
    ...
    },
    {
      ...
      url: 'https://www.retrogames.cc/embed/4665-donkey-kong-country-2-snes.html',
      genre: 'Platformer',
      description: 'Diddy and Dixie Kong rescue Donkey Kong from Kaptain K. Rool.',
      rating: 4.8,
      playersOnline: 6100,
      availability: 'Online',
      ...
      badgeIds: ['classic', 'elite'],
      launchConfig: {
        approvedEmbedUrl: 'https://www.retrogames.cc/embed/4665-donkey-kong-country-2-snes.html',
        embedMode: 'inline',
        secure_mode: 'wasm',
    ...
    },
    {
      ...
      name: 'Secret of Mana',
      url: 'https://www.retrogames.cc/embed/32112-secret-of-mana-usa.html',
      genre: 'Action RPG',
      description: '3-player co-op action RPG. Wield the Mana Sword to save the world.',
      rating: 4.6,
      playersOnline: 4200,
      availability: 'Online',
      tags: ['Action RPG', 'SNES', 'Co-op', 'Classic', 'JRPG'],
      badgeIds: ['classic'],
      launchConfig: {
        approvedEmbedUrl: 'https://www.retrogames.cc/embed/32112-secret-of-mana-usa.html',
        embedMode: 'external-only',
        secure_mode: 'wasm',
        approvedExternalUrl: 'https://www.retrogames.cc/embed/32112-secret-of-mana-usa.html',
      },
      art: {
        eyebrow: 'SNES Co-op',
        accentStart: '#00cc66',
    ...
    },
    {
      ...
      url: 'https://www.retrogames.cc/embed/32121-street-fighter-alpha-2-usa.html',
      genre: 'Fighting',
      description: 'The definitive Street Fighter Alpha experience on SNES with custom combos.',
      rating: 4.5,
      playersOnline: 7600,
      availability: 'Online',
      ...
      badgeIds: ['classic'],
      launchConfig: {
        approvedEmbedUrl: 'https://www.retrogames.cc/embed/32121-street-fighter-alpha-2-usa.html',
        embedMode: 'external-only',
        secure_mode: 'wasm',
    ...
    },
    {
      ...
      name: 'EarthBound',
      url: 'https://www.retrogames.cc/embed/32016-earthbound-usa.html',
      genre: 'RPG',
      description: 'Ness and friends battle Giygas in this quirky cult classic RPG.',
      rating: 4.8,
      playersOnline: 5600,
      availability: 'Online',
      ...
      badgeIds: ['classic', 'featured'],
      launchConfig: {
        approvedEmbedUrl: 'https://www.retrogames.cc/embed/32016-earthbound-usa.html',
        embedMode: 'external-only',
        secure_mode: 'wasm',
    ...
    },
    {
      ...
      url: 'https://www.retrogames.cc/embed/32131-super-bomberman-usa.html',
      genre: 'Action',
      description: '4-player explosive arena action. The ultimate party game on SNES.',
      rating: 4.5,
      playersOnline: 3200,
      availability: 'Online',
      ...
      badgeIds: ['classic'],
      launchConfig: {
        approvedEmbedUrl: 'https://www.retrogames.cc/embed/32131-super-bomberman-usa.html',
        embedMode: 'inline',
        secure_mode: 'wasm',
    ...
    },
    {
      ...
      name: 'Comix Zone',
      url: 'https://www.retrogames.cc/embed/29006-comix-zone-usa.html',
      genre: 'Action',
      description: 'Punch through comic book panels in this unique Sega beat-em-up.',
      rating: 4.5,
      playersOnline: 2800,
      availability: 'Online',
      ...
      badgeIds: ['classic'],
      launchConfig: {
        approvedEmbedUrl: 'https://www.retrogames.cc/embed/29006-comix-zone-usa.html',
        embedMode: 'external-only',
        secure_mode: 'wasm',
    ...
    },
    {
      ...
      name: 'Vectorman',
      url: 'https://www.retrogames.cc/embed/29041-vectorman-usa.html',
      genre: 'Action',
      description: 'A glob-throwing robot saves Earth in this pre-rendered Genesis shooter.',
      rating: 4.4,
      playersOnline: 2200,
      availability: 'Online',
      ...
      badgeIds: ['classic'],
      launchConfig: {
        approvedEmbedUrl: 'https://www.retrogames.cc/embed/29041-vectorman-usa.html',
        embedMode: 'external-only',
        secure_mode: 'wasm',
    ...
    },
    {
      ...
      name: 'Altered Beast',
      url: 'https://www.retrogames.cc/embed/29001-altered-beast-w-world.html',
      genre: 'Beat \'em up',
      description: 'Rise from your grave! Transform into powerful beasts in this iconic arcade port.',
      rating: 4.3,
      playersOnline: 2600,
      availability: 'Online',
      ...
      badgeIds: ['classic'],
      launchConfig: {
        approvedEmbedUrl: 'https://www.retrogames.cc/embed/29001-altered-beast-w-world.html',
        embedMode: 'external-only',
        secure_mode: 'wasm',
    ...
    },
    {
      ...
      url: 'https://www.retrogames.cc/embed/29033-phantasy-star-iv-usa.html',
      genre: 'RPG',
      description: 'Sega\'s answer to Final Fantasy. Sci-fi RPG epic across the Algo star system.',
      rating: 4.7,
      playersOnline: 3800,
      availability: 'Online',
      ...
      badgeIds: ['classic', 'elite'],
      launchConfig: {
        approvedEmbedUrl: 'https://www.retrogames.cc/embed/29033-phantasy-star-iv-usa.html',
        embedMode: 'external-only',
        secure_mode: 'wasm',
    ...
    },
    {
      ...
      url: 'https://www.retrogames.cc/embed/29011-ecco-the-dolphin-usa.html',
      genre: 'Adventure',
      description: 'Explore the ocean as a dolphin in this hauntingly beautiful Sega adventure.',
      rating: 4.3,
      playersOnline: 1800,
      availability: 'Online',
      tags: ['Adventure', 'Genesis', 'Unique', 'Underwater'],
      badgeIds: ['classic'],
      launchConfig: {
        approvedEmbedUrl: 'https://www.retrogames.cc/embed/29011-ecco-the-dolphin-usa.html',
        embedMode: 'external-only',
        secure_mode: 'wasm',
        approvedExternalUrl: 'https://www.retrogames.cc/embed/29011-ecco-the-dolphin-usa.html',
      },
      art: {
        eyebrow: 'Genesis Adventure',
        accentStart: '#0099cc',
        accentEnd: '#003344',
      },
    ...
    },
    {
      ...
      name: 'ToeJam & Earl',
      url: 'https://www.retrogames.cc/embed/29039-toejam-earl-usa.html',
      genre: 'Roguelike',
      description: 'Two funky aliens crash-land on Earth in this hilarious co-op roguelike.',
      rating: 4.4,
      playersOnline: 2000,
      availability: 'Online',
      tags: ['Roguelike', 'Genesis', 'Co-op', 'Cult'],
      badgeIds: ['classic'],
      launchConfig: {
        approvedEmbedUrl: 'https://www.retrogames.cc/embed/29039-toejam-earl-usa.html',
        embedMode: 'external-only',
        secure_mode: 'wasm',
        approvedExternalUrl: 'https://www.retrogames.cc/embed/29039-toejam-earl-usa.html',
      },
      art: {
        eyebrow: 'Genesis Cult',
        accentStart: '#ff00ff',
        accentEnd: '#330033',
      },
    ...
    },
    {
      ...
      name: 'Shinobi III',
      url: 'https://www.retrogames.cc/embed/29037-shinobi-iii-return-of-the-ninja-master-usa.html',
      genre: 'Action',
      description: 'Joe Musashi in the pinnacle of the Shinobi series - fluid ninja action.',
      rating: 4.6,
      playersOnline: 2400,
      availability: 'Online',
      ...
      badgeIds: ['classic'],
      launchConfig: {
        approvedEmbedUrl: 'https://www.retrogames.cc/embed/29037-shinobi-iii-return-of-the-ninja-master-usa.html',
        embedMode: 'external-only',
        secure_mode: 'wasm',
    ...
    },
    {
      ...
      url: 'https://www.retrogames.cc/embed/29035-rocket-knight-adventures-usa.html',
      genre: 'Platformer',
      description: 'A jet-pack-wielding knight on an epic Konami platforming adventure.',
      rating: 4.5,
      playersOnline: 1600,
      availability: 'Online',
      ...
      badgeIds: ['classic'],
      launchConfig: {
        approvedEmbedUrl: 'https://www.retrogames.cc/embed/29035-rocket-knight-adventures-usa.html',
        embedMode: 'external-only',
        secure_mode: 'wasm',
    ...
    },
    {
      ...
      name: 'Advance Wars',
      url: 'https://www.retrogames.cc/embed/40009-advance-wars-usa.html',
      genre: 'Strategy',
      description: 'Command armies in this beloved turn-based tactical strategy masterpiece.',
      rating: 4.7,
      playersOnline: 4600,
      availability: 'Online',
      ...
      badgeIds: ['classic', 'elite'],
      launchConfig: {
        approvedEmbedUrl: 'https://www.retrogames.cc/embed/40009-advance-wars-usa.html',
        embedMode: 'external-only',
        secure_mode: 'wasm',
    ...
    },
    {
      ...
      name: 'Golden Sun',
      url: 'https://www.retrogames.cc/embed/40147-golden-sun-usa.html',
      genre: 'RPG',
      description: 'Camelot\'s GBA JRPG with Djinn summoning and psynergy puzzles.',
      rating: 4.6,
      playersOnline: 3400,
      availability: 'Online',
      ...
      badgeIds: ['classic'],
      launchConfig: {
        approvedEmbedUrl: 'https://www.retrogames.cc/embed/40147-golden-sun-usa.html',
        embedMode: 'external-only',
        secure_mode: 'wasm',
    ...
    },
    {
      ...
      url: 'https://www.retrogames.cc/embed/40240-mario-kart-super-circuit-usa.html',
      genre: 'Racing',
      description: 'Mario Kart goes portable with all-new tracks and classic SNES circuits.',
      rating: 4.5,
      playersOnline: 5800,
      availability: 'Online',
      ...
      badgeIds: ['classic'],
      launchConfig: {
        approvedEmbedUrl: 'https://www.retrogames.cc/embed/40240-mario-kart-super-circuit-usa.html',
        embedMode: 'external-only',
        secure_mode: 'wasm',
    ...
    },
    {
      ...
      name: 'Fire Emblem',
      url: 'https://www.retrogames.cc/embed/40135-fire-emblem-usa.html',
      genre: 'Strategy',
      description: 'The tactical RPG that launched a Western phenomenon. Permadeath counts.',
      rating: 4.7,
      playersOnline: 4800,
      availability: 'Online',
      ...
      badgeIds: ['classic', 'elite'],
      launchConfig: {
        approvedEmbedUrl: 'https://www.retrogames.cc/embed/40135-fire-emblem-usa.html',
        embedMode: 'external-only',
        secure_mode: 'wasm',
    ...
    },
    {
      ...
      name: 'WarioWare, Inc.',
      url: 'https://www.retrogames.cc/embed/40377-warioware-inc-mega-microgames-usa.html',
      genre: 'Party',
      description: '5-second micro-games at breakneck speed. Wario\'s chaotic party masterpiece.',
      rating: 4.5,
      playersOnline: 3200,
      availability: 'Online',
      tags: ['Party', 'GBA', 'Wario', 'Unique'],
      badgeIds: ['classic'],
      launchConfig: {
        approvedEmbedUrl: 'https://www.retrogames.cc/embed/40377-warioware-inc-mega-microgames-usa.html',
        embedMode: 'external-only',
        secure_mode: 'wasm',
        approvedExternalUrl: 'https://www.retrogames.cc/embed/40377-warioware-inc-mega-microgames-usa.html',
      },
      art: {
        eyebrow: 'GBA Party',
        accentStart: '#ffcc00',
    ...
    },
    {
      ...
      name: 'F-Zero X',
      url: 'https://www.retrogames.cc/embed/18914-f-zero-x-n64.html',
      genre: 'Racing',
      description: 'Anti-gravity racing at 60fps. Captain Falcon races 30 tracks at insane speed.',
      rating: 4.7,
      playersOnline: 3600,
      availability: 'Online',
      tags: ['Racing', 'N64', 'F-Zero', 'Sci-Fi', 'Speed'],
      badgeIds: ['classic', 'elite'],
      launchConfig: {
        approvedEmbedUrl: 'https://www.retrogames.cc/embed/18914-f-zero-x-n64.html',
        embedMode: 'inline',
        secure_mode: 'wasm',
        approvedExternalUrl: 'https://www.retrogames.cc/embed/32221-f-zero-x-usa.html',
      },
      art: {
        eyebrow: 'N64 Racing',
        accentStart: '#0066ff',
    ...
    },
    {
      ...
      name: 'Paper Mario',
      url: 'https://www.retrogames.cc/embed/41762-paper-mario.html',
      genre: 'RPG',
      description: 'Mario\'s papery RPG adventure with turn-based combat and charming characters.',
      rating: 4.7,
      playersOnline: 5800,
      availability: 'Online',
      tags: ['RPG', 'N64', 'Mario', 'JRPG'],
      badgeIds: ['classic', 'elite'],
      launchConfig: {
        approvedEmbedUrl: 'https://www.retrogames.cc/embed/41762-paper-mario.html',
        embedMode: 'external-only',
        secure_mode: 'wasm',
        approvedExternalUrl: 'https://www.retrogames.cc/embed/41762-paper-mario.html',
      },
      art: {
        eyebrow: 'N64 RPG',
        accentStart: '#ff3333',
    ...
    },
    {
      ...
      name: 'Kirby 64: Crystal Shards',
      url: 'https://www.retrogames.cc/embed/18946-kirby-64-the-crystal-shards-n64.html',
      genre: 'Platformer',
      description: 'Kirby combines copy abilities for the first time in this colorful N64 adventure.',
      rating: 4.5,
      playersOnline: 3400,
      availability: 'Online',
      tags: ['Platformer', 'N64', 'Kirby', 'Classic', 'Co-op'],
      badgeIds: ['classic'],
      launchConfig: {
        approvedEmbedUrl: 'https://www.retrogames.cc/embed/18946-kirby-64-the-crystal-shards-n64.html',
        embedMode: 'inline',
        secure_mode: 'wasm',
        approvedExternalUrl: 'https://www.retrogames.cc/embed/32230-kirby-64-the-crystal-shards-usa.html',
      },
      art: {
        eyebrow: 'N64 Cute',
        accentStart: '#ff66cc',
    ...
    },
    {
      ...
      name: 'Bomberman 64',
      url: 'https://www.retrogames.cc/embed/18939-bomberman-64-n64.html',
      genre: 'Action',
      description: 'Bomberman goes 3D with adventure mode and explosive 4-player battles.',
      rating: 4.4,
      playersOnline: 2600,
      availability: 'Online',
      tags: ['Action', 'N64', 'Party', 'Multiplayer'],
      badgeIds: ['classic'],
      launchConfig: {
        approvedEmbedUrl: 'https://www.retrogames.cc/embed/18939-bomberman-64-n64.html',
        embedMode: 'inline',
        secure_mode: 'wasm',
        approvedExternalUrl: 'https://www.retrogames.cc/embed/32207-bomberman-64-usa.html',
      },
      art: {
        eyebrow: 'N64 Party',
        accentStart: '#ff9900',
    ...
    },
    {
      ...
      name: 'Metal Slug 2',
      url: 'https://www.retrogames.cc/embed/14871-metal-slug-2.html',
      genre: 'Action',
      description: 'Legendary run-and-gun with co-op action, humor, and explosive pixel art.',
      rating: 4.8,
      playersOnline: 7200,
      availability: 'Online',
      ...
      badgeIds: ['classic', 'featured'],
      launchConfig: {
        approvedEmbedUrl: 'https://www.retrogames.cc/embed/14871-metal-slug-2.html',
        embedMode: 'external-only',
        secure_mode: 'wasm',
    ...
    },
    {
      ...
      url: 'https://www.retrogames.cc/embed/19413-the-king-of-fighters-98-the-slugfest.html',
      genre: 'Fighting',
      description: 'The Dream Match - every KOF character in one legendary fighting game.',
      rating: 4.8,
      playersOnline: 8400,
      availability: 'Online',
      tags: ['Fighting', 'Arcade', 'Neo Geo', 'Classic'],
      badgeIds: ['classic', 'featured'],
      launchConfig: {
        approvedEmbedUrl: 'https://www.retrogames.cc/embed/19413-the-king-of-fighters-98-the-slugfest.html',
        embedMode: 'external-only',
        secure_mode: 'wasm',
        approvedExternalUrl: 'https://www.retrogames.cc/embed/19413-the-king-of-fighters-98-the-slugfest.html',
      },
      art: {
    ...
    },
    {
      ...
      url: 'https://www.retrogames.cc/embed/19432-samurai-shodown-ii.html',
      genre: 'Fighting',
      description: 'Weapons-based feudal Japan fighting at its absolute finest.',
      rating: 4.7,
      playersOnline: 4600,
      availability: 'Online',
      ...
      badgeIds: ['classic'],
      launchConfig: {
        approvedEmbedUrl: 'https://www.retrogames.cc/embed/19432-samurai-shodown-ii.html',
        embedMode: 'external-only',
        secure_mode: 'wasm',
    ...
    },
    {
      ...
      name: 'Puzzle Bobble',
      url: 'https://www.retrogames.cc/embed/19423-puzzle-bobble.html',
      genre: 'Puzzle',
      description: 'Bub and Bob\'s bubble-matching puzzle classic. Deceptively addictive.',
      rating: 4.5,
      playersOnline: 3800,
      availability: 'Online',
      ...
      badgeIds: ['classic'],
      launchConfig: {
        approvedEmbedUrl: 'https://www.retrogames.cc/embed/19423-puzzle-bobble.html',
        embedMode: 'external-only',
        secure_mode: 'wasm',
    ...
    },
    {
      ...
      name: 'R-Type',
      url: 'https://www.retrogames.cc/embed/14894-r-type.html',
      genre: 'Shooter',
      description: 'Bydo Empire threatens humanity in this pioneering side-scrolling space shooter.',
      rating: 4.6,
      playersOnline: 3200,
      availability: 'Online',
      ...
      badgeIds: ['classic'],
      launchConfig: {
        approvedEmbedUrl: 'https://www.retrogames.cc/embed/14894-r-type.html',
        embedMode: 'external-only',
        secure_mode: 'wasm',
    ...
    },
    {
      ...
      name: 'Gradius',
      url: 'https://www.retrogames.cc/embed/14861-gradius.html',
      genre: 'Shooter',
      description: 'Konami\'s Vic Viper fights the Bacterion Empire in the definitive side-scroll shooter.',
      rating: 4.5,
      playersOnline: 2800,
      availability: 'Online',
      ...
      badgeIds: ['classic'],
      launchConfig: {
        approvedEmbedUrl: 'https://www.retrogames.cc/embed/14861-gradius.html',
        embedMode: 'external-only',
        secure_mode: 'wasm',
    ...
    },
    {
      ...
      url: 'https://www.retrogames.cc/embed/19405-fatal-fury-special.html',
      genre: 'Fighting',
      description: 'Terry Bogard\'s enhanced Fatal Fury with guest fighters from Art of Fighting.',
      rating: 4.5,
      playersOnline: 3400,
      availability: 'Online',
      ...
      badgeIds: ['classic'],
      launchConfig: {
        approvedEmbedUrl: 'https://www.retrogames.cc/embed/19405-fatal-fury-special.html',
        embedMode: 'external-only',
        secure_mode: 'wasm',
    ...
    },
    {
      ...
      name: 'Blazing Star',
      url: 'https://www.retrogames.cc/embed/19397-blazing-star.html',
      genre: 'Shooter',
      description: 'Neo Geo\'s stunning horizontal shmup with flashy scoring mechanics.',
      rating: 4.6,
      playersOnline: 2400,
      availability: 'Online',
      ...
      badgeIds: ['classic'],
      launchConfig: {
        approvedEmbedUrl: 'https://www.retrogames.cc/embed/19397-blazing-star.html',
        embedMode: 'external-only',
        secure_mode: 'wasm',
    ...
    },
    {
      ...
      url: 'https://www.retrogames.cc/embed/19409-garou-mark-of-the-wolves.html',
      genre: 'Fighting',
      description: 'The most beautiful 2D fighter ever made. Rock Howard carries Terry\'s legacy.',
      rating: 4.8,
      playersOnline: 5200,
      availability: 'Online',
      tags: ['Fighting', 'Arcade', 'Neo Geo', 'SNK', 'Elite'],
      badgeIds: ['classic', 'elite', 'featured'],
      launchConfig: {
        approvedEmbedUrl: 'https://www.retrogames.cc/embed/19409-garou-mark-of-the-wolves.html',
        embedMode: 'external-only',
        secure_mode: 'wasm',
        approvedExternalUrl: 'https://www.retrogames.cc/embed/19409-garou-mark-of-the-wolves.html',
      },
      art: {
        eyebrow: 'Neo Geo Masterpiece',
        accentStart: '#6633cc',
        accentEnd: '#1a0033',
      },
    ...
    },
    {
      ...
      name: 'Windjammers',
      url: 'https://www.retrogames.cc/embed/19453-windjammers.html',
      genre: 'Sports',
      description: 'Frisbee-meets-tennis on Neo Geo. The ultimate competitive party game.',
      rating: 4.6,
      playersOnline: 3600,
      availability: 'Online',
      ...
      badgeIds: ['classic', 'featured'],
      launchConfig: {
        approvedEmbedUrl: 'https://www.retrogames.cc/embed/19453-windjammers.html',
        embedMode: 'external-only',
        secure_mode: 'wasm',
    ...
    },
    {
      ...
      url: 'https://www.retrogames.cc/embed/40208-crash-bandicoot-2-cortex-strikes-back.html',
      genre: 'Platformer',
      description: 'Crash returns in the definitive PS1 platformer. Spin, slide, jump through warp rooms.',
      rating: 4.7,
      playersOnline: 7400,
      availability: 'Online',
      ...
      badgeIds: ['classic', 'elite'],
      launchConfig: {
        approvedEmbedUrl: 'https://www.retrogames.cc/embed/40208-crash-bandicoot-2-cortex-strikes-back.html',
        embedMode: 'external-only',
        secure_mode: 'wasm',
    ...
    },
    {
      ...
      url: 'https://www.retrogames.cc/embed/21026-mega-man-legends-ps1.html',
      genre: 'Action RPG',
      description: 'Mega Man explores ruins in this charming 3D action RPG departure.',
      rating: 4.5,
      playersOnline: 2800,
      availability: 'Online',
      tags: ['Action RPG', 'PS1', 'Mega Man', '3D'],
      badgeIds: ['classic'],
      launchConfig: {
        approvedEmbedUrl: 'https://www.retrogames.cc/embed/21026-mega-man-legends-ps1.html',
        embedMode: 'inline',
        secure_mode: 'wasm',
        approvedExternalUrl: 'https://www.retrogames.cc/embed/42625-mega-man-legends.html',
      },
      art: {
        eyebrow: 'PS1 Action RPG',
        accentStart: '#0066cc',
        accentEnd: '#003366',
      },
    ...
    },
    {
      ...
      name: 'Tomb Raider II',
      url: 'https://www.retrogames.cc/embed/42647-tomb-raider-ii.html',
      genre: 'Adventure',
      description: 'Lara Croft hunts the Dagger of Xian across Venice, Tibet, and beyond.',
      rating: 4.6,
      playersOnline: 5400,
      availability: 'Online',
      tags: ['Adventure', 'PS1', 'Tomb Raider', '3D'],
      badgeIds: ['classic', 'elite'],
      launchConfig: {
        approvedEmbedUrl: 'https://www.retrogames.cc/embed/42647-tomb-raider-ii.html',
        embedMode: 'external-only',
        secure_mode: 'wasm',
        approvedExternalUrl: 'https://www.retrogames.cc/embed/42647-tomb-raider-ii.html',
      },
      art: {
        eyebrow: 'PS1 Adventure',
        accentStart: '#0099cc',
        accentEnd: '#003344',
      },
    ...
    },
    {
      ...
      name: 'Syphon Filter',
      url: 'https://www.retrogames.cc/embed/42644-syphon-filter.html',
      genre: 'Stealth',
      description: 'Gabe Logan\'s explosive espionage thriller. Stealth meets action in this PS1 gem.',
      rating: 4.5,
      playersOnline: 3000,
      availability: 'Online',
      tags: ['Stealth', 'PS1', 'Action', 'Espionage'],
      badgeIds: ['classic'],
      launchConfig: {
        approvedEmbedUrl: 'https://www.retrogames.cc/embed/42644-syphon-filter.html',
        embedMode: 'external-only',
        secure_mode: 'wasm',
        approvedExternalUrl: 'https://www.retrogames.cc/embed/42644-syphon-filter.html',
      },
      art: {
        eyebrow: 'PS1 Stealth',
        accentStart: '#333333',
    ...
    },
    {
      ...
      name: 'Jet Moto',
      url: 'https://www.retrogames.cc/embed/42620-jet-moto.html',
      genre: 'Racing',
      description: 'Hoverbike racing across water, ice, and lava. High-octane PS1 anti-grav racing.',
      rating: 4.3,
      playersOnline: 2000,
      availability: 'Online',
      tags: ['Racing', 'PS1', 'Anti-Gravity', 'Futuristic'],
      badgeIds: ['classic'],
      launchConfig: {
        approvedEmbedUrl: 'https://www.retrogames.cc/embed/42620-jet-moto.html',
        embedMode: 'external-only',
        secure_mode: 'wasm',
        approvedExternalUrl: 'https://www.retrogames.cc/embed/42620-jet-moto.html',
      },
      art: {
        eyebrow: 'PS1 Racing',
        accentStart: '#00ccff',
    ...
    },
    {
      ...
      name: 'Pokémon Red',
      url: 'https://www.retrogames.cc/embed/20025-pokemon-red-version-usa.html',
      genre: 'RPG',
      description: 'Where it all began. Choose your starter and become Pokemon Champion.',
      rating: 4.8,
      playersOnline: 22000,
      availability: 'Online',
      tags: ['RPG', 'Game Boy', 'Pokemon', 'Classic', 'JRPG'],
      badgeIds: ['classic', 'featured'],
      launchConfig: {
        approvedEmbedUrl: 'https://www.retrogames.cc/embed/20025-pokemon-red-version-usa.html',
        embedMode: 'external-only',
        secure_mode: 'wasm',
        approvedExternalUrl: 'https://www.retrogames.cc/embed/20025-pokemon-red-version-usa.html',
      },
      art: {
        eyebrow: 'Pokemon Origin',
        accentStart: '#cc0000',
        accentEnd: '#660000',
      },
    ...
    },
    {
      ...
      url: 'https://www.retrogames.cc/embed/20058-the-legend-of-zelda-links-awakening-dx-usa.html',
      genre: 'Adventure',
      description: 'Link washes ashore Koholint Island in this magical GBC adventure.',
      rating: 4.8,
      playersOnline: 8400,
      availability: 'Online',
      tags: ['Adventure', 'Game Boy Color', 'Zelda', 'Classic'],
      badgeIds: ['classic', 'featured'],
      launchConfig: {
        approvedEmbedUrl: 'https://www.retrogames.cc/embed/20058-the-legend-of-zelda-links-awakening-dx-usa.html',
        embedMode: 'inline',
        secure_mode: 'wasm',
        approvedExternalUrl: 'https://www.retrogames.cc/embed/20058-the-legend-of-zelda-links-awakening-dx-usa.html',
      },
      art: {
        eyebrow: 'GBC Classic',
        accentStart: '#009900',
    ...
    },
    {
      ...
      url: 'https://www.retrogames.cc/embed/20205-wario-land-super-mario-land-3-gb.html',
      genre: 'Platformer',
      description: 'Wario\'s first solo adventure - a treasure-hunting platformer.',
      rating: 4.5,
      playersOnline: 3200,
      availability: 'Online',
      tags: ['Platformer', 'Game Boy', 'Wario', 'Classic'],
      badgeIds: ['classic'],
      launchConfig: {
        approvedEmbedUrl: 'https://www.retrogames.cc/embed/20205-wario-land-super-mario-land-3-gb.html',
        embedMode: 'inline',
        secure_mode: 'wasm',
        approvedExternalUrl: 'https://www.retrogames.cc/embed/20049-wario-land-super-mario-land-3-usa.html',
      },
      art: {
        eyebrow: 'GB Classic',
        accentStart: '#ffcc00',
    ...
    },
    {
      ...
      url: 'https://www.retrogames.cc/embed/20192-kirbys-dream-land-gb.html',
      genre: 'Platformer',
      description: 'The puffball\'s debut. Kirby inhales enemies to defeat King Dedede.',
      rating: 4.4,
      playersOnline: 4800,
      availability: 'Online',
      ...
      badgeIds: ['classic'],
      launchConfig: {
        approvedEmbedUrl: 'https://www.retrogames.cc/embed/20192-kirbys-dream-land-gb.html',
        embedMode: 'inline',
        secure_mode: 'wasm',
    ...
    },
    {
      ...
      url: 'https://www.retrogames.cc/embed/20196-tetris-gb.html',
      genre: 'Puzzle',
      description: 'THE Game Boy game. The version that made Tetris a worldwide phenomenon.',
      rating: 4.9,
      playersOnline: 25000,
      availability: 'Online',
      tags: ['Puzzle', 'Game Boy', 'Tetris', 'Classic', 'Addictive'],
      badgeIds: ['classic', 'featured'],
      launchConfig: {
        approvedEmbedUrl: 'https://www.retrogames.cc/embed/20196-tetris-gb.html',
        embedMode: 'inline',
        secure_mode: 'wasm',
        approvedExternalUrl: 'https://www.retrogames.cc/embed/20041-tetris-usa.html',
      },
      art: {
        eyebrow: 'GB Legend',
        accentStart: '#333333',
    ...
    },
    {
      ...
      url: 'https://www.retrogames.cc/embed/20030-pokemon-trading-card-game-usa.html',
      genre: 'Card Game',
      description: 'Build decks and battle Gym Leaders with Pokemon cards in this GBC gem.',
      rating: 4.5,
      playersOnline: 3600,
      availability: 'Online',
      tags: ['Card Game', 'Game Boy Color', 'Pokemon', 'Strategy'],
      badgeIds: ['classic'],
      launchConfig: {
        approvedEmbedUrl: 'https://www.retrogames.cc/embed/20030-pokemon-trading-card-game-usa.html',
        embedMode: 'external-only',
        secure_mode: 'wasm',
        approvedExternalUrl: 'https://www.retrogames.cc/embed/20030-pokemon-trading-card-game-usa.html',
      },
      art: {
        eyebrow: 'GBC Card Game',
        accentStart: '#ffcc00',
        accentEnd: '#ff6600',
      },
    ...
    },
    {
      ...
      url: 'https://www.retrogames.cc/embed/10033-bonks-adventure.html',
      genre: 'Platformer',
      description: 'The TurboGrafx mascot - a head-bonking caveboy in a prehistoric platformer.',
      rating: 4.4,
      playersOnline: 2200,
      availability: 'Online',
      ...
      badgeIds: ['classic'],
      launchConfig: {
        approvedEmbedUrl: 'https://www.retrogames.cc/embed/10033-bonks-adventure.html',
        embedMode: 'external-only',
        secure_mode: 'wasm',
    ...
    },
    {
      ...
      name: 'Blazing Lazers',
      url: 'https://www.retrogames.cc/embed/10034-blazing-lazers.html',
      genre: 'Shooter',
      description: 'TurboGrafx premier vertical shooter. Non-stop firepower and spectacular bosses.',
      rating: 4.5,
      playersOnline: 1800,
      availability: 'Online',
      tags: ['Shooter', 'TurboGrafx', 'Shmup', 'Classic'],
      badgeIds: ['classic'],
      launchConfig: {
        approvedEmbedUrl: 'https://www.retrogames.cc/embed/10034-blazing-lazers.html',
        embedMode: 'external-only',
        secure_mode: 'wasm',
        approvedExternalUrl: 'https://www.retrogames.cc/embed/10034-blazing-lazers.html',
      },
      art: {
        eyebrow: 'TurboGrafx Shooter',
        accentStart: '#ff0066',
        accentEnd: '#990033',
      },
    ...
    },
    {
      ...
      name: 'Splatterhouse',
      url: 'https://www.retrogames.cc/embed/10060-splatterhouse.html',
      genre: 'Horror',
      description: 'Rick dons the Terror Mask to fight through a mansion of nightmares.',
      rating: 4.4,
      playersOnline: 2600,
      availability: 'Online',
      ...
      badgeIds: ['classic'],
      launchConfig: {
        approvedEmbedUrl: 'https://www.retrogames.cc/embed/10060-splatterhouse.html',
        embedMode: 'external-only',
        secure_mode: 'wasm',
    ...
    },
    {
      ...
      name: 'Soldier Blade',
      url: 'https://www.retrogames.cc/embed/10059-soldier-blade.html',
      genre: 'Shooter',
      description: 'Pinnacle of the Soldier series. Top-down TurboGrafx space shooter masterpiece.',
      rating: 4.6,
      playersOnline: 1600,
      availability: 'Online',
      tags: ['Shooter', 'TurboGrafx', 'Space', 'Shmup'],
      badgeIds: ['classic'],
      launchConfig: {
        approvedEmbedUrl: 'https://www.retrogames.cc/embed/10059-soldier-blade.html',
        embedMode: 'external-only',
        secure_mode: 'wasm',
        approvedExternalUrl: 'https://www.retrogames.cc/embed/10059-soldier-blade.html',
      },
      art: {
        eyebrow: 'TurboGrafx Elite',
        accentStart: '#0099ff',
        accentEnd: '#003366',
      },
    ...
    },
    {
      ...
      url: 'https://www.retrogames.cc/embed/10048-lords-of-thunder.html',
      genre: 'Shooter',
      description: 'Heavy metal side-scrolling shooter with selectable armor and epic bosses.',
      rating: 4.7,
      playersOnline: 2000,
      availability: 'Online',
      tags: ['Shooter', 'TurboGrafx', 'Heavy Metal', 'Shmup'],
      badgeIds: ['classic', 'featured'],
      launchConfig: {
        approvedEmbedUrl: 'https://www.retrogames.cc/embed/10048-lords-of-thunder.html',
        embedMode: 'external-only',
        secure_mode: 'wasm',
        approvedExternalUrl: 'https://www.retrogames.cc/embed/10048-lords-of-thunder.html',
      },
      art: {
        eyebrow: 'TurboGrafx Metal',
        accentStart: '#cc0000',
        accentEnd: '#660000',
      },
    ...
    },
    {
      ...
      name: 'Ninja Gaiden',
      url: 'https://www.retrogames.cc/embed/17950-ninja-gaiden-usa.html',
      genre: 'Action',
      description: 'Ryu Hayabusa\'s legendary NES action trilogy begins here.',
      rating: 4.6,
      playersOnline: 3800,
      availability: 'Online',
      ...
      badgeIds: ['classic'],
      launchConfig: {
        approvedEmbedUrl: 'https://www.retrogames.cc/embed/17950-ninja-gaiden-usa.html',
        embedMode: 'external-only',
        secure_mode: 'wasm',
    ...
    },
    {
      ...
      name: 'Battletoads',
      url: 'https://www.retrogames.cc/embed/17868-battletoads-usa.html',
      genre: 'Beat \'em up',
      description: 'The infamous NES difficulty king. Turbo tunnel nightmare.',
      rating: 4.5,
      playersOnline: 4200,
      availability: 'Online',
      ...
      badgeIds: ['classic'],
      launchConfig: {
        approvedEmbedUrl: 'https://www.retrogames.cc/embed/17868-battletoads-usa.html',
        embedMode: 'external-only',
        secure_mode: 'wasm',
    ...
    },
    {
      ...
      name: 'Punch-Out!!',
      url: 'https://www.retrogames.cc/embed/17960-punch-out-usa.html',
      genre: 'Sports',
      description: 'The re-released NES boxing classic (without Mike Tyson). Battle through the World Circuit, from Glass Joe to Mr. Dream, in this legendary Nintendo title.',
      rating: 4.8,
      playersOnline: 6200,
      availability: 'Online',
      ...
      badgeIds: ['classic', 'featured'],
      launchConfig: {
        approvedEmbedUrl: 'https://www.retrogames.cc/embed/17960-punch-out-usa.html',
        embedMode: 'external-only',
        secure_mode: 'wasm',
    ...
    },
    {
      ...
      url: 'https://www.retrogames.cc/embed/17967-river-city-ransom-usa.html',
      genre: 'Beat \'em up',
      description: 'Open-world beat-em-up RPG on the NES. Eat pizza, learn moves, rescue Cyndi.',
      rating: 4.6,
      playersOnline: 2800,
      availability: 'Online',
      ...
      badgeIds: ['classic'],
      launchConfig: {
        approvedEmbedUrl: 'https://www.retrogames.cc/embed/17967-river-city-ransom-usa.html',
        embedMode: 'external-only',
        secure_mode: 'wasm',
    ...
    },
    {
      ...
      name: 'Kid Icarus',
      url: 'https://www.retrogames.cc/embed/17929-kid-icarus-usa.html',
      genre: 'Action',
      description: 'Pit flies through the underworld to defeat Medusa in this Nintendo cult classic.',
      rating: 4.4,
      playersOnline: 2400,
      availability: 'Online',
      ...
      badgeIds: ['classic'],
      launchConfig: {
        approvedEmbedUrl: 'https://www.retrogames.cc/embed/17929-kid-icarus-usa.html',
        embedMode: 'external-only',
        secure_mode: 'wasm',
    ...
    },
    {
      ...
      name: 'Blaster Master',
      url: 'https://www.retrogames.cc/embed/17870-blaster-master-usa.html',
      genre: 'Action',
      description: 'Ride the SOPHIA tank through underground caverns in this NES action-adventure.',
      rating: 4.4,
      playersOnline: 1800,
      availability: 'Online',
      ...
      badgeIds: ['classic'],
      launchConfig: {
        approvedEmbedUrl: 'https://www.retrogames.cc/embed/17870-blaster-master-usa.html',
        embedMode: 'external-only',
        secure_mode: 'wasm',
    ...
    },
    {
      ...
      name: 'Ice Hockey',
      url: 'https://www.retrogames.cc/embed/17924-ice-hockey-usa.html',
      genre: 'Sports',
      description: 'Nintendo\'s classic 4v4 hockey. Choose fat, normal, or skinny players.',
      rating: 4.3,
      playersOnline: 2000,
      availability: 'Online',
      ...
      badgeIds: ['classic'],
      launchConfig: {
        approvedEmbedUrl: 'https://www.retrogames.cc/embed/17924-ice-hockey-usa.html',
        embedMode: 'external-only',
        secure_mode: 'wasm',
    ...
    },
    {
      ...
      url: 'https://www.retrogames.cc/embed/11001-alex-kidd-in-miracle-world.html',
      genre: 'Platformer',
      description: 'Sega\'s original mascot platformer before Sonic.',
      rating: 4.3,
      playersOnline: 1600,
      availability: 'Online',
      tags: ['Platformer', 'Master System', 'Sega', 'Classic', 'Mascot'],
      badgeIds: ['classic'],
      launchConfig: {
        approvedEmbedUrl: 'https://www.retrogames.cc/embed/11001-alex-kidd-in-miracle-world.html',
        embedMode: 'external-only',
        secure_mode: 'wasm',
        approvedExternalUrl: 'https://www.retrogames.cc/embed/11001-alex-kidd-in-miracle-world.html',
      },
      art: {
    ...
    },
    {
      ...
      name: 'Wonder Boy',
      url: 'https://www.retrogames.cc/embed/11019-wonder-boy.html',
      genre: 'Platformer',
      description: 'The arcade-to-console classic platformer. Run, throw axes, ride skateboards.',
      rating: 4.2,
      playersOnline: 1200,
      availability: 'Online',
      tags: ['Platformer', 'Master System', 'Sega', 'Classic', 'Arcade'],
      badgeIds: ['classic'],
      launchConfig: {
        approvedEmbedUrl: 'https://www.retrogames.cc/embed/11019-wonder-boy.html',
        embedMode: 'external-only',
        secure_mode: 'wasm',
        approvedExternalUrl: 'https://www.retrogames.cc/embed/11019-wonder-boy.html',
      },
      art: {
        eyebrow: 'Master System',
        accentStart: '#ffcc00',
    ...
    },
    {
      ...
      name: 'Phantasy Star (Master System)',
      url: 'https://www.retrogames.cc/embed/11013-phantasy-star.html',
      genre: 'RPG',
      description: 'Sega\'s groundbreaking sci-fi RPG. First console RPG with 3D dungeons.',
      rating: 4.6,
      playersOnline: 2200,
      availability: 'Online',
      tags: ['RPG', 'Master System', 'Sega', 'Sci-Fi', 'Classic'],
      badgeIds: ['classic', 'elite'],
      launchConfig: {
        approvedEmbedUrl: 'https://www.retrogames.cc/embed/11013-phantasy-star.html',
        embedMode: 'external-only',
        secure_mode: 'wasm',
        approvedExternalUrl: 'https://www.retrogames.cc/embed/11013-phantasy-star.html',
      },
      art: {
        eyebrow: 'SMS RPG',
        accentStart: '#0099cc',
    ...
    },
    {
      ...
      url: 'https://www.retrogames.cc/embed/30104-virtua-fighter-2.html',
      genre: 'Fighting',
      description: 'Sega\'s 3D polygon fighting masterpiece running at 60fps on Saturn.',
      rating: 4.7,
      playersOnline: 3400,
      availability: 'Online',
      ...
      badgeIds: ['classic', 'elite'],
      launchConfig: {
        approvedEmbedUrl: 'https://www.retrogames.cc/embed/30104-virtua-fighter-2.html',
        embedMode: 'external-only',
        secure_mode: 'wasm',
    ...
    },
    {
      ...
      name: 'Daytona USA',
      url: 'https://www.retrogames.cc/embed/30007-daytona-usa.html',
      genre: 'Racing',
      description: 'SEGA! DAYTONAAA! The arcade racing king with unforgettable announcer lines.',
      rating: 4.6,
      playersOnline: 4200,
      availability: 'Online',
      ...
      badgeIds: ['classic', 'featured'],
      launchConfig: {
        approvedEmbedUrl: 'https://www.retrogames.cc/embed/30007-daytona-usa.html',
        embedMode: 'external-only',
        secure_mode: 'wasm',
    ...
    },
    {
      ...
      url: 'https://www.retrogames.cc/embed/30021-panzer-dragoon-saga.html',
      genre: 'RPG',
      description: 'Saturn\'s crown jewel RPG. Ride dragons in a post-apocalyptic desert world.',
      rating: 4.8,
      playersOnline: 2800,
      availability: 'Online',
      tags: ['RPG', 'Saturn', 'Sega', 'JRPG', 'Dragons'],
      badgeIds: ['classic', 'elite', 'featured'],
      launchConfig: {
        approvedEmbedUrl: 'https://www.retrogames.cc/embed/30021-panzer-dragoon-saga.html',
        embedMode: 'external-only',
        secure_mode: 'wasm',
        approvedExternalUrl: 'https://www.retrogames.cc/embed/30021-panzer-dragoon-saga.html',
      },
      art: {
        eyebrow: 'Saturn RPG',
        accentStart: '#9966cc',
    ...
    },
    {
      ...
      url: 'https://www.retrogames.cc/embed/30027-sega-rally-championship.html',
      genre: 'Racing',
      description: 'The rally racing classic. Surface matters - asphalt, dirt, gravel feel different.',
      rating: 4.5,
      playersOnline: 2600,
      availability: 'Online',
      ...
      badgeIds: ['classic'],
      launchConfig: {
        approvedEmbedUrl: 'https://www.retrogames.cc/embed/30027-sega-rally-championship.html',
        embedMode: 'external-only',
        secure_mode: 'wasm',
    ...
    },
    {
      ...
      url: 'https://www.retrogames.cc/embed/30019-nights-into-dreams.html',
      genre: 'Action',
      description: 'Sonic Team\'s surreal flying dream adventure. Soar through dream worlds.',
      rating: 4.7,
      playersOnline: 2400,
      availability: 'Online',
      tags: ['Action', 'Saturn', 'Sega', 'Flying', 'Dream'],
      badgeIds: ['classic', 'featured'],
      launchConfig: {
        approvedEmbedUrl: 'https://www.retrogames.cc/embed/30019-nights-into-dreams.html',
        embedMode: 'external-only',
        secure_mode: 'wasm',
        approvedExternalUrl: 'https://www.retrogames.cc/embed/30019-nights-into-dreams.html',
      },
      art: {
        eyebrow: 'Saturn Dream',
        accentStart: '#ff66cc',
        accentEnd: '#cc3399',
      },
    ...
    {
      id: 'moto-x3m-elite', name: 'Moto X3M',
      url: 'https://games.crazygames.com/en_US/moto-x3m/index.html', genre: 'Racing',
      description: 'High-speed motocross stunt racer with 22 obstacle-filled levels, flips, and time trials.',
      rating: 4.6, playersOnline: 7200, availability: 'Online',
      tags: ['Racing', 'Stunt', 'Arcade', 'Web', 'Physics'], badgeIds: ['trending'],
      launchConfig: { approvedEmbedUrl: 'https://games.crazygames.com/en_US/moto-x3m/index.html', embedMode: 'inline', secure_mode: 'wasm', approvedExternalUrl: 'https://www.crazygames.com/game/moto-x3m' },
      art: { eyebrow: 'Stunt Racing', accentStart: '#ff6b35', accentEnd: '#ff2e63' },
      image: '/assets/games/moto-x3m-elite.svg',
    },
    {
      id: 'basketball-stars-elite', name: 'Basketball Stars',
      url: 'https://games.crazygames.com/en_US/basketball-stars/index.html', genre: 'Sports',
      description: '2-player basketball showdown with special moves, alley-oops, and real-time matchmaking.',
      rating: 4.5, playersOnline: 5500, availability: 'Online',
      tags: ['Sports', 'Basketball', 'Multiplayer', 'Web', '2 Player'], badgeIds: ['trending'],
      launchConfig: { approvedEmbedUrl: 'https://games.crazygames.com/en_US/basketball-stars/index.html', embedMode: 'inline', secure_mode: 'wasm', approvedExternalUrl: 'https://www.crazygames.com/game/basketball-stars' },
      art: { eyebrow: '2P Sports', accentStart: '#ff8c00', accentEnd: '#ff4500' },
      image: '/assets/games/basketball-stars-elite.svg',
    },
    {
      id: 'awesome-tanks-2-elite', name: 'Awesome Tanks 2',
      url: 'https://games.crazygames.com/en_US/awesome-tanks-2/index.html', genre: 'Action',
      description: 'Top-down tank shooter with upgradeable weapons, 30+ levels, and destructible environments.',
      rating: 4.5, playersOnline: 4100, availability: 'Online',
      tags: ['Action', 'Tank', 'Shooter', 'Arcade', 'Web'], badgeIds: ['trending'],
      launchConfig: { approvedEmbedUrl: 'https://games.crazygames.com/en_US/awesome-tanks-2/index.html', embedMode: 'inline', secure_mode: 'wasm', approvedExternalUrl: 'https://www.crazygames.com/game/awesome-tanks-2' },
      art: { eyebrow: 'Tank Shooter', accentStart: '#228b22', accentEnd: '#006400' },
      image: '/assets/games/awesome-tanks-2-elite.svg',
    },
    {
      id: 'slope-elite', name: 'Slope',
      url: 'https://games.crazygames.com/en_US/slope/index.html', genre: 'Arcade',
      description: 'Endless downhill neon ball runner. Dodge obstacles at increasing speed in this 3D reflex challenge.',
      rating: 4.4, playersOnline: 9800, availability: 'Online',
      tags: ['Arcade', 'Reflex', '3D', 'Endless', 'Web'], badgeIds: ['trending'],
      launchConfig: { approvedEmbedUrl: 'https://games.crazygames.com/en_US/slope/index.html', embedMode: 'inline', secure_mode: 'wasm', approvedExternalUrl: 'https://www.crazygames.com/game/slope' },
      art: { eyebrow: 'Endless Runner', accentStart: '#00ffff', accentEnd: '#0000ff' },
      image: '/assets/games/slope-elite.svg',
    },
    {
      id: 'tunnel-rush-elite', name: 'Tunnel Rush',
      url: 'https://games.crazygames.com/en_US/tunnel-rush/index.html', genre: 'Arcade',
      description: 'Blazing neon corridor runner. Swerve through walls of color at impossible speeds.',
      rating: 4.3, playersOnline: 8500, availability: 'Online',
      tags: ['Arcade', 'Reflex', '3D', 'Web', 'Endless'], badgeIds: ['trending'],
      launchConfig: { approvedEmbedUrl: 'https://games.crazygames.com/en_US/tunnel-rush/index.html', embedMode: 'inline', secure_mode: 'wasm', approvedExternalUrl: 'https://www.crazygames.com/game/tunnel-rush' },
      art: { eyebrow: 'Neon Runner', accentStart: '#ff00ff', accentEnd: '#800080' },
      image: '/assets/games/tunnel-rush-elite.svg',
    },
    {
      id: 'drift-hunters-elite', name: 'Drift Hunters',
      url: 'https://games.crazygames.com/en_US/drift-hunters/index.html', genre: 'Racing',
      description: 'Master the art of drifting with 26 tuner cars, engine swaps, and suspension tuning in 3D.',
      rating: 4.7, playersOnline: 8200, availability: 'Online',
      tags: ['Racing', 'Drift', '3D', 'Web', 'Simulation'], badgeIds: ['trending'],
      launchConfig: { approvedEmbedUrl: 'https://games.crazygames.com/en_US/drift-hunters/index.html', embedMode: 'inline', secure_mode: 'wasm', approvedExternalUrl: 'https://www.crazygames.com/game/drift-hunters' },
      art: { eyebrow: 'Drift Sim', accentStart: '#ff4500', accentEnd: '#8b0000' },
      image: '/assets/games/drift-hunters-elite.svg',
    },
    {
      id: 'stickman-fight-elite', name: 'Stickman Fighter',
      url: 'https://games.crazygames.com/en_US/stickman-fighter-epic-battle/index.html', genre: 'Fighting',
      description: 'Fast-paced stickman brawler with epic combos and ragdoll physics. Multiple arenas and characters.',
      rating: 4.4, playersOnline: 6400, availability: 'Online',
      tags: ['Fighting', 'Stickman', 'Arcade', 'Web'], badgeIds: ['trending'],
      launchConfig: { approvedEmbedUrl: 'https://games.crazygames.com/en_US/stickman-fighter-epic-battle/index.html', embedMode: 'inline', secure_mode: 'wasm', approvedExternalUrl: 'https://www.crazygames.com/game/stickman-fighter-epic-battle' },
      art: { eyebrow: 'Stickman Brawler', accentStart: '#ff6600', accentEnd: '#ff0000' },
      image: '/assets/games/stickman-fight-elite.svg',
    },
    {
      id: 'bullet-force-elite', name: 'Bullet Force',
      url: 'https://games.crazygames.com/en_US/bullet-force/index.html', genre: 'Action',
      description: 'Console-quality multiplayer FPS with 20+ weapons, killstreaks, and squad-based team deathmatch.',
      rating: 4.5, playersOnline: 6200, availability: 'Online',
      tags: ['FPS', 'Multiplayer', 'Shooter', '3D', 'Web'], badgeIds: ['trending', 'featured'],
      launchConfig: { approvedEmbedUrl: 'https://games.crazygames.com/en_US/bullet-force/index.html', embedMode: 'inline', secure_mode: 'wasm', approvedExternalUrl: 'https://www.crazygames.com/game/bullet-force' },
      art: { eyebrow: 'Tactical FPS', accentStart: '#ff5500', accentEnd: '#990000' },
      image: '/assets/games/bullet-force-elite.svg',
    },
    {
      id: 'stickman-hook-elite', name: 'Stickman Hook',
      url: 'https://games.crazygames.com/en_US/stickman-hook/index.html', genre: 'Arcade',
      description: 'Swing through levels with grappling hook physics. Perform flips and reach the finish line faster.',
      rating: 4.3, playersOnline: 5600, availability: 'Online',
      tags: ['Arcade', 'Physics', 'Stickman', 'Web', 'Platformer'], badgeIds: ['trending'],
      launchConfig: { approvedEmbedUrl: 'https://games.crazygames.com/en_US/stickman-hook/index.html', embedMode: 'inline', secure_mode: 'wasm', approvedExternalUrl: 'https://www.crazygames.com/game/stickman-hook' },
      art: { eyebrow: 'Grappling Fun', accentStart: '#ff3399', accentEnd: '#cc0066' },
      image: '/assets/games/stickman-hook-elite.svg',
    },
    {
      id: 'shell-shockers-elite', name: 'Shell Shockers',
      url: 'https://shellshock.io/game/0.52.4/index.html', genre: 'Action',
      description: 'Egg-based multiplayer FPS. Crack your opponents in this egg-citing shooter with multiple classes.',
      rating: 4.6, playersOnline: 12500, availability: 'Online',
      tags: ['FPS', 'Multiplayer', 'Shooter', 'Web', '3D'], badgeIds: ['trending', 'featured'],
      launchConfig: { approvedEmbedUrl: 'https://shellshock.io/game/0.52.4/index.html', embedMode: 'inline', secure_mode: 'wasm', approvedExternalUrl: 'https://shellshock.io' },
      art: { eyebrow: 'Egg FPS', accentStart: '#ffcc00', accentEnd: '#ff6600' },
      image: '/assets/games/shell-shockers-elite.svg',
    },
  ],
  recommendationRails: [
    {
      ...
      roomIds: ['neo-zone'],
      gameIds: ['the-punisher-elite-master', 'mario-golf-elite-master', 'mario-tennis-elite-master', 'marvel-super-heroes-elite-master', 'twisted-metal-2-elite-master', 'dino-crisis-elite-master', 'medievil-elite-master', 'the-lion-king-elite-master', 'star-fox-elite-master', 'crash-bandicoot-elite-master', 'spyro-the-dragon-elite-master', 'castlevania-iv-elite-master', 'tekken8-tribute-elite', 'mega-man-x3-elite-master', 'doom-ii-elite-master', 'metal-slug-3-elite-master', 'umk3-elite-master', 'zelda-alttp-elite-master', 'megaman-x-elite-master', 'tekken-tag-tournament-elite-master', 'slow-roads-webgl', 'venge-io-webgl', 'final-fantasy-ix-elite-master', 'pokemon-emerald-elite-master'],
      maxItems: 6,
    },
    {
      id: 'rail-golden-era',
      ...
      gameIds: ['street-fighter-alpha-3-elite-master', 'darkstalkers-elite-master', 'cadillacs-and-dinosaurs-elite-master', 'splinter-cell-elite-master', 'captain-commando-elite-master', 'the-punisher-elite-master', 'halo-2-elite-elite-master', 'pokemon-stadium-2-elite-master', 'tony-hawk-2-master-elite-master', 'spider-man-ps1-elite-master', 'x-men-vs-street-fighter-elite-master', 'doom-64-elite-master', 'perfect-dark-elite-master', 'turok-2-elite-master', 'gran-turismo-2-elite-master', 'donkey-kong-country-elite-master', 'tony-hawk-3-elite-master', 'sonic-the-hedgehog-3-elite-master', 'aladdin-elite-master', 'super-mario-world-elite-master', 'nba-hangtime-elite-master', 'super-metroid-elite-master', 'marvel-vs-capcom-2-elite-master', 'sonic-cd-elite-master', 'duke-nukem-3d-elite-master', 'final-fantasy-vi-elite-master'],
      maxItems: 6,
    },
    {
      ...
      gameIds: ['resident-evil-2-elite-master', 'silent-hill-elite-master', 'metal-gear-solid-elite-master', 'krunker-io-web-elite', 'venge-io-web-elite', 'shell-shockers-web-elite'],
      maxItems: 6,
    },
    {
      ...
      roomIds: ['arcade'],
      gameIds: ['ratchet-uy-ps2-elite', 'sly2-ps2-elite', 'katamari-ps2-elite', 'persona4-ps2-elite', 'tekken-5-elite', 'mgs2-elite', 'silent-hill-2-elite', 'need-for-speed-underground-2-elite'],
      audience: {
        minPlays: 0,
      },
      weights: {
    ...
    },
    {
      ...
      roomIds: ['shooting-range'],
      gameIds: ['halo-2-xbox-elite', 'kotor-xbox-elite', 'ninja-gaiden-xbox-elite'],
      audience: {
        minPlays: 0,
      },
      weights: {
    ...
    },
    {
      ...
      maxItems: 6,
      badgeId: 'elite',
      gameIds: ['mgs2-elite', 're4-elite', 'sonic-adventure-2-elite', 'metal-gear-msx-elite', 'vampire-killer-msx-elite', 'zelda-oot-classic', 'gta-sa-classic', 'sf3-classic', 'ff7-classic'],
    },
    {
    ...
    },
    {
      ...
      maxItems: 4,
      gameIds: ['mortal-kombat-1-tribute-elite', 'resident-evil-2-elite-master', 'silent-hill-elite-master', 'metal-gear-solid-elite-master', 'castlevania-iv-elite-master', 'tekken8-tribute-elite', 'metal-slug-3-elite-master', 'zelda-alttp-elite-master', 'tekken-tag-tournament-elite-master', 'tekken-5-elite', 'burnout-3-elite', 'def-jam-ffny-elite', 'double-dragon-classic-elite', 'dbz-buus-fury-classic-elite', 'sf2-classic', 'sf3-classic', 'dd2-classic'],
    },
    {
      id: 'rail-rpg-depths',
      title: 'RPG deep runs',
      ...
      roomIds: ['rpg-vault'],
      gameIds: ['street-fighter-alpha-3-elite-master', 'mario-tennis-elite-master', '1080-snowboarding-elite-master', 'tony-hawk-2-master-elite-master', 'jak-and-daxter-elite-master', 'star-fox-64-elite-master', 'earthworm-jim-elite-master', 'super-metroid-elite-master', 'final-fantasy-vi-elite-master', 'megaman-x-elite-master', 'capcom-vs-snk-2-elite-master', 'sonic-cd-elite-master', 'zelda-oot-elite', 'final-fantasy-vii-elite', 'pokemon-yellow-elite', 'final-fantasy-nes', 'ffx-elite', 'ff7-classic', 'ff10-classic', 'ff1-classic'],
      audience: {
        rooms: ['rpg-vault'],
        minPlays: 0,
        maxPlays: 999,
    ...
    },
    {
      ...
      roomIds: ['co-op-link'],
      gameIds: ['gta-elite-wasm', 'mortal-kombat-2-elite', 'sfii-world-warrior', 'tekken-3-elite', 'tmnt-turtles-in-time-elite', 'gta-san-andreas-elite', 'tekken-5-elite', 'gta-vice-city-elite', 'gta-2-elite', 'gta-london-1969-elite'],
      audience: {
        rooms: ['co-op-link'],
        minPlays: 0,
        maxPlays: 999,
    ...
    },
    {
      ...
      roomIds: ['arcade'],
      gameIds: ['street-fighter-alpha-3-elite-master', 'darkstalkers-elite-master', 'gran-turismo-2-elite-master', 'doom-ii-elite-master', 'resident-evil-3-elite-master', 'super-metroid-elite-master', 'capcom-vs-snk-2-elite-master', 'nfl-blitz-elite-master', 'pokemon-emerald-elite-master', 'gta-iii-elite', 'gta-vice-city-elite', 'gta-san-andreas-elite', 'spider-man-2-elite', 'true-crime-la-elite', 'need-for-speed-underground-2-elite', 'gta-2-elite', 'gta-london-1969-elite', 'gta-sa-classic'],
      audience: {
        minPlays: 0,
      },
      weights: {
    ...
    },
    {
      ...
      roomIds: ['shooting-range'],
      gameIds: ['splinter-cell-elite-master', 'captain-commando-elite-master', 'turok-2-elite-master', 'tony-hawk-3-elite-master', 'f-zero-elite-master', 'zelda-alttp-elite-master', 'nba-hangtime-elite-master', 'pokemon-fire-red-elite-master', 'marvel-vs-capcom-2-elite-master', 'metal-gear-solid-2-elite-master', 'soulcalibur-ii-elite-master', 'final-fantasy-ix-elite-master', 'venge-io-webgl', 'half-life-ps2-elite', 'unreal-tournament-dc-elite', 'krunker-io-web-elite', 'ev-io-web-elite'],
      audience: {
        minPlays: 0,
      },
      weights: {
    ...
    },
    {
      ...
      roomIds: ['sports'],
      gameIds: ['tecmo-bowl-elite', 'nba-jam-elite', 'madden-2004-elite', 'nba-live-2000-elite', 'doom-64-elite-master', 'duke-nukem-3d-elite-master', 'nba-street-v2-elite', 'ssx-tricky-elite', 'fifa-2005-elite', 'thps2-ps1-elite', '10-yard-fight-classic-elite', 'madden-nfl-2000-elite', 'madden-2004-classic', 'tecmo-bowl-classic', 'punch-out-classic'],
      audience: {
        minPlays: 0,
      },
      weights: {
    ...
    },
    {
      ...
      roomIds: ['arcade'],
      gameIds: ['donkey-kong-arcade', 'frogger-arcade', 'pac-man-elite', 'asteroids-arcade', 'sonic1-classic', 'sf2-classic'],
      audience: {
        minPlays: 0,
      },
      weights: {
    ...
    },
    {
      ...
      roomIds: ['rpg-vault'],
      gameIds: ['chrono-trigger-snes-elite', 'smt-nocturne-ps2-elite'],
      audience: {
        minPlays: 0,
      },
      weights: {
