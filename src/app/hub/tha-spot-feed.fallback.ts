...
export const THA_SPOT_FALLBACK_FEED: ThaSpotFeed = {
  ...
  games: [
    ...
    },
    {
      ...
      rating: 4.7,
      badgeIds: ['new-drop'],
      tags: ['Fighting', 'Action', 'Multiplayer', 'Retro', 'Classic'],
      launchConfig: {
        approvedEmbedUrl:
          'https://www.retrogames.cc/embed/10103-street-fighter-ii-the-world-warrior-world-910522.html',
        telemetryMode: 'origin',
        telemetryOrigins: ['https://www.gamepix.com'],
        embedMode: 'inline',
        controls: ['Standard Keyboard'],
    ...
    },
    {
      ...
      genre: 'RPG',
      description:
        'Experience the greatest adventure of all time. High-fidelity N64 emulation on the S.M.U.V.E link.',
      availability: 'Online',
      playersOnline: 52000,
      rating: 5.0,
      badgeIds: ['classic', 'elite', 'staff-pick'],
      tags: ['RPG', 'Retro', 'N64', 'Adventure', 'WASM'],
      launchConfig: {
        approvedEmbedUrl:
          'https://www.retrogames.cc/embed/32446-the-legend-of-zelda-ocarina-of-time-usa.html',
        embedMode: 'inline',
        secure_mode: 'wasm',
        controls: ['Standard Keyboard'],
      },
    ...
    },
    {
      ...
      genre: 'Shooting',
      description:
        'The original top-down crime epic. Dominate the streets in high-performance PS1 emulation.',
      availability: 'Online',
      playersOnline: 28000,
      rating: 4.9,
      badgeIds: ['classic', 'elite'],
      tags: ['Shooting', 'Retro', 'PS1', 'Action', 'WASM'],
      launchConfig: {
        approvedEmbedUrl:
          'https://www.retrogames.cc/embed/41819-grand-theft-auto-usa.html',
        embedMode: 'inline',
        secure_mode: 'wasm',
        controls: ['Standard Keyboard'],
      },
    ...
    },
    {
      ...
      genre: 'Fighting',
      description:
        'Elite Saiyan combat. Experience the legendary split-screen battles of the Mega Drive classic.',
      availability: 'Online',
      playersOnline: 20000,
      rating: 4.9,
      badgeIds: ['classic', 'elite'],
      tags: ['Fighting', 'Retro', 'Genesis', 'Anime'],
      launchConfig: {
        approvedEmbedUrl:
          'https://www.retrogames.cc/embed/24151-dragon-ball-z-buyuu-retsuden-japan.html',
        embedMode: 'inline',
        secure_mode: 'wasm',
        controls: ['Standard Keyboard'],
      },
