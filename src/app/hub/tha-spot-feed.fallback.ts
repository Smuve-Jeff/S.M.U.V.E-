...
export const THA_SPOT_FALLBACK_FEED: ThaSpotFeed = {
  ...
  games: [
    ...
    },
    {
      ...
      image:
        'https://images.unsplash.com/photo-1461896704190-3213c021199a?auto=format&fit=crop&q=80&w=400',
    },
    {
      id: '13',
      name: 'Soccer Stars',
    ...
    },
    {
      ...
      description:
        'Elite first-person shooting precision with high-stakes tactical deployments.',
      genre: 'Shooting',
      rating: 4.8,
      playersOnline: 15000,
      availability: 'Web',
    ...
    },
    {
      ...
      description:
        'Deep RPG adventure with character progression and elite boss encounters.',
      genre: 'RPG',
      rating: 4.7,
      playersOnline: 9200,
      availability: 'Web',
      ...
      image:
        'https://images.unsplash.com/photo-1533236897111-3e94666b2edf?auto=format&fit=crop&q=80&w=400',
    },
    {
      id: '25',
    ...
    },
    {
      ...
      description:
        'Elite sports simulation with realistic physics and tournament brackets.',
      genre: 'Sports',
      rating: 4.6,
      playersOnline: 4200,
      availability: 'Web',
    ...
    },
    {
      ...
      description:
        'Long-range tactical shooting missions with elite ballistics.',
      genre: 'Shooting',
      rating: 4.7,
      playersOnline: 8000,
      availability: 'Web',
    ...
    },
    {
      ...
      image:
        'https://images.unsplash.com/photo-1552084117-56a987666449?auto=format&fit=crop&q=80&w=400',
    },
    {
      id: 'nba-pro-3d',
      ...
      genre: 'Sports',
      description:
        'Elite WebGL basketball with fluid 3D animations, shot timing, and competitive street-ball mechanics.',
      availability: 'Web',
      playersOnline: 45000,
      rating: 4.8,
      badgeIds: ['featured', 'staff-pick'],
    ...
    },
    {
      ...
      genre: 'Shooting',
      description:
        'Tactical 2.5D sci-fi combat. Lead your squad through hostile zones in this elite futuristic shooter tribute.',
      availability: 'Web',
      playersOnline: 15000,
      rating: 4.6,
      badgeIds: ['featured', 'staff-pick'],
    ...
    },
    {
      ...
      genre: 'Fighting',
      description:
        'Elite heavyweight boxing. Master the sweet science with realistic 3D WebGL physics and career depth.',
      availability: 'Web',
      playersOnline: 21000,
      rating: 4.8,
      badgeIds: ['featured', 'staff-pick'],
    ...
    },
    {
      ...
      genre: 'Racing',
      description:
        'High-octane marsupial racing. Elite PS1 speed with precision touch controls.',
      availability: 'Web',
      playersOnline: 14200,
      rating: 4.9,
      badgeIds: ['elite'],
    ...
    },
    {
      ...
      genre: 'Strategy',
      description:
        'Elite tactical intelligence. Advanced AI opponents in a high-fidelity 3D environment.',
      availability: 'Web',
      playersOnline: 8500,
      rating: 4.9,
      badgeIds: ['staff-pick'],
    ...
    },
    {
      ...
      genre: 'Shooting',
      description:
        'The definitive N64 shooter. High-fidelity emulation with optimized mouse/touch mapping for elite runs.',
      availability: 'Web',
      playersOnline: 28400,
      rating: 5.0,
      badgeIds: ['featured', 'elite'],
    ...
    },
    {
      ...
      genre: 'Sports',
      description:
        'Elite skating excellence. PS1 legend with stabilized frame rates and high-fidelity textures.',
      availability: 'Web',
      playersOnline: 19500,
      rating: 5.0,
    ...
    },
    {
      ...
      genre: 'Music Battle',
      description:
        'High-intensity rap battles with precision timing and elite soundtrack depth.',
      availability: 'Web',
      playersOnline: 42000,
      rating: 4.8,
      badgeIds: ['trending'],
    ...
    },
    {
      ...
      genre: 'Puzzle',
      description:
        'The definitive puzzle experience. Classic NES logic with elite-tier responsive input.',
      availability: 'Web',
      playersOnline: 28000,
      rating: 5.0,
