...
export interface AppSettings {
  ...
  ai: { kbWriteAccess: boolean; commanderPersona: string; aiMimicEnabled: boolean; aiProfanityEnabled: boolean; aiPersonaIntensityEnabled: boolean; aiConversationalTier: "Standard" | "Elite" | "SUPREME" };
  security: {
...
export const initialProfile: UserProfile = {
  settings: {
    ...
    ai: { kbWriteAccess: true, commanderPersona: 'Elite', aiMimicEnabled: false, aiProfanityEnabled: false, aiPersonaIntensityEnabled: false, aiConversationalTier: 'Standard' },
