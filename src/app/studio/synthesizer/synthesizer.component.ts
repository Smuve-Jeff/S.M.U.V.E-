...
export class SynthesizerComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  tooltips: Record<string, ParamTooltip> = {
    oscillator: {
      label: 'Wave Shape',
      plain: 'This changes the basic character of your sound — from smooth and round to buzzy and sharp.',
      icon: '🎵',
    },
    cutoff: {
      label: 'Brightness',
      plain: 'Turn up to make the sound brighter and sharper. Turn down for a muffled, dark tone.',
      icon: '🔆',
    },
    q: {
      label: 'Sharpness',
      plain: 'Adds a nasal, whistling quality at higher values. Great for funky filter sweeps!',
      icon: '🎯',
    },
    attack: {
      label: 'Fade In',
      plain: 'How fast the sound reaches full volume when you press a key. Low = instant, High = slow swell.',
      icon: '⚡',
    },
    decay: {
      label: 'Drop Off',
      plain: 'How quickly the sound fades after the initial hit, before it holds steady.',
      icon: '📉',
    },
    sustain: {
      label: 'Hold Level',
    ...
    distortion: {
      label: 'Drive / Grit',
      plain: 'Adds crunch and warmth. Low = clean, High = overdriven and aggressive.',
      icon: '🔥',
    },
    subOsc: {
      label: 'Sub Bass',
      plain: 'Adds deep low-end power underneath your sound. Great for bass and pads.',
      icon: '💪',
    },
    subGain: {
      label: 'Sub Volume',
      plain: 'How loud the deep sub bass is. Be careful — too much can shake the speakers!',
      icon: '🔊',
    },
  };
  ...
  patches: SynthPatch[] = [
    ...
    },
    {
      ...
      beginnerTip: 'Great for filling space behind your voice. Hold chords for a lush bed of sound.',
      params: {
    ...
    },
    {
      ...
      beginnerTip: 'Perfect for arpeggios and fast rhythmic patterns. Think harp or guitar.',
      params: {
    ...
    },
    {
      ...
      beginnerTip: 'Sounds like a Rhodes or Wurlitzer. Great for R&B, soul, and lo-fi.',
      params: {
        oscillator: 'triangle', subOsc: true, subGain: 0.2,
        attack: 0.005, decay: 0.4, sustain: 0.3, release: 0.7,
        cutoff: 2500, q: 0.8, distortion: 0.08,
      },
    },
    {
      id: 'strings',
      ...
      beginnerTip: 'Adds cinematic drama. Layer with pads for a movie-soundtrack feel.',
      params: {
        oscillator: 'sawtooth', subOsc: true, subGain: 0.15,
        attack: 0.4, decay: 0.6, sustain: 0.75, release: 2.0,
        cutoff: 3500, q: 0.3, distortion: 0.02,
      },
    },
    {
      id: 'wobble',
      ...
      beginnerTip: 'The classic "wub wub" sound. Turn up the LFO rate for faster wobbles!',
      params: {
        oscillator: 'sawtooth', subOsc: true, subGain: 0.5,
        attack: 0.01, decay: 0.3, sustain: 0.7, release: 0.4,
        cutoff: 600, q: 8, distortion: 0.3,
      },
    },
  ];
