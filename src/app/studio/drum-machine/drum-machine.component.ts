  ...
  pads = signal<DrumPad[]>([
    {
      ...
      color: '#ec5b13',
      active: false,
      params: { pitch: 150, decay: 0.5, gain: 1.0, punch: 0.5 },
    },
    {
      id: 'p2',
      name: 'SNARE',
      ...
      color: '#a855f7',
      active: false,
      params: { frequency: 250, decay: 0.2, gain: 0.8, snap: 0.6 },
    },
    {
      id: 'p3',
      name: 'HI-HAT (C)',
      ...
      color: '#10b981',
      active: false,
      params: { frequency: 10000, decay: 0.1, gain: 0.5, crispness: 0.8 },
    },
    {
      id: 'p4',
      name: 'BASS',
      ...
      color: '#d946ef',
      active: false,
      params: { frequency: 55, decay: 0.3, gain: 0.9, sub: 0.7 },
    },
    {
      id: 'p5',
      name: 'CLAP',
      ...
      color: '#ec5b13',
      active: false,
      params: { frequency: 1200, decay: 0.15, gain: 0.7, width: 0.5 },
    },
    {
      id: 'p6',
      name: 'TOM',
      ...
      color: '#a855f7',
      active: false,
      params: { pitch: 100, decay: 0.4, gain: 0.8, thump: 0.4 },
    },
    {
      id: 'p7',
      name: 'RIM',
      ...
      color: '#10b981',
      active: false,
      params: { frequency: 5000, decay: 0.05, gain: 0.6, click: 0.9 },
    },
    {
      id: 'p8',
      name: 'CRASH',
      ...
      color: '#d946ef',
      active: false,
      params: { frequency: 8000, decay: 1.5, gain: 0.4, shimmer: 0.6 },
    },
  ]);
