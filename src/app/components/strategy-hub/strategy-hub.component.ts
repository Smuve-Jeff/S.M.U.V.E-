...
export class StrategyHubComponent {
  ...
  educationalGuides = [
    ...
    },
    {
      ...
      content: 'The MLC collects mechanical royalties from digital service providers (DSPs) like Spotify and Apple Music for the use of musical works.'
    },
    {
      title: 'SoundExchange',
      content: 'SoundExchange collects non-interactive digital performance royalties for featured artists and copyright owners.'
    },
    {
  ...
  toggleItem(id: string) {
    this.checklists.update(items => items.map(item =>
